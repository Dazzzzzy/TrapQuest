...
To say ExamineDesc of (C - MansionScenery02):
	...
	if newbie tips is 1, say "[newbie style]Newbie tip: This statue lets you remove annoying things - specifically, touching the body lets you remove a wisp, and touching the headband lets you remove your headgear, or perhaps gain a new one. Touch the golden ropes to upgrade your jewellery... Probably.[roman type][line break]";
