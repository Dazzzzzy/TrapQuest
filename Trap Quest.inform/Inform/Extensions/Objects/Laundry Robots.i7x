...
To compute LaundryRobots:
	...
	if C is clothing:
		...
		otherwise if C is clothing and the charge of laundry robots <= 0:
			...
			now the charge of laundry robots is 200;
		otherwise:
			say "The robotic arms above you move suddenly as you enter the room, but do not approach you. Maybe they need to recharge.";
	otherwise:
...
Definition: a headgear is washable: decide no.
