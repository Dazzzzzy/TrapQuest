...
To compute periodic augmentation effect of (C - a clothing):
	...
	if the augmentation-grow-charge of C > the augmentation-charging-time of C:
		...
		if C is breast covering:
			if the player is not top heavy and (C is not bra or the largeness of breasts < the max size of C):
...
A time based rule (this is the compute jiggles rule):
	if diaper quest is 0 and a random number between 2 and (300 / (1 + unlucky)) <= the square root of the largeness of breasts:
...
To compute bsound:
	if diaper quest is 1:
		compute squelchsound;
	otherwise if the largeness of breasts > 3:
		repeat with C running through worn audible jiggles clothing:
			unless C is bsounding:
				say "[one of]Your [ShortDesc of C] accompanies the bounces of your [BreastDesc] with boings and wobbles.[or]Your [ShortDesc of C] is ensuring that every [BreastBounceDesc] of your [BreastDesc] is accompanied with silly sound effects.[or]Your [ShortDesc of C] continues to emit a cringeworthy caricature of the sound of your [BreastDesc] wobbling.[or]You are unable to prevent your [ShortDesc of C] from announcing each bounce of your [BreastDesc]![or]The clap of your [BreastDesc] keeps alerting everyone to your location![or]The magical sound-based emphasis on the movement of your [BreastDesc] is signalling to everyone exactly where you are![or]Artificial sounds created by your [ShortDesc of C] make it sound like your [BreastDesc] are jiggling unnaturally loudly![or][if the player is shameless]Your [ShortDesc of C] continues[otherwise]You wish you could stop your [ShortDesc of C] from[end if] detailing every sway of your breasts.[or]You [if the player is shameless]can't help but smile[otherwise]cringe[end if] as your [ShortDesc of C] continues to make ridiculous noises with every movement of your [BreastDesc].[or]Your [ShortDesc of C] makes your [BreastDesc] go BOOOOING![or]A loud cartoonish bouncing sound comes from your [ShortDesc of C].[or][BigNameDesc of C] makes bouncing noises echo out from your [BreastDesc].[or]The uneven reverberations of the boob bouncing sounds generated by your [ShortDesc of C] are impossible to ignore.[or]The painfully awkward parody of the sounds of your [BreastDesc] bouncing fills the air.[or]Fake wobbling sounds follow you around, thanks to your [ShortDesc of C].[or]Exaggerated jiggling noises bounce and echo throughout the [playerRegion].[or]A particularly loud BOING from your [ShortDesc of C] makes you wince[if C is not disgraced] with shame[end if].[then at random]"; [this is going to happen every turn for upright walking so we need lots of variation to prevent it getting stale]
				now C is bsounding;
				now slow-move-this-turn is 1.

Definition: a clothing (called C) is audibly squelching:
	if C is audible squelches and C is worn and (C is wet or C is messed knickers), decide yes;
	decide no.

To compute squelchsound:
	repeat with C running through audibly squelching clothing:
		unless C is bsounding:
			say "[one of]Your [ShortDesc of C] greatly amplifies the subtle squelching sound it's making.[or]Your [ShortDesc of C] is ensuring that every rustle and slosh echos throughout the [if the player is in a painting-room]surrounding area[otherwise][playerRegion][end if].[or]Your [ShortDesc of C] continues to emit a cringeworthy caricature of its wet contents.[or]You are unable to prevent your [ShortDesc of C] from announcing each slosh of [if C is messed knickers]your shameful mess[otherwise if the known-slime-soak of C > 0]your accident[otherwise]wetness[end if]![or]The extra-loud squelching of your [ShortDesc of C] keeps alerting everyone to your location![or]The magical sound-based emphasis of your [if C is messed knickers]messy[otherwise]wet[end if] [ShortDesc of C] is signalling to everyone exactly where you are![or]Artificial sounds created by your [ShortDesc of C] make it sound like it's squelching unnaturally loudly![or][if the player is shameless]Your [ShortDesc of C] continues[otherwise]You wish you could stop your [ShortDesc of C] from[end if] detailing every slosh and swill.[or]You [if the player is shameless]can't help but smile[otherwise]cringe[end if] as your [ShortDesc of C] continues to make ridiculous noises with every movement of its soiled fabric.[or]Your [ShortDesc of C] makes a horribly loud slurping noise![or]A loud cartoonish gargling sound comes from your [ShortDesc of C].[or][BigNameDesc of C] makes squelching noises echo out from your [body area of C].[or]The uneven reverberations of the wet splattering sounds generated by your [ShortDesc of C] are impossible to ignore.[or]The painfully awkward parody of the sounds of your [ShortDesc of C] squelching fills the air.[or]Fake sloshing sounds follow you around, thanks to your [ShortDesc of C].[or]Exaggerated wet scrunching noises echo throughout the region.[or]A particularly loud wet farting sound from your [C] makes you wince[if C is not disgraced] with shame[end if].[then at random]"; [this is going to happen every turn for upright walking so we need lots of variation to prevent it getting stale]
			now C is bsounding;
			now slow-move-this-turn is 1.
