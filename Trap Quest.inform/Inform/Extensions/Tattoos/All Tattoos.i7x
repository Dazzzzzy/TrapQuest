All Tattoos by Tattoos begins here.
...
Definition: abyssal tattoo is eligible: decide no.
Figure of abyssal tattoo is the file "Items/Tats/tattoo144.jpg".
To decide which figure-name is the examine-image of (T - abyssal tattoo):
	decide on figure of abyssal tattoo.
...
To decide which object is the at least partial concealer of (T - abyssal tattoo):
...
To decide which number is the sex-addiction-influence of (C - abyssal tattoo):
	...
	if the player-class is priestess, increase X by 2;
	decide on X.
To compute inking effect of (T - abyssal tattoo):
	if the player-class is faerie or the player-class is fertility goddess:
		increase the pregnancy rate of the player by 1.

Understand "abyssal", "markings" as abyssal tattoo.

[thoughts on tailored bonuses:
Maid/Puppygirl/Catgirl - a bonus that triggers while crawling
Broodmother - more wasps per egg
...
Sissy - maybe just have it TG you?
...
Definition: all-you-can-eat tattoo is eligible:
	...
	decide no.
Definition: all-you-can-eat tattoo is food themed: decide yes.
To say tattoo-desc of (T - all-you-can-eat tattoo):
	say "A drawing of an ice cream sundae with the words 'ALL YOU CAN EAT' is inked above your [genitals]. Perhaps some people will choose to go for your [vagina] more often now.".
This is the all-you-can-eat tattoo pussy slut rule:
	if all-you-can-eat tattoo is worn, increase the desirability of vagina by 5.
The all-you-can-eat tattoo pussy slut rule is listed in the pussy slut eligibility rules.

anal dragon tattoo is an asshole-tattoo. The tattoo-title of anal dragon tattoo is "anal dragon".
Definition: anal dragon tattoo is eligible:
	if the noun is sex toy or the noun is ass plugging clothing or the noun is egg, decide yes;
	decide no.
To say tattoo-desc of (T - anal dragon tattoo):
	say "A black tattoo in the shape of a long dragon circles around your [asshole].".
To decide which number is the anal sensitivity influence of (C - anal dragon tattoo):
	decide on 2.

anal-slut tattoo is a lower back tattoo. The tattoo-title of anal-slut tattoo is "anal slut".
Definition: anal-slut tattoo is drawable:
...
This is the player can't present anything except asshole rule:
	if the noun is not asshole and anal-slut tattoo is worn:
		if auto is 0, say "Your anal slut tattoo is somehow preventing you from offering up anything other than anal sex!";
		rule fails.
The player can't present anything except asshole rule is listed in the global presentable rules.

anal star tattoo is an asshole-tattoo. The tattoo-title of anal star tattoo is "anal star".
Definition: anal star tattoo is eligible:
	if the noun is star themed, decide yes;
	decide no.
To say tattoo-desc of (T - anal star tattoo):
	say "A red bordered star tattooed around your [asshole].".
To decide which number is the anal sensitivity influence of (C - anal star tattoo):
	decide on 2.

To decide which number is the soreness-influence of (C - anal star tattoo):
	let P be a random live thing penetrating asshole;
	unless P is nothing:
		decide on -2;
	decide on 0.

This is the anal star tattoo butt slut rule:
	if anal star tattoo is worn, increase the desirability of asshole by 3.
The anal star tattoo butt slut rule is listed in the butt slut eligibility rules.

anchor tattoo is an arm-tattoo. The tattoo-title of anchor tattoo is "anchor".
Definition: anchor tattoo is eligible:
	if the noun is swimming themed, decide yes;
	decide no.
Figure of anchor tattoo is the file "Items/Tats/tattoo146.jpg".
To decide which figure-name is the examine-image of (T - anchor tattoo):
	decide on figure of anchor tattoo.
To say tattoo-desc of (T - anchor tattoo):
	say "A drawing of a ship's anchor is tattooed on your left arm, as if you're a sailor.".
To decide which number is the strength-influence of (T - anchor tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - anchor tattoo):
	decide on 1.
Definition: anchor tattoo is swimming themed: decide yes.

angel tattoo is an arm-tattoo. The tattoo-title of angel tattoo is "angel".
...
Definition: angel tattoo is eligible:
	if the noun is purity clothing or the noun is blessed clothing or the noun is blessing-potion or the noun is bandage or the noun is chastity bond, decide yes;
	decide no.
...
To decide which number is the initial outrage of (T - angel tattoo):
	decide on 1.
Definition: angel tattoo is magic themed: decide yes.
...
This is the cupid tattoo butt slut rule:
	if asshole-cupid tattoo is worn, increase the desirability of asshole by 10.
The cupid tattoo butt slut rule is listed in the butt slut eligibility rules.

Atlas tattoo is a body tattoo. The tattoo-title of atlas tattoo is "atlas".
Definition: Atlas tattoo is drawable:
	if diaper quest is 1 or Atlas tattoo is worn or the player is a flatchested trap or Atlas tattoo is not eligible, decide no;
	decide yes.
Definition: Atlas tattoo is eligible:
...
To decide which object is the concealer of (T - Atlas tattoo):
	decide on a random worn actually dense actually breast covering clothing.
To decide which object is the at least partial concealer of (T - Atlas tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through actually breast covering clothing.

Book - B Tattoos

babygirl tattoo is a leg tattoo. The tattoo-title of babygirl tattoo is "babygirl".
...
To decide which number is the bimbo-influence of (T - babygirl tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - babygirl tattoo):
	decide on 5.

bat tattoo is a chest tattoo. The tattoo-title of bat tattoo is "bat".
Figure of bat tattoo is the file "Items/Tats/tattoo39.jpg".
Definition: bat tattoo is drawable:
	if the number of worn chest tattoo is 0 and it is eligible, decide yes;
	decide no.
Definition: bat tattoo is eligible:
	if the noun is corset:
		if the strength-influence of the noun is not 0 or the dexterity-influence of the noun is not 0 or the intelligence-influence of the noun is not 0, decide yes;
	if the noun is heart themed, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - bat tattoo):
	decide on figure of bat tattoo.
To say tattoo-desc of (T - bat tattoo):
	say "A heart with laces sewn into it, and with bat wings, is tattooed onto your chest.".
To decide which number is the intelligence-influence of (T - bat tattoo):
	decide on 1.
To decide which number is the dexterity-influence of (T - bat tattoo):
	decide on 1.
To decide which number is the strength-influence of (T - bat tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - bat tattoo):
	decide on 3.

bbc-fairy tattoo is an upper back tattoo. The tattoo-title of bbc-fairy tattoo is "big black cock fairy cum".
Understand "big black", "black cock", "fairy cum" as bbc-fairy tattoo.
Definition: bbc-fairy tattoo is drawable:
...
To decide which number is the sex-addiction-influence of (T - bbc-fairy tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - bbc-fairy tattoo):
	decide on 15.

bbc-only tattoo is an arm-tattoo. The tattoo-title of bbc-only tattoo is "STOP - BBC only".
Understand "stop", "bbc only" as bbc-only tattoo.
Definition: bbc-only tattoo is drawable:
	if interracial fetish is 1 and it is not worn, decide yes;
	decide no.
Definition: bbc-only tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
To say tattoo-desc of (T - bbc-only tattoo):
...
To decide which figure-name is the examine-image of (T - beauty tattoo):
...
bed-wetter tattoo is an arm-tattoo. The tattoo-title of bed-wetter tattoo is "bed wetter". Understand "wetter" as bed-wetter tattoo.
Figure of bed wetter tattoo is the file "Items/Tats/tattoo101.jpg".
To decide which figure-name is the examine-image of (T - bed-wetter tattoo):
	decide on figure of bed wetter tattoo.
Definition: bed-wetter tattoo is eligible:
	if diaper lover <= 0, decide no;
...
best-seat tattoo is a belly-tattoo. The tattoo-title of best-seat tattoo is "best seat in the house".
Definition: best-seat tattoo is drawable: decide no. [doesn't appear randomly]
To say tattoo-desc of (T - best-seat tattoo):
	say "A drawing of a woman locked into a queening chair with the phrase 'best seat in the house' is tattooed on your belly. It will probably make people much more likely to use your face for sex if they can see it.".
To decide which number is the initial outrage of (T - best-seat tattoo):
	decide on 4.
To decide which number is the oral-sex-addiction-influence of (T - best-seat tattoo):
	decide on 1.
Definition: best-seat tattoo is oral sex themed: decide yes.
This is the best-seat blowjob slut rule:
...
To decide which figure-name is the examine-image of (T - bird kitty tattoo):
	decide on figure of bird kitty tattoo.
Definition: bird kitty tattoo is eligible:
	if the noun is cat themed or the noun is bird themed, decide yes;
	decide no.
Understand "bird and" as bird kitty tattoo.
To say tattoo-desc of (T - bird kitty tattoo):
	say "A multicoloured cat with a little bird perched on its nose is tattooed on the back of your left thigh. You can feel it improving your inner peace.".
To decide which object is the concealer of (T - bird kitty tattoo):
	decide on a random worn actually dense leg covering clothing.
To decide which object is the at least partial concealer of (T - bird kitty tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through leg covering clothing.
To decide which number is the humiliation-influence of (T - bird kitty tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - bird kitty tattoo):
	decide on 3.
Definition: bird kitty tattoo is cat themed: decide yes.
Definition: bird kitty tattoo is bird themed: decide yes.

bird nest tattoo is a crotch tattoo. The tattoo-title of bird nest tattoo is "bird nest".
Definition: a bird nest tattoo is drawable:
	if there is a worn crotch tattoo, decide no;
	if diaper quest is 1, decide no;
	if christmas content is 1, decide yes;
	decide no.
Definition: bird nest tattoo is eligible:
	if the noun is christmas headgear, decide yes;
	decide no.
...
Definition: bird nest tattoo is bird themed: decide yes.
...
birds tattoo is a body tattoo. The tattoo-title of birds tattoo is "birds".
Figure of birds tattoo is the file "Items/Tats/tattoo70.jpg".
To decide which figure-name is the examine-image of (T - birds tattoo):
	decide on figure of birds tattoo.
Definition: birds tattoo is eligible:
	if the noun is egg or the noun is inflation themed or the noun is bird themed, decide yes;
	decide no.
To say tattoo-desc of (T - birds tattoo):
	say "You have a tattoo of four flying birds on your left shoulder.".
To decide which number is the dexterity-influence of (T - birds tattoo):
	decide on 1.
Definition: birds tattoo is bird themed: decide yes.
To decide which object is the concealer of (T - birds tattoo):
	if there is a worn actually dense arm covering clothing, decide on a random worn actually dense arm covering clothing;
	decide on a random worn actually dense neck covering dress. [collars won't cover this]
To decide which object is the at least partial concealer of (T - birds tattoo):
	if T is listed in the armUses of arms, decide on arms;
	if there is a worn not-see-through arm covering clothing, decide on a random worn not-see-through arm covering clothing;
	decide on a random worn not-see-through neck covering dress. [collars won't cover this]

bitch tattoo is a lower back tattoo. The tattoo-title of bitch tattoo is "bitch".
Figure of bitch tattoo is the file "Items/Tats/tattoo103.jpg".
Figure of bitchboy tattoo is the file "Items/Tats/tattoo104.jpg".
To decide which figure-name is the examine-image of (T - bitch tattoo):
	if the player is a flatchested trap, decide on figure of bitchboy tattoo;
	decide on figure of bitch tattoo.
To say ShortDesc of (T - bitch tattoo):
	say "bitch[if the player is a flatchested trap]boy[end if] tattoo".
...
Definition: bitch tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - bitch tattoo):
...
To decide which number is the initial outrage of (T - bitch tattoo):
	decide on 7.
To decide which number is the delicateness-influence of (C - bitch tattoo):
	if the player is a flatchested trap, decide on 2;
	decide on -1.
...
Definition: black cock only tattoo is drawable:
	...
	if there is a worn lower back tattoo, decide no;
	decide yes.
Definition: black cock only tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
...
Definition: black hole tattoo is drawable:
	...
	if diaper quest is 1, decide no;
	if virgin void tattoo is worn, decide no;
...
To decide which object is the concealer of (T - black hole tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - black hole tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.

black owned tattoo is a thigh-tattoo. The tattoo-title of black owned tattoo is "black owned".
Definition: black owned tattoo is drawable:
	if interracial fetish is 0 or it is worn, decide no;
	decide yes.
Definition: black owned tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
...
To decide which number is the initial outrage of (T - black owned tattoo):
	decide on 8.
Definition: black owned tattoo is interracial themed: decide yes.
...
To decide which figure-name is the examine-image of (T - born to lose tattoo):
	decide on figure of born to lose tattoo.
Definition: born to lose tattoo is drawable:
	if there is a worn crotch tattoo or born to lose tattoo is not eligible, decide no;
	decide no.
Definition: born to lose tattoo is eligible:
...
To decide which number is the cringe of (T - born to lose tattoo):
	decide on 0.
...
Report going when the player is in the location of HotelScenery01:
	if clumsy is 1 and (a random number between 1 and 2 is 1 or unlucky > 0) and pack of playing cards is carried and born to lose tattoo is drawable and the player is upright and (there is a worn tattoo or clumsy april fools is 1):
		...
		let P be pack of playing cards;
		let T be born to lose tattoo;
		say "[bold type]As you step into this room, you clumsily stumble towards the laundry chute at the other end of the room, [roman type]your pack of playing cards flying out of [if BG is bag of holding]your [ShortDesc of BG][otherwise]hand[end if] as you wobble! Before you can stop them, the cards have flown everywhere, and half of them have fallen down the hole. ";
		say aprilFoolsClumsyFlav;
		say "Metal robotic arms fly out of concealed holes in the ceiling and grab onto your limbs. They pin you to the table, with your head facing the screen. The screen now says 'Inspiration understood.' [inking-flav]Another arm descends carrying a mirror, to allow you to see your new ink:[line break]";
		summon T;
		try examining T;
...
Definition: bred by a bull tattoo is interracial themed: decide yes.
Definition: bred by a bull tattoo is pregnancy themed: decide yes.
To say tattoo-desc of (T - bred by a bull tattoo):
	say "The words 'BRED BY A BULL' are tattooed just below your left armpit.".
To decide which object is the concealer of (T - bred by a bull tattoo):
	decide on a random worn actually dense breast covering clothing.
To decide which object is the at least partial concealer of (T - bred by a bull tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through breast covering clothing.

bright-hair tattoo is an arm-tattoo. The tattoo-title of bright-hair tattoo is "bright hair".
To say ShortDesc of (T - bright-hair tattoo):
	say "[if the redness of hair < 3 or the blondeness of hair < 3 or the brightness of hair < 3]bright hair tattoo[otherwise]ultra pink hair tattoo[end if]".
Understand "is best", "bright", "pink hair", "bright hair", "hair tattoo", "ultra" as bright-hair tattoo.
Definition: bright-hair tattoo is drawable:
	if it is worn, decide no;
...
To compute inking effect of (T - bright-hair tattoo):
	unless there is worn redness-negative headgear, now the redness of hair is 3;
	unless there is worn blondeness-negative headgear, now the blondeness of hair is 3;
	unless there is worn brightness-negative headgear, now the brightness of hair is 3.
To decide which number is the initial outrage of (T - bright-hair tattoo):
	decide on 2.
To decide which number is the initial cringe of (T - bright-hair tattoo):
	decide on 3.
...
Definition: broken-clitty tattoo is eligible:
	...
	decide no.
Definition: broken-clitty tattoo is drawable:
	if there is a worn crotch tattoo, decide no;
	...
	if there is a monster penetrating a fuckhole and the player is possessing a penis:
		if there is a worn tattoo and broken-clitty tattoo is drawable:
			if anal-orgasms >= 5 and the player is a sissy:
				...
				say "[bold type]A new tattoo suddenly appears above your [sissy-penis]![roman type][line break]".
The broken clitty orgasm rule is listed in the orgasm resolution rules.

butt-burger tattoo is an upper back tattoo. The tattoo-title of butt-burger tattoo is "butt burger".
Definition: butt-burger tattoo is drawable:
	if there is a worn upper back tattoo or diaper quest is 1, decide no;
	decide yes.
Definition: butt-burger tattoo is eligible:
	if the noun is food themed or the noun is semen themed, decide yes;
	decide no.
To say tattoo-desc of (T - butt-burger tattoo):
	say "A drawing of a woman's big butt sandwiched inside the contents of a burger, with a healthy serving of cum oozing from underneath her, is tattooed on your upper back.".
To decide which number is the oral-sex-addiction-influence of (T - butt-burger tattoo):
	decide on 1.
To decide which number is the semen-taste-addiction-influence of (T - butt-burger tattoo):
	decide on 1.
To decide which number is the strength-influence of (T - butt-burger tattoo):
	decide on 1.
To compute inking effect of (T - butt-burger tattoo):
	say "You feel your [AssDesc] begin to swell in size.";
	AssSwell 2.
To decide which number is the initial outrage of (T - butt-burger tattoo):
	decide on 7.
...
This is the butt-slut tattoo butt slut rule:
	if butt-slut tattoo is worn, increase the desirability of asshole by 5.
The butt-slut tattoo butt slut rule is listed in the butt slut eligibility rules.
...
To decide which number is the anal-sex-addiction-influence of (T - butterfly-wings tattoo):
	decide on 1.
To decide which number is the heaviness of (T - butterfly-wings tattoo):
	decide on -10.

buttslut tattoo is a both-asscheeks tattoo. The tattoo-title of buttslut tattoo is "butt slut ass".
Understand "butt slut", "ass tattoo" as buttslut tattoo.
Definition: buttslut tattoo is anal sex themed: decide yes.
Definition: buttslut tattoo is drawable:
	if diaper quest is 1 or there is a worn asscheek tattoo, decide no;
	decide yes.
Definition: buttslut tattoo is eligible:
	if butt-slut tattoo is eligible, decide yes;
	decide no.
...
This is the buttslut tattoo butt slut rule:
	if buttslut tattoo is worn, increase the desirability of asshole by 5.
...
To say tattoo-desc of (T - change-self tattoo):
	say "The words 'Can't Change Self' are tattooed on your left upper arm. You can feel it preventing you from removing diapers, unless they are full to the brim.".
Check taking off diaper:
	if the noun is worn and change-self tattoo is worn and the noun is unmessed and the total-soak of the noun < the soak-limit of the noun, say "Your 'Can't Change Self' tattoo is preventing you from being able to do this!" instead.

cheating whore tattoo is a both-asscheeks tattoo. The tattoo-title of cheating whore tattoo is "cheating whore".
...
chilli pepper tattoo is a right-asscheek tattoo. The tattoo-title of chilli pepper tattoo is "chilli pepper".
Figure of chilli pepper tattoo is the file "Items/Tats/tattoo168.jpg".
To decide which figure-name is the examine-image of (T - chilli pepper tattoo):
	decide on figure of chilli pepper tattoo.
Definition: chilli pepper tattoo is drawable:
	if (diaper quest is 1 and diaper messing < 3) or there is a worn right-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: chilli pepper tattoo is eligible:
	if the noun is food themed or the noun is fire themed or the noun is bomb, decide yes;
	if the noun is crotch covering clothing or the noun is sex toy:
		if the noun is red themed or the noun is orange themed, decide yes;
	decide no.
To say tattoo-desc of (T - chilli pepper tattoo):
	say "There is an image of a red hot fiery chilli pepper tattooed on one of your butt cheeks. You can tell that [if diaper quest is 1]messing will now sometimes be painful[otherwise]your holes will now get sore easier[end if].".
Definition: chilli pepper tattoo is fire themed: decide yes.
To decide which number is the soreness-influence of (C - chilli pepper tattoo):
	decide on -2.

clit-piercing tattoo is an arm-tattoo. The tattoo-title of clit-piercing tattoo is "clit piercing". Understand "clit", "piercing" as clit-piercing tattoo.
...
Definition: clit-piercing tattoo is vagina themed: decide yes.
To decide which number is the initial outrage of (T - clit-piercing tattoo):
	decide on 12.
This is the clit-piercing tattoo pussy slut rule:
	if clit-piercing tattoo is worn, increase the desirability of vagina by 5.
The clit-piercing tattoo pussy slut rule is listed in the pussy slut eligibility rules.

cloth revolution tattoo is an arm-tattoo. The tattoo-title of cloth revolution tattoo is "cloth revolution".
Definition: cloth revolution tattoo is eligible:
	if diaper quest is 0, decide no;
	if the noun is diaper or the noun is soiled-diaper, decide yes;
	decide no.
To say tattoo-desc of (T - cloth revolution tattoo):
	say "A drawing of a blue cloth diaper with the phrase 'cloth revolution' is tattooed on your right wrist.".
To decide which number is the diaper-addiction-influence of (T - cloth revolution tattoo):
	decide on 3.
To decide which number is the initial cringe of (T - cloth revolution tattoo):
	decide on 4.
Definition: cloth revolution tattoo is baby themed: decide yes.

cock expert tattoo is an arm-tattoo. The tattoo-title of cock expert tattoo is "cock expert".
...
To decide which number is the initial outrage of (T - cock expert tattoo):
	decide on 8.
To decide which number is the oral-sex-addiction-influence of (T - cock expert tattoo):
	decide on 1.
To decide which number is the delicateness-influence of (T - cock expert tattoo):
	decide on -1.
Definition: cock expert tattoo is penis themed: decide yes.

cocktail tattoo is an arm-tattoo. The tattoo-title of cocktail tattoo is "cocktail".
Figure of cocktail tattoo is the file "Items/Tats/tattoo148.jpg".
To decide which figure-name is the examine-image of (T - cocktail tattoo):
	decide on figure of cocktail tattoo.
Definition: cocktail tattoo is eligible:
	if the noun is party themed or the noun is drink themed, decide yes;
	decide no.
To say tattoo-desc of (T - cocktail tattoo):
	say "A drawing of a pink girly cocktail is tattooed on your left arm.".
To decide which number is the initial outrage of (T - cocktail tattoo):
	decide on 5.
Definition: cocktail tattoo is party themed: decide yes.
Definition: cocktail tattoo is drink themed: decide yes.

cool mom tattoo is a body tattoo. The tattoo-title of cool mom tattoo is "cool mom".
...
Definition: cool mom tattoo is eligible:
	...
	decide no.
Definition: cool mom tattoo is pregnancy themed: decide yes.
Definition: cool mom tattoo is party themed: decide yes.
To decide which number is the vaginal-sex-addiction-influence of (T - cool mom tattoo):
	decide on alcohol-level.
To decide which object is the concealer of (T - cool mom tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - cool mom tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.

cum-dump tattoo is a body tattoo. The tattoo-title of cum-dump tattoo is "cum dump". Understand "cum", "dump" as cum-dump tattoo.
Definition: cum-dump tattoo is drawable:
	if it is not worn and diaper quest is 0 and it is eligible, decide yes;
	decide no.
Definition: cum-dump tattoo is eligible:
...
To decide which number is the semen-addiction-influence of (C - cum-dump tattoo):
	decide on 2.
...
Definition: cum dumpster lip tattoo is eligible:
	...
	if the noun is bottle:
		if the fill-colour of the noun is creamy or the fill-colour of the noun is murky, decide yes;
	decide no.
To say tattoo-desc of (T - cum dumpster lip tattoo):
	say "The words 'Cum Dumpster' are written on your gum behind your bottom lip. Nobody can see it, but that doesn't stop it being an extremely outrageous tattoo. You feel more capable at taking cocks without gagging.".
To decide which number is the bimbo-influence of (C - cum dumpster lip tattoo):
	decide on 1.
To decide which object is the concealer of (T - cum dumpster lip tattoo):
	decide on face.
To decide which object is the at least partial concealer of (T - cum dumpster lip tattoo):
	decide on face.
To say CurrentlyVisibleFlav of (C - cum dumpster lip tattoo):
	do nothing.
...
cum-when-messing tattoo is a thigh-tattoo. The tattoo-title of cum-when-messing tattoo is "messing makes me cum".
Definition: cum-when-messing tattoo is drawable:
	if it is not worn and diaper quest is 1 and diaper messing >= 3, decide yes;
	decide no.
Definition: cum-when-messing tattoo is eligible: decide no.
Understand "messing", "makes", "makes me", "cum" as cum-when-messing tattoo.
...
Definition: cum-when-messing tattoo is toilet themed: decide yes.

cumlust tattoo is a genitals-tattoo. The tattoo-title of cumlust tattoo is "cumlust".
Definition: cumlust tattoo is drawable: decide no.
To say tattoo-desc of (T - cumlust tattoo):
	say "A scarlet pair of puckered lips is tattooed on the spot where your penis used to be. It seems like normal ink, but you can feel it constantly tugging at the edge of your gaze, as if eager for your attention. When you look at it for too long, you feel a really strange sensation, almost like having an erection.".
...
To decide which number is the initial cringe of (T - cupcake tattoo):
	decide on 6.
Definition: cupcake tattoo is food themed: decide yes. [Is it something that has food in the pattern?]

cupcake wrist tattoo is an arm-tattoo. The tattoo-title of cupcake wrist tattoo is "cupcake wrist".
...
To say tattoo-desc of (T - cupcake wrist tattoo):
	say "This colourful smiling cupcake is tattooed on the inside of your right wrist. You sense that it has a chance of helping you out when you get hungry and tired.".
To decide which number is the initial cringe of (T - cupcake wrist tattoo):
	decide on 5.
[periodic effect documented in cupcake tattoo section]
Definition: cupcake wrist tattoo is food themed: decide yes. [Is it something that has food in the pattern?]

Book - D Tattoos

[This one lets the player resist any anal sex that isn't caused by a father.]

daddy's cock only tattoo is an asshole-tattoo. The tattoo-title of daddy's cock only tattoo is "daddy's cock only".
Definition: daddy's cock only tattoo is eligible:
	if the noun is sex toy or the noun is ass plugging clothing or the noun is royal sigil, decide yes;
	decide no.
Definition: daddy's cock only tattoo is drawable:
	if there is a worn asshole-tattoo, decide no;
	if there is a mating male monster, decide yes;
	decide no.
To say tattoo-desc of (T - daddy's cock only tattoo):
	say "The words 'daddy's cock only' are permanently inked around your [asshole]. You feel like it's important to resist against anal sex from anyone who hasn't given you a baby.".
Definition: daddy's cock only tattoo is penis themed: decide yes.

daddy's girl tattoo is a crotch tattoo. The tattoo-title of daddy's girl tattoo is "daddy's girl".
Figure of daddy's girl tattoo is the file "Items/Tats/tattoo180.jpg".
To decide which figure-name is the examine-image of (T - daddy's girl tattoo):
	decide on figure of daddy's girl tattoo.
Definition: daddy's girl tattoo is drawable: decide no. [doesn't appear randomly]
To say tattoo-desc of (T - daddy's girl tattoo):
	say "The words 'daddy's girl' are permanently inked in tiny swirly letters above your crotch.".
To decide which number is the cringe of (T - daddy's girl tattoo):
	decide on 4.
To decide which number is the vaginal-sex-addiction-influence of (T - daddy's girl tattoo):
	decide on 1.
To decide which number is the diaper-addiction-influence of (T - daddy's girl tattoo):
	decide on 1.
An orgasm resolution rule (this is the daddy's girl orgasm resolution rule):
	if daddy's girl tattoo is worn and there is a worn diaper:
		say "[bold type]Your 'daddy's girl' tattoo shifts and slightly transforms. It's now a 'daddy's little girl' tattoo![roman type][line break]";
		destroy daddy's girl tattoo;
		summon daddy's little girl tattoo;
		try examining daddy's little girl tattoo;
	otherwise if there is a worn tattoo and the number of worn crotch tattoo is 0:
		if (there is a presenting as male monster penetrating vagina or there is a presenting as male masturbating the player monster) and the player is getting very unlucky:
			say "Suddenly, a new tattoo appears on you!";
			summon daddy's girl tattoo;
			try examining daddy's girl tattoo;
			say GotUnluckyFlav.

daddy's little girl tattoo is a crotch tattoo. The tattoo-title of daddy's little girl tattoo is "daddy's little girl".
Figure of daddy's little girl tattoo is the file "Items/Tats/tattoo44.jpg".
Definition: daddy's little girl tattoo is drawable:
	if there is a worn crotch tattoo, decide no;
	if diaper lover <= 0, decide no;
	decide yes.
Definition: daddy's little girl tattoo is eligible:
	...
	decide no.
To decide which figure-name is the examine-image of (T - daddy's little girl tattoo):
	decide on figure of daddy's little girl tattoo.
To say tattoo-desc of (T - daddy's little girl tattoo):
...
To decide which number is the cringe of (T - daddy's little girl tattoo):
	decide on 8.

daddy's wild child tattoo is a body tattoo. The tattoo-title of daddy's wild child tattoo is "daddy's wild child".
Figure of daddy's wild child tattoo is the file "Items/Tats/tattoo76.jpg".
Definition: daddy's wild child tattoo is eligible: decide no.
To decide which figure-name is the examine-image of (T - daddy's wild child tattoo):
	decide on figure of daddy's wild child tattoo.
To say tattoo-desc of (T - daddy's wild child tattoo):
	say "The words 'daddy's wild child' are tattooed in large looping letters on the back of your left thigh.".
To decide which object is the concealer of (T - daddy's wild child tattoo):
	decide on a random worn actually dense leg covering clothing.
To decide which object is the at least partial concealer of (T - daddy's wild child tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through leg covering clothing.
To decide which number is the sex-addiction-influence of (T - daddy's wild child tattoo):
	decide on 2.
To decide which number is the delicateness-influence of (T - daddy's wild child tattoo):
	decide on -2.
...
Definition: demon belly mark is demonic: decide yes.

demon link mark is a crotch tattoo.
The tattoo-title of demon link mark is "demon queen link mark". Understand "queen" as demon link mark.
Definition: demon link mark is drawable: decide no.
To say tattoo-desc of (T - demon link mark):
	say "The mark of a pentagram above your [genitals]. You feel a permanent link to the Demon Queen.".
Definition: demon link mark is demonic: decide yes.

demon tattoo is a genitals-tattoo. Figure of demon tattoo is the file "Items/Tats/tattoo37.jpg". The tattoo-title of demon tattoo is "demon's head".
Definition: demon tattoo is eligible:
	if the noun is demonic thing, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - demon tattoo):
	decide on figure of demon tattoo.
...
demon slut tattoo is right-asscheek tattoo. The tattoo-title of demon slut tattoo is "demon slut".
...
demongirl tattoo is an arm-tattoo. The tattoo-title of demongirl tattoo is "demongirl".
Figure of demongirl tattoo is the file "Items/Tats/tattoo52.jpg".
To decide which figure-name is the examine-image of (T - demongirl tattoo):
	decide on figure of demongirl tattoo.
To say tattoo-desc of (T - demongirl tattoo):
	say "A drawing of a saucy demongirl is tattooed on your left arm.".
...
Definition: diapered dinosaur tattoo is eligible:
...
To decide which number is the initial cringe of (T - diapered dinosaur tattoo):
	decide on 6.
Definition: diapered dinosaur tattoo is baby themed: [Is it something that only an adult baby fetishist would have?]
	decide yes.

doggy style tattoo is a both-asscheeks tattoo. The tattoo-title of doggy style tattoo is "doggy style".
Definition: doggy style tattoo is drawable:
	if diaper quest is 1 or there is a worn asscheek tattoo, decide no;
	decide yes.
Definition: doggy style tattoo is eligible:
	if the noun is dog themed, decide yes;
	decide no.
To say tattoo-desc of (T - doggy style tattoo):
	say "The words 'doggy style' are tattooed on your butt cheeks.".
To decide which number is the initial outrage of (T - doggy style tattoo):
	decide on 6.
To decide which number is the vaginal-sex-addiction-influence of (T - doggy style tattoo):
	decide on 1.
To decide which number is the anal-sex-addiction-influence of (T - doggy style tattoo):
	decide on 1.
To decide which number is the strength-influence of (T - doggy style tattoo):
	decide on 1.
Definition: doggy style tattoo is dog themed: decide yes.

dolly tattoo is a hand-tattoo. The tattoo-title of dolly tattoo is "dolly".
To say ShortDesc of (T - dolly tattoo):
...
To decide which object is the concealer of (T - dolly tattoo):
	decide on a random worn actually dense finger covering clothing.
To decide which object is the at least partial concealer of (T - dolly tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through finger covering clothing.
To decide which number is the initial outrage of (T - dolly tattoo):
	decide on 4.
To decide which number is the perceived-bimbo-influence of (C - dolly tattoo):
	if the class of the player is living sex doll, decide on 3;
	decide on 1.
To decide which number is the anal sensitivity influence of (C - dolly tattoo):
	decide on -2.
To decide which number is the vaginal sensitivity influence of (C - dolly tattoo):
	decide on -2.
To decide which number is the intelligence-influence of (C - dolly tattoo):
	decide on -2.

double penetration tattoo is an arm-tattoo.
The tattoo-title of double penetration tattoo is "double penetration".
Definition: a double penetration tattoo is eligible:
	if diaper quest is 1 or the player is not possessing a vagina, decide no;
	...
	decide no.
To say tattoo-desc of (T - a double penetration tattoo):
	say "This heart-shaped tattoo on one arm shows a woman being double teamed in her lower holes by two men, the vaginal one with 'LOVE' tattooed on his hand and the anal one with 'HATE' tattooed on his hand. They're both giving this woman internal creampies, and she has a religious cross tattooed on the underside of her thigh. You can feel it making both your [vagina] and [asshole] more desirable.".
To decide which number is the anal sex addiction influence of (C - a double penetration tattoo):
	decide on -2.
To decide which number is the vaginal sex addiction influence of (C - a double penetration tattoo):
	decide on 1.
To decide which number is the semen addiction influence of (C - a double penetration tattoo):
	decide on 2.
This is the double penetration tattoo butt slut rule:
	if double penetration tattoo is worn, increase the desirability of asshole by 5.
The double penetration tattoo butt slut rule is listed in the butt slut eligibility rules.
This is the double penetration tattoo pussy slut rule:
	if double penetration tattoo is worn, increase the desirability of vagina by 5.
The double penetration tattoo pussy slut rule is listed in the pussy slut eligibility rules.
To decide which number is the initial outrage of (T - a double penetration tattoo):
	decide on 10.

drinkme tattoo is a thigh-tattoo. Figure of drinkme tattoo is the file "Items/Tats/tattoo65.jpg".
To decide which figure-name is the examine-image of (T - drinkme tattoo):
	decide on figure of drinkme tattoo.
Definition: drinkme tattoo is eligible:
	if the noun is drink themed, decide yes;
	decide no.
The tattoo-title of drinkme tattoo is "drink me".
...
Definition: drinkme tattoo is magic themed: decide yes.
...
Definition: eat-your-heart-out tattoo is eligible:
	if the noun is heart themed or the noun is food themed or the noun is oral sex themed, decide yes;
	decide no.
To say tattoo-desc of (T - eat-your-heart-out tattoo):
	say "An anatomically correct heart is tattooed over your asshole, with the words 'EAT YOUR HEART OUT' surrounding it in black ink. It seems to attract attention to your [asshole].".
To decide which number is the delicateness-influence of (T - eat-your-heart-out tattoo):
	decide on -2.
This is the eat-your-heart-out tattoo butt slut rule:
	if eat-your-heart-out tattoo is worn, increase the desirability of asshole by 5.
The eat-your-heart-out tattoo butt slut rule is listed in the butt slut eligibility rules.
Definition: eat-your-heart-out tattoo is anal sex themed: decide no.
Definition: eat-your-heart-out tattoo is oral sex themed: decide yes.
Definition: eat-your-heart-out tattoo is heart themed: decide yes.

elephant tattoo is a dq tattoo. The tattoo-title of elephant tattoo is "elephant".
Figure of elephant tattoo is the file "Items/Tats/tattoo73.jpg".
To decide which figure-name is the examine-image of (T - elephant tattoo):
	decide on figure of elephant tattoo.
Definition: elephant tattoo is drawable:
...
To decide which object is the concealer of (T - elephant tattoo):
	decide on a random worn actually dense leg covering clothing.
To decide which object is the at least partial concealer of (T - elephant tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through leg covering clothing.
To decide which number is the delicateness-influence of (T - elephant tattoo):
	decide on -1.
To decide which number is the initial cringe of (T - elephant tattoo):
	decide on 5.
Definition: elephant tattoo is elephant themed: decide yes.
Definition: elephant tattoo is heart themed: decide yes.
Definition: elephant tattoo is grey themed: decide yes.
...
Definition: empty-mind tattoo is eligible:
	...
	decide no.
Definition: empty-mind tattoo is drawable:
	if it is not worn and the intelligence of the player < 4, decide yes;
	decide no.
To say tattoo-desc of (T - empty-mind tattoo):
	say "The word 'EMPTY' is tattooed in block capitals on your forehead. You are finding it almost impossible to think!".
To compute periodic effect of (C - empty-mind tattoo):
	if the intelligence of the player > 3, IntDown 1.
To decide which number is the initial outrage of (T - empty-mind tattoo):
	if diaper quest is 1, decide on 0;
	decide on 4.
To decide which number is the initial cringe of (T - empty-mind tattoo):
	decide on 4.
...
To decide which figure-name is the examine-image of (T - fairy-cheek tattoo):
	decide on figure of fairy-cheek tattoo.
...
Definition: fairy-cheek tattoo is magic themed:
	decide yes.
This is the fairy cheek tattoo oral slut rule:
...
To decide which number is the delicateness-influence of (T - flower ballerina tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - flower ballerina tattoo):
	decide on 5.
...
Figure of forever tattoo is the file "Items/Tats/tattoo16.jpg".
To decide which figure-name is the examine-image of (T - forever tattoo):
	decide on figure of forever tattoo.
Definition: forever tattoo is eligible:
	if the noun is plentiful accessory, decide yes;
	decide no.
To say tattoo-desc of (T - forever tattoo):
	say "The words 'Nothing is Forever' are tattooed above your crotch.".
A time based rule (this is the forever tattoo rule):
	if forever tattoo is worn:
		let K be a random worn bland removable clothing;
...
free ride tattoo is a face-tattoo. The tattoo-title of free ride tattoo is "free ride".
Definition: free ride tattoo is drawable:
...
To decide which number is the perceived-bimbo-influence of (C - free ride tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - free ride tattoo):
	decide on 5.
...
To say tattoo-desc of (T - freedom tattoo):
	say "The word 'Freedom' is permanently etched on your left ankle in a tidy italic font.".
To decide which number is the dexterity-modifier of (T - freedom tattoo):
	decide on 2.
To decide which number is the initial outrage of (T - freedom tattoo):
	decide on 0.
...
Definition: fuck-me tattoo is drawable: decide no.
The printed name of fuck-me tattoo is usually "fuck me tattoo".
To say tattoo-desc of (T - fuck-me tattoo):
	say "The word 'FUCK' is tattooed on your left cheek and 'ME' tattooed on your right, clearly identifying you as the dirtiest kind of slut.".
Understand "fuck" as fuck-me tattoo.
To decide which number is the perceived-bimbo-influence of (C - fuck-me tattoo):
	decide on 99.
To decide which number is the initial outrage of (T - fuck-me tattoo):
	decide on 20.
...
To say tattoo-desc of (T - fuckin classy tattoo):
	say "The words 'fuckin classy' with a heart are tattooed with a jazzy font on your torso.".
To decide which object is the concealer of (T - fuckin classy tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - fuckin classy tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
To decide which number is the bimbo-influence of (T - fuckin classy tattoo):
	decide on -1.
Definition: fuckin classy tattoo is heart themed: decide yes.

funcentre tattoo is an asshole-tattoo. The tattoo-title of funcentre tattoo is "funcentre".
Definition: funcentre tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - funcentre tattoo):
...
To decide which number is the anal sensitivity influence of (C - funcentre tattoo):
	decide on 2.

Book - G Tattoos

gimp tattoo is a thigh-tattoo. The tattoo-title of gimp tattoo is "gimp".
Definition: gimp tattoo is eligible:
	if diaper quest is 1, decide no;
	if the noun is black themed clothing:
		if the noun is latex or the noun is leather or the noun is pvc, decide yes;
	if the noun is semen themed or the noun is hood or the noun is submissive collar or the noun is dog themed or the noun is spikey clothing, decide yes;
	decide no.
To say tattoo-desc of (T - gimp tattoo):
	say "A drawing of a hooded, blindfolded gimp wearing a dog slave collar with an arrow saying 'CUM HERE' pointing to their waiting tongue is inked on your left thigh.".
To decide which number is the semen-taste-addiction-influence of (T - gimp tattoo):
	decide on 1.
To decide which number is the delicateness-influence of (T - gimp tattoo):
	decide on 1.
To decide which number is the strength-influence of (T - gimp tattoo):
	decide on 1.
Definition: gimp tattoo is dog themed: decide yes.


guns-n-roses tattoo is a lower back tattoo. The tattoo-title of guns-n-roses tattoo is "guns and roses".
Figure of guns-n-roses tattoo is the file "Items/Tats/tattoo95.jpg".
Understand "guns ", "roses" as guns-n-roses tattoo.
Definition: guns-n-roses tattoo is eligible:
	if the noun is magic pistol or the noun is flower themed, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - guns-n-roses tattoo):
	decide on figure of guns-n-roses tattoo.
To say tattoo-desc of (T - guns-n-roses tattoo):
	say "Two large pistols and 2 large roses surround the word 'strength' on your lower back.".
To decide which number is the initial outrage of (T - guns-n-roses tattoo):
	decide on 3.
To decide which number is the strength-influence of (T - guns-n-roses tattoo):
	decide on 1.
Definition: guns-n-roses tattoo is flower themed: decide yes.
...
To say tattoo-desc of (T - heavyweight tattoo):
	say "The word 'Heavy' is inked on the back your left leg and the word 'Weight' on the back of your right leg. You feel as if it is [if weight gain fetish is 1]making it more difficult for you to lose weight[otherwise]somehow weighing you down[end if].".
To decide which number is the heaviness of (T - heavyweight tattoo):
	if weight gain fetish is 1, decide on 0;
	decide on 10.
To decide which number is the strength-influence of (T - heavyweight tattoo):
	decide on 1.

hundred percent cunt tattoo is a crotch tattoo. The tattoo-title of hundred percent cunt tattoo is "100% cunt". Understand "100%" as hundred percent cunt tattoo.
...
The hundred percent cunt tattoo pussy slut rule is listed in the pussy slut eligibility rules.
Definition: hundred percent cunt tattoo is vagina themed: decide yes.

Book - I Tattoos

i-love-anal-sex tattoo is a lower back tattoo. The tattoo-title of i-love-anal-sex tattoo is "I love anal sex".
Definition: i-love-anal-sex tattoo is drawable:
	if there is a worn lower back tattoo or diaper quest is 1, decide no;
	decide yes.
Definition: i-love-anal-sex tattoo is eligible:
	if the noun is anal sex themed, decide yes;
	decide no.
To say tattoo-desc of (T - i-love-anal-sex tattoo):
	say "You have a tramp stamp tattoo on your lower back that says 'I love anal sex'.".
To decide which number is the anal-sex-addiction-influence of (T - i-love-anal-sex tattoo):
	decide on 1.
Definition: i-love-anal-sex tattoo is anal sex themed: decide yes.
To decide which number is the initial outrage of (T - i-love-anal-sex tattoo):
	decide on 6.

i-love-black-boys tattoo is a left-asscheek tattoo. The tattoo-title of i-love-black-boys tattoo is "I love black boys".
Definition: i-love-black-boys tattoo is drawable:
	if interracial fetish is 0 or there is a worn left-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: i-love-black-boys tattoo is eligible:
	if the noun is interracial themed or the noun is heart themed, decide yes;
	decide no.
To say tattoo-desc of (T - i-love-black-boys tattoo):
	say "The words 'I <3 BLACK BOYS' are tattooed on your butt cheek with a big red 'no entry' sign over them.".
Definition: i-love-black-boys tattoo is heart themed: decide yes.
Definition: i-love-black-boys tattoo is interracial themed: decide yes.
To decide which number is the initial outrage of (T - i-love-black-boys tattoo):
	decide on 8.

i-love-black-cock tattoo is a belly-tattoo. The tattoo-title of i-love-black-cock tattoo is "I love black cock".
Definition: i-love-black-cock tattoo is drawable:
	if interracial fetish is 0 or there is a worn belly-tattoo, decide no;
	decide yes.
Definition: i-love-black-cock tattoo is eligible:
	if the noun is interracial themed or the noun is heart themed, decide yes;
	decide no.
To say tattoo-desc of (T - i-love-black-cock tattoo):
	say "You have a tattoo on your belly that says 'I <3 Black Cock'.".
Definition: i-love-black-cock tattoo is interracial themed: decide yes.
Definition: i-love-black-cock tattoo is heart themed: decide yes.
To decide which number is the initial outrage of (T - i-love-black-cock tattoo):
	decide on 7.

i-suck tattoo is an arm-tattoo. The tattoo-title of i-suck tattoo is "I suck".
Figure of i-suck tattoo is the file "Items/Tats/tattoo92.jpg".
Definition: i-suck tattoo is eligible:
	if the noun is oral sex themed or the noun is baby's bottle, decide yes;
	decide no.
...
To decide which number is the initial outrage of (T - i-suck tattoo):
	decide on 4.
Definition: i-suck tattoo is oral sex themed: decide yes.
...
ink-me tattoo is a hand-tattoo. The tattoo-title of ink-me tattoo is "ink me". Understand "ink" as ink-me tattoo.
Figure of ink-me tattoo is the file "Items/Tats/tattoo117.jpg".
To decide which figure-name is the examine-image of (T - ink-me tattoo):
	decide on figure of ink-me tattoo.
Definition: ink-me tattoo is eligible: decide no.
To say tattoo-desc of (T - ink-me tattoo):
	say "The words 'INK ME' are tattooed in block capitals on the inside of one wrist, along with a drawing of a mechanical tattoo needle.".
To decide which number is the initial outrage of (T - ink-me tattoo):
	decide on 1.

in-this-together tattoo is a thigh-tattoo. The tattoo-title of in-this-together tattoo is "we're in this together".
Definition: in-this-together tattoo is drawable:
	if interracial fetish is 1 and in-this-together tattoo is not worn and in-this-together tattoo is eligible, decide yes;
	decide no.
Definition: in-this-together tattoo is eligible:
	if the noun is anal sex themed or the noun is vagina themed or the noun is penis themed or the noun is star themed, decide yes;
	decide no.
To say tattoo-desc of (T - in-this-together tattoo):
...
To decide which number is the initial outrage of (T - in-this-together tattoo):
	decide on 9.
Definition: in-this-together tattoo is anal sex themed: decide yes.
...
Definition: jack-of-spades tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - jack-of-spades tattoo):
	say "The word 'Cuckold' and the spades symbol with a 'J' in it are tattooed above your [MediumDesc of penis].".
Definition: jack-of-spades tattoo is interracial themed: decide yes.

joy bird tattoo is an upper back tattoo. The tattoo-title of joy bird tattoo is "joy bird".
Figure of joy bird tattoo is the file "Items/Tats/tattoo175.jpg".
To decide which figure-name is the examine-image of (T - joy bird tattoo):
	decide on figure of joy bird tattoo.
Definition: joy bird tattoo is eligible:
	if the noun is bird themed or the noun is large egg, decide yes;
	decide no.
To say tattoo-desc of (T - joy bird tattoo):
	say "A large drawing of a bird with the word 'joy' written in cursive is tattooed on your upper back. You feel it improving your inner peace.".
To decide which number is the sex-addiction-influence of (T - joy bird tattoo):
	decide on -1.
To decide which number is the humiliation-influence of (T - joy bird tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - joy bird tattoo):
	decide on 1.
Definition: joy bird tattoo is bird themed: decide yes.

just the tip tattoo is a right-asscheek tattoo. The tattoo-title of just the tip tattoo is "just the tip".
Definition: just the tip tattoo is drawable:
	if diaper quest is 1 or there is a worn right-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
To say tattoo-desc of (T - just the tip tattoo):
	say "The words 'Just The Tip' are tattooed on your right butt cheek. You feel less shameful about offering your butthole for sex.".
To decide which number is the initial outrage of (T - just the tip tattoo):
	decide on 4.
Definition: just the tip tattoo is anal sex themed: decide yes.

Book - K Tattoos

kitty cat tattoo is a dq tattoo. The tattoo-title of kitty cat tattoo is "kitty cat".
Definition: kitty cat tattoo is eligible:
	if the noun is cat themed, decide yes;
	decide no.
To say tattoo-desc of (T - kitty cat tattoo):
	say "You have tattoos of two kitty cats on your tummy, one on either side.".
...
To decide which object is the concealer of (T - kitty cat tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - kitty cat tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
To decide which number is the initial cringe of (T - kitty cat tattoo):
	decide on 7.
...
Definition: knock-me-up tattoo is pregnancy themed: decide yes.
To compute inking effect of (T - knock-me-up tattoo):
	increase the pregnancy rate of the player by 1.
Definition: knock-me-up tattoo is IcarusScienceAppropriate:
	if pregnancy fetish > 0 and there is a worn tattoo and the number of worn belly-tattoo is 0, decide yes;
	decide no.
...
Definition: lesbian anilingus tattoo is drawable:
	if diaper quest is 1 or there is a worn right-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: lesbian anilingus tattoo is eligible:
	if the noun is penis themed, decide no;
	if the noun is dong or the noun is oral sex themed, decide yes;
	decide no.
To say tattoo-desc of (T - lesbian anilingus tattoo):
	say "An artistic drawing of two women licking a third's pussy and asshole is permanently inked onto your right butt cheek. You can feel it encouraging women to use your mouth.".
To decide which number is the initial outrage of (T - lesbian anilingus tattoo):
	decide on 10.
This is the lesbian anilingus tattoo blowjob slut rule:
	if lesbian anilingus tattoo is worn and there is a female willing to do oral monster in the location of the player, increase the desirability of face by 8.
The lesbian anilingus tattoo blowjob slut rule is listed in the blowjob slut eligibility rules.
Definition: lesbian anilingus tattoo is oral sex themed: decide yes.
Definition: lesbian anilingus tattoo is vagina themed: decide yes.
...
Definition: let it die tattoo is eligible:
	if the noun is biological clothing, decide yes;
	decide no.
...
lipstick crystal tattoo is an arm-tattoo. The tattoo-title of lipstick crystal tattoo is "lipstick crystal".
Figure of lipstick crystal tattoo is the file "Items/Tats/tattoo64.jpg".
Definition: lipstick crystal tattoo is eligible:
	if the noun is make up kit or the noun is plentiful accessory or the noun is gem themed, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - lipstick crystal tattoo):
	decide on figure of lipstick crystal tattoo.
To say tattoo-desc of (T - lipstick crystal tattoo):
	say "This colourful surrealist lipstick with crystalline rocks poking out the bottom is tattooed on the inside of your right wrist. You feel that it increases your mental resilience depending on your make up level.".
To decide which number is the delicateness-influence of (T - lipstick crystal tattoo):
	decide on the make-up of face * -1.
To decide which number is the initial cringe of (T - lipstick crystal tattoo):
	decide on 3.

ass-lips tattoo is a left-asscheek tattoo. The tattoo-title of ass-lips tattoo is "ass lips".
...
To decide which object is the concealer of (T - loser tattoo):
	...
	decide on nothing.
To decide which object is the at least partial concealer of (T - loser tattoo):
	if T is listed in the armUses of arms, decide on arms;
	let C be a random worn not-see-through neck covering clothing;
	unless C is accessory, decide on C;
	decide on nothing.
...
To decide which figure-name is the examine-image of (T - lucky you tattoo):
	decide on figure of lucky you tattoo.
Definition: lucky you tattoo is drawable:
	if there is a worn crotch tattoo, decide no;
	if it is eligible, decide yes;
	decide no.
Definition: lucky you tattoo is eligible:
	if the noun is playing card themed or the noun is chess piece or the noun is green-briefs or the noun is luck-potion, decide yes;
	decide no.
...
marker chest tattoo is a chest tattoo.
marker chest tattoo has a number called tattoo-outrage.
Definition: marker chest tattoo is drawable: decide no. [Never spawns randomly]
To say tattoo-desc of (T - marker chest tattoo):
	say "Someone has written '[tattoo-title of T]' on your [ShortDesc of breasts] with a magic marker!".
To decide which number is the initial outrage of (T - marker chest tattoo):
	decide on the tattoo-outrage of T.
Definition: marker chest tattoo is boob themed:
	if the tattoo-title of marker chest tattoo is not "DISGUSTING FAT UGLY PIG", decide yes;
	decide no.
To decide which object is the concealer of (T - marker chest tattoo):
	decide on a random worn actually dense actually breast covering clothing.
...
This is the measurement tattoo pussy slut rule:
...
To decide which number is the initial cringe of (T - mushbutt tattoo):
	...
	decide on 5.
To decide which object is the concealer of (T - mushbutt tattoo):
	decide on a random worn actually dense actually breast covering clothing.
To decide which object is the at least partial concealer of (T - mushbutt tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through actually breast covering clothing.
...
Definition: my-vagina tattoo is drawable:
	...
	decide yes.
Definition: my-vagina tattoo is eligible:
	if the noun is pregnancy themed or the noun is vagina themed, decide yes;
	decide no.
To say tattoo-desc of (T - my-vagina tattoo):
	say "You have a tattoo on your upper back with the words 'My Vagina'. It sits above a diagram of female genitals and the female reproductive system. It's enhancing your fertility and increasing the amount that others want to breed you.".
To compute inking effect of (T - my-vagina tattoo):
	increase the pregnancy rate of the player by 1.
...
To decide which number is the initial outrage of (T - my-vagina tattoo):
	decide on 7.
This is the my-vagina tattoo pussy slut rule:
	if my-vagina tattoo is worn, increase the desirability of vagina by 5.
The my-vagina tattoo pussy slut rule is listed in the pussy slut eligibility rules.
Definition: my-vagina tattoo is vagina themed: decide yes.
Definition: my-vagina tattoo is pregnancy themed: decide yes.

Book - N Tattoos

naughty boy tattoo is a belly-tattoo. The tattoo-title of naughty boy tattoo is "naughty boy".
Figure of naughty boy tattoo is the file "Items/Tats/tattoo199.jpg".
To decide which figure-name is the examine-image of (T - naughty boy tattoo):
	decide on figure of naughty boy tattoo.
Definition: naughty boy tattoo is drawable:
...
Definition: naughty boy tattoo is star themed: decide yes.
To decide which number is the delicateness-influence of (T - naughty boy tattoo):
	decide on -1.

nest egg tattoo is an upper back tattoo. The tattoo-title of nest egg tattoo is "nest egg".
Figure of nest egg tattoo is the file "Items/Tats/tattoo131.jpg".
To decide which figure-name is the examine-image of (T - nest egg tattoo):
	decide on figure of nest egg tattoo.
Definition: nest egg tattoo is eligible:
	if the noun is egg or the noun is plentiful accessory, decide yes;
	decide no.
...
Definition: no-panties tattoo is drawable:
	...
	decide yes.
Definition: no-panties tattoo is eligible:
...
no-regrets tattoo is a crotch tattoo. The tattoo-title of no-regrets tattoo is "no regrets".
Figure of no-regrets tattoo is the file "Items/Tats/tattoo49.jpg".
To decide which figure-name is the examine-image of (T - no-regrets tattoo):
	decide on figure of no-regrets tattoo.
Definition: no-regrets tattoo is eligible:
	if the noun is book of regrets or the noun is pink pill, decide yes;
	decide no.
To say tattoo-desc of (T - no-regrets tattoo):
	say "The words 'no regrets' are tattooed above your [genitals]. You feel it somehow making you struggle to recover lost self-esteem.".

no-whiteboys tattoo is a right-asscheek tattoo. The tattoo-title of no-whiteboys tattoo is "no whiteboys allowed".
Definition: no-whiteboys tattoo is drawable:
	if interracial fetish is 0 or there is a worn right-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: no-whiteboys tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
To say tattoo-desc of (T - no-whiteboys tattoo):
	say "The words 'No Whiteboys Allowed' are tattooed on your butt cheek with a big red 'no entry' sign over them.".
Definition: no-whiteboys tattoo is interracial themed: decide yes.
To decide which number is the initial outrage of (T - no-whiteboys tattoo):
	decide on 8.

nothing's sacred tattoo is a body tattoo. The tattoo-title of nothing's sacred tattoo is "nothing's sacred". nothing's sacred tattoo has a number called soul-charge.
Figure of nothing's sacred tattoo is the file "Items/Tats/tattoo42.jpg".
...
Definition: nothing's sacred tattoo is eligible:
	if the noun is purity clothing or the noun is runic headband or the noun is witch's goblet or the noun is mystical amulet or the noun is demonic or the noun is dildo-heels, decide yes;
	decide no.
To say tattoo-desc of (T - nothing's sacred tattoo):
	say "The words 'Nothing's Sacred' are tattooed near your belly.".
To decide which number is the strength-influence of (C - a nothing's sacred tattoo):
	decide on 2.
To compute periodic effect of (C - nothing's sacred tattoo):
...
nun blowjob tattoo is an arm-tattoo. The tattoo-title of nun blowjob tattoo is "nun blowjob".
...
To decide which number is the initial outrage of (T - nun blowjob tattoo):
	decide on 12.
Definition: nun blowjob tattoo is oral sex themed: decide yes.
Definition: nun blowjob tattoo is penis themed: decide yes.
Definition: nun blowjob tattoo is magic themed: decide yes.
...
Definition: once-you-go-black tattoo is interracial themed: decide yes.
Definition: once-you-go-black tattoo is drawable:
	if interracial fetish is 1 and the number of worn upper back tattoo is 0 and it is eligible, decide yes;
	decide no.
Definition: once-you-go-black tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
To say tattoo-desc of (T - once-you-go-black tattoo):
	say "You have a tattoo on your upper back with the words 'Once you go black you never go back'. It sits above a drawing of the outline of Africa and the words 'I <3 AFRICA' inside.[line break][variable custom style][if the bimbo of the player < 10]I don't know what's worse, people thinking I'm a slut or people thinking I'm a racist...![otherwise]A bit racially insensitive, but it gets the important message across.[end if][roman type][line break]".
To decide which number is the initial outrage of (T - once-you-go-black tattoo):
	decide on 17.
This is the once-you-go-black tattoo pussy slut rule:
	if once-you-go-black tattoo is worn, increase the desirability of vagina by 5.
The once-you-go-black tattoo pussy slut rule is listed in the pussy slut eligibility rules.

overcome tattoo is a chest tattoo. The tattoo-title of overcome tattoo is "overcome".
Figure of overcome tattoo is the file "Items/Tats/tattoo24.jpg".
To decide which figure-name is the examine-image of (T - overcome tattoo):
	decide on figure of overcome tattoo.
Definition: overcome tattoo is eligible:
	if the noun is exercise themed, decide yes;
	if the noun is clothing:
...
To decide which number is the strength-influence of (T - paw print tattoo):
	decide on 1.
To decide which number is the delicateness-influence of (T - paw print tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - paw print tattoo):
	decide on 5.
Definition: paw print tattoo is dog themed: decide yes.

penis-butterfly tattoo is an upper back tattoo. The tattoo-title of penis-butterfly tattoo is "penis butterfly".
Definition: penis-butterfly tattoo is drawable:
	if there is a worn upper back tattoo or diaper quest is 1, decide no;
	decide yes.
Definition: penis-butterfly tattoo is eligible:
	if the noun is penis themed or the noun is semen themed or the noun is fae mushroom or the noun is pink-hair or the noun is butterfly wings or the noun is fairy-wand, decide yes;
	decide no.
To say tattoo-desc of (T - penis-butterfly tattoo):
	say "A drawing of an ejaculating penis with butterfly wings is tattooed on your upper back. It is making you lighter.".
Definition: penis-butterfly tattoo is penis themed: decide yes.
Definition: penis-butterfly tattoo is semen themed: decide yes.
To decide which number is the heaviness of (T - penis-butterfly tattoo):
	decide on -10.
To decide which number is the semen-addiction-influence of (T - penis-butterfly tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - penis-butterfly tattoo):
	decide on 5.

pentagram tattoo is a vagina-tattoo. The tattoo-title of pentagram tattoo is "Xavier's pentagram".
To decide which object is the concealer of (T - pentagram tattoo):
	decide on a random worn potentially vagina covering clothing.
To decide which object is the at least partial concealer of (T - pentagram tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn potentially at least partially vagina covering clothing.
Definition: pentagram tattoo is drawable: decide no.
Definition: pentagram tattoo is demonic: decide yes.
To say tattoo-desc of (T - pentagram tattoo):
...
playdude bunny tattoo is a right-asscheek tattoo. The tattoo-title of playdude bunny tattoo is "playdude bunny".
Figure of playdude bunny tattoo is the file "Items/Tats/tattoo167.jpg".
To decide which figure-name is the examine-image of (T - playdude bunny tattoo):
...
Figure of portal tattoo is the file "Items/Tats/tattoo141.jpg".
...
To decide which object is the concealer of (T - portal tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - portal tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
To say tattoo-desc of (T - portal tattoo):
	say "A swirling blue portal is tattooed around your belly button.".
Definition: portal tattoo is magic themed: decide yes.
portal tattoo has a number called charge.
To compute periodic effect of (T - portal tattoo):
	increase the charge of T by 1;
	if the charge of T > a random number between 60 and 1000:
		now the charge of T is 0;
		say "[bold type]Your portal tattoo grows warm with space-time magic,[roman type] and you feel it fill your belly with ";
		...
		otherwise if egg laying fetish is 1 and a random number between 1 and 3 is 1:
			let N be (belly limit - the total fill of belly) / 5;
			if N > 0 and a random number between 1 and 3 is 1:
				say "[if N is 1]a giant egg[otherwise][N] huge eggs[end if]!";
				increase the large egg count of belly by N;
			otherwise if a random number between 1 and 2 is 1:
				let N be (belly limit - the total fill of belly) / 2;
				say "[if N <= 1]an egg[otherwise][N] eggs[end if]!";
				increase the medium egg count of belly by N;
			otherwise:
				let N be belly limit - the total fill of belly;
		...
		otherwise:
			...
			let N be belly limit - the total fill of belly;
			Assfill N with L;
		say "[variable custom style][one of]What the hell?![or]Not again!!![or]Uh-oh...[or]Ugh, so full...[or]My poor belly...[or]Oh golly...[then at random][roman type][line break]".

prime USDA tattoo is a left-asscheek tattoo. The tattoo-title of prime USDA tattoo is "100% Prime USDA".
Understand "100%" as prime USDA tattoo.
Definition: prime USDA tattoo is drawable:
	if diaper quest is 1 or there is a worn left-asscheek tattoo or there is a worn both-asscheeks tattoo or (lactation fetish is 0 and weight gain fetish is 0) or it is not eligible, decide no;
	decide yes.
Definition: prime USDA tattoo is eligible:
	if the noun is cow themed or the noun is food themed, decide yes;
	decide no.
To say ShortDesc of (T - prime USDA tattoo):
	say "cow meat tattoo".
To say MediumDesc of (T - prime USDA tattoo):
	say "[tattoo-title of T] tattoo".
To say tattoo-desc of (T - prime USDA tattoo):
	say "This tattoo is a replica of the stamp used to signify A-grade cow meat. It's right on your butt cheek. It seems to be preventing your butt from getting less fat.".
To decide which number is the initial outrage of (T - prime USDA tattoo):
	decide on 12.
Definition: prime USDA tattoo is cow themed: decide yes.

princess castle tattoo is a dq tattoo. The tattoo-title of princess castle tattoo is "princess castle".
Definition: princess castle tattoo is eligible:
	if the noun is royalty themed or the noun is magic lamp or the noun is pink pill, decide yes;
	decide no.
To say tattoo-desc of (T - princess castle tattoo):
	say "A drawing of a large pink castle on your left side by your tummy. You feel like [if playerRegion is Dungeon]you are[otherwise]you'll be[end if] more powerful while in the dungeon.".
To decide which object is the concealer of (T - princess castle tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - princess castle tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
To decide which number is the strength-influence of (T - princess castle tattoo):
	if playerRegion is Dungeon, decide on 2.
To decide which number is the initial cringe of (T - princess castle tattoo):
	decide on 5.
Definition: princess castle tattoo is royalty themed: decide yes.

princess-tattoo is a lower back tattoo. The tattoo-title of princess-tattoo is "princess tramp stamp".
Figure of princess-tattoo is the file "Items/Tats/tattoo35.jpg".
To decide which figure-name is the examine-image of (T - princess-tattoo):
	decide on figure of princess-tattoo.
Definition: princess-tattoo is eligible:
	if the noun is royalty themed, decide yes;
	decide no.
To say tattoo-desc of (T - princess-tattoo):
	say "You have a tramp stamp tattoo on your lower back that says the word 'Princess' under a playdude logo.".
To decide which number is the intelligence-influence of (T - princess-tattoo):
	decide on 1.
To decide which number is the strength-influence of (T - princess-tattoo):
	decide on -1.
To decide which number is the delicateness-influence of (T - princess-tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - princess-tattoo):
	decide on 6 - (diaper quest * 3).
To decide which number is the initial cringe of (T - princess-tattoo):
	decide on 6.
Definition: princess-tattoo is royalty themed: decide yes.

property-tattoo is a lower back tattoo. The tattoo-title of property-tattoo is "property".
Definition: property-tattoo is drawable: decide no.
Definition: property-tattoo is eligible: decide no.
To say tattoo-desc of (T - property-tattoo):
	say "You have a tramp stamp tattoo on your lower back that says 'PROPERTY'.".
To decide which number is the delicateness-influence of (T - property-tattoo):
	decide on 2.
...
To decide which object is the at least partial concealer of (T - pull-to-choke tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through neck covering clothing.
...
Definition: pussy deluxe tattoo is eligible:
	if the noun is plentiful accessory or the noun is gem themed or the noun is whore themed or the noun is bunny themed, decide yes;
	decide no.
To say tattoo-desc of (T - pussy deluxe tattoo):
	say "The words 'pussy deluxe' and a drawing of a playdude bunny are tattooed to the left of a giant $ sign above your crotch.".
Definition: pussy deluxe tattoo is vagina themed: decide yes.
Definition: pussy deluxe tattoo is whore themed: decide yes.

put-it-in-my-butt tattoo is a left-asscheek tattoo. The tattoo-title of put-it-in-my-butt tattoo is "put it in my butt".
Understand "put", "put it", "put it in ", "it in my", "my butt" as put-it-in-my-butt tattoo.
Definition: put-it-in-my-butt tattoo is eligible:
	if the noun is candy or the noun is heart themed or the noun is romance-novel, decide yes;
	decide no.
Definition: put-it-in-my-butt tattoo is drawable:
	if diaper quest is 1 or there is a worn left-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
To say tattoo-desc of (T - put-it-in-my-butt tattoo):
	say "The words 'put it in my butt' appear on tattooed love hearts on your left butt cheek.[line break][if the anal sex addiction of the player < 3][line break][variable custom style]Please don't! *sob*[otherwise if the anal sex addiction of the player < 7][variable custom style]Well now everything is going to aim for my [asshole], isn't it?![otherwise][line break][second custom style]This way everything and everyone knows that my [asshole] is open for business![end if][roman type][line break]You can sense that it will make people more likely to choose to have anal sex with you.".
To decide which number is the initial outrage of (T - put-it-in-my-butt tattoo):
	decide on 7.
To decide which number is the anal-sex-addiction-influence of (T - put-it-in-my-butt tattoo):
	decide on 1.
This is the put-it-in-my-butt tattoo butt slut rule:
	if put-it-in-my-butt tattoo is worn, increase the desirability of asshole by 10.
The put-it-in-my-butt tattoo butt slut rule is listed in the butt slut eligibility rules.
Definition: put-it-in-my-butt tattoo is heart themed: decide yes.
Definition: put-it-in-my-butt tattoo is anal sex themed: decide yes.
...
Definition: queen-of-spades bunny tattoo is drawable:
	if interracial fetish is 0 or there is a worn right-breast tattoo or there is worn both-breasts tattoo, decide no;
	decide yes.
Definition: queen-of-spades bunny tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed or the noun is bunny themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades bunny tattoo):
	say "A black spade symbol with an silhouette of a bunny in its hollow centre is tattooed on your right breast.".
To decide which number is the initial outrage of (T - queen-of-spades bunny tattoo):
	decide on 5.
Definition: queen-of-spades bunny tattoo is interracial themed: decide yes.
Definition: queen-of-spades bunny tattoo is playing card themed: decide yes.
Definition: queen-of-spades bunny tattoo is bunny themed: decide yes.

queen-of-spades crown tattoo is a chest tattoo. The tattoo-title of queen-of-spades crown tattoo is "queen of spades crown".
Definition: queen-of-spades crown tattoo is drawable:
	if interracial fetish is 0 or there is a worn chest tattoo, decide no;
	decide yes.
Definition: queen-of-spades crown tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed or the noun is royalty themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades crown tattoo):
	say "A black spade symbol inside a crown is tattooed above your left breast.".
To decide which number is the initial outrage of (T - queen-of-spades crown tattoo):
	decide on 2.
Definition: queen-of-spades crown tattoo is interracial themed: decide yes.
Definition: queen-of-spades crown tattoo is playing card themed: decide yes.
Definition: queen-of-spades crown tattoo is royalty themed: decide yes.

queen-of-spades nipples tattoo is a both-breasts tattoo. The tattoo-title of queen-of-spades nipples tattoo is "queen of spades nipples".
Definition: queen-of-spades nipples tattoo is drawable:
	if interracial fetish is 0 or there is a worn breast tattoo, decide no;
	decide yes.
Definition: queen-of-spades nipples tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed or the noun is boob themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades nipples tattoo):
	say "A black spade symbol is tattooed over each of your nipples.".
To decide which number is the initial outrage of (T - queen-of-spades nipples tattoo):
	decide on 15.
Definition: queen-of-spades nipples tattoo is interracial themed: decide yes.
Definition: queen-of-spades nipples tattoo is playing card themed: decide yes.
Definition: queen-of-spades nipples tattoo is boob themed: decide yes.
To decide which object is the concealer of (T - queen-of-spades nipples tattoo):
	decide on a random worn nipple covering clothing.
To decide which object is the at least partial concealer of (T - queen-of-spades nipples tattoo):
	if breasts is listed in the armUses of arms or T is listed in the armUses of arms, decide on arms;
	decide on a random worn nipple covering clothing.

queen-of-spades rose tattoo is a thigh-tattoo. The tattoo-title of queen-of-spades rose tattoo is "queen of spades rose".
Definition: queen-of-spades rose tattoo is drawable:
	if interracial fetish is 0 or queen-of-spades rose tattoo is worn, decide no;
	decide yes.
Definition: queen-of-spades rose tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed or the noun is flower themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades rose tattoo):
	say "A black queen of spades symbol is tattooed on a red rose on your right thigh.".
To decide which number is the initial outrage of (T - queen-of-spades rose tattoo):
	decide on 4.
Definition: queen-of-spades rose tattoo is interracial themed: decide yes.
Definition: queen-of-spades rose tattoo is playing card themed: decide yes.
Definition: queen-of-spades rose tattoo is flower themed: decide yes.

queen-of-spades slut tattoo is a chest tattoo. The tattoo-title of queen-of-spades slut tattoo is "SLUT for BBC".
Definition: queen-of-spades slut tattoo is drawable:
	if interracial fetish is 0 or there is a worn chest tattoo, decide no;
	decide yes.
Definition: queen-of-spades slut tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades slut tattoo):
	say "A black queen of spades symbol and the phrase 'SLUT for BBC' is tattooed above your chest.".
To decide which number is the initial outrage of (T - queen-of-spades slut tattoo):
	decide on 8.
...
Definition: queen-of-spades tribal tattoo is drawable:
	if there is a worn crotch tattoo or interracial fetish is 0, decide no;
	decide yes.
Definition: queen-of-spades tribal tattoo is eligible:
	if the noun is interracial themed or the noun is playing card themed, decide yes;
	decide no.
To say tattoo-desc of (T - queen-of-spades tribal tattoo):
	say "A tribal pattern with a queen of spades symbol in the middle is inked above your [genitals].".
To decide which number is the initial outrage of (T - queen-of-spades tribal tattoo):
	decide on 3.
Definition: queen-of-spades tribal tattoo is interracial themed: decide yes.
Definition: queen-of-spades tribal tattoo is playing card themed: decide yes.

Book - R Tattoos

refugees welcome tattoo is a left-breast tattoo. The tattoo-title of refugees welcome tattoo is "refugees welcome".
Definition: refugees welcome tattoo is drawable:
	if interracial fetish is 0 or there is worn left-breast tattoo or there is a worn both-breasts tattoo, decide no;
	decide yes.
Definition: refugees welcome tattoo is eligible:
	if the noun is interracial themed, decide yes;
	decide no.
...
Definition: respect the pussy tattoo is drawable:
	if there is a worn crotch tattoo or diaper quest is 1, decide no;
...
To decide which number is the delicateness-influence of (T - respect the pussy tattoo):
	if the player is possessing a vagina and T is currently visible, decide on -3;
	decide on 0.
Definition: respect the pussy tattoo is vagina themed: decide yes.

revolver tattoo is a body tattoo. The tattoo-title of revolver tattoo is "revolver".
Figure of revolver tattoo is the file "Items/Tats/tattoo149.jpg".
To decide which figure-name is the examine-image of (T - revolver tattoo):
	decide on figure of revolver tattoo.
Definition: revolver tattoo is eligible:
	if the noun is magic pistol, decide yes;
	decide no.
To decide which object is the concealer of (T - revolver tattoo):
	decide on a random worn potentially vagina covering clothing.
To decide which object is the at least partial concealer of (T - revolver tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn potentially vagina covering clothing.
Definition: revolver tattoo is demonic: decide yes.
To say tattoo-desc of (T - revolver tattoo):
	say "A revolver is tattooed on your left hip.".
To decide which number is the strength-influence of (T - revolver tattoo):
	decide on 4.

ribbon-bow-neck tattoo is a body tattoo. The tattoo-title of ribbon-bow-neck tattoo is "ribbon bow neck".
Figure of ribbon-bow-neck tattoo is the file "Items/Tats/tattoo71.jpg".
To decide which figure-name is the examine-image of (T - ribbon-bow-neck tattoo):
	decide on figure of ribbon-bow-neck tattoo.
Definition: ribbon-bow-neck tattoo is eligible:
	if the noun is bow themed, decide yes;
	decide no.
To say tattoo-desc of (T - ribbon-bow-neck tattoo):
	say "You have a tattoo of a ribbon bow on the back of your neck.".
To decide which number is the delicateness-influence of (T - ribbon-bow-neck tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - ribbon-bow-neck tattoo):
	decide on 4.
To decide which object is the concealer of (T - ribbon-bow-neck tattoo):
	decide on a random worn actually dense neck covering clothing.
To decide which object is the at least partial concealer of (T - ribbon-bow-neck tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through neck covering clothing.
Definition: ribbon-bow-neck tattoo is bow themed: decide yes.

ribbon bow tattoo is a leg tattoo. The tattoo-title of ribbon bow tattoo is "ribbon bow leg".
Figure of ribbon bow tattoo is the file "Items/Tats/tattoo29.jpg".
To decide which figure-name is the examine-image of (T - ribbon bow tattoo):
	decide on figure of ribbon bow tattoo.
Definition: ribbon bow tattoo is eligible:
	if the noun is stockings or the noun is bow themed, decide yes;
	decide no.
To say tattoo-desc of (T - ribbon bow tattoo):
	say "There are two red ribbon bows tattooed on you, one on the back of each leg.".
To decide which number is the bimbo-influence of (T - ribbon bow tattoo):
	decide on 1.
To decide which number is the heel-skill-influence of (T - ribbon bow tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - ribbon bow tattoo):
	decide on 4.
Definition: ribbon bow tattoo is bow themed: decide yes.

royal hearts tattoo is a thigh-tattoo. The tattoo-title of royal hearts tattoo is "royal hearts".
Figure of royal hearts tattoo is the file "Items/Tats/tattoo67.jpg".
To decide which figure-name is the examine-image of (T - royal hearts tattoo):
	decide on figure of royal hearts tattoo.
Definition: royal hearts tattoo is eligible:
	if the noun is royalty themed or the noun is heart themed, decide yes;
	decide no.
...
To decide which number is the bimbo-influence of (T - royal hearts tattoo):
	decide on 1.
To decide which number is the intelligence-influence of (T - royal hearts tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - royal hearts tattoo):
	decide on 6.
Definition: royal hearts tattoo is royalty themed: decide yes.
Definition: royal hearts tattoo is heart themed: decide yes.

Book - S Tattoos

safety pin tattoo is an arm-tattoo. The tattoo-title of safety pin tattoo is "safety pin".
Definition: safety pin tattoo is eligible:
	if diaper quest is 0, decide no;
	if the noun is diaper or the noun is mechanical joint or the noun is diaper cover or the noun is pin themed, decide yes;
	decide no.
To say tattoo-desc of (T - safety pin tattoo):
	say "A drawing of a safety pin is tattooed on your right wrist.".
To decide which number is the delicateness-influence of (T - safety pin tattoo):
	decide on -2.
To decide which number is the initial cringe of (T - safety pin tattoo):
	decide on 3.
Definition: safety pin tattoo is baby themed: decide yes.
Definition: safety pin tattoo is pin themed: decide yes.

semen demon tattoo is a lower back tattoo. The tattoo-title of semen demon tattoo is "semen demon".
Definition: semen demon tattoo is drawable:
	if diaper quest is 1, decide no;
	if there is a worn lower back tattoo, decide no;
	decide yes.
Definition: semen demon tattoo is eligible:
	if the noun is squirt dildo or (the noun is non-empty bottle and the fill-colour of the noun is creamy) or the noun is cum dump's undergarment or the noun is condom of kings or the noun is semen themed or the noun is demonic, decide yes;
	decide no.
To say tattoo-desc of (T - semen demon tattoo):
	say "You have a tramp stamp tattoo on your lower back that says the words 'Semen Demon'. There's a drawing of several sperm cells swimming towards a red trident. You can sense some faint demonic energy emanating from it.".
To decide which number is the semen-addiction-influence of (T - semen demon tattoo):
	decide on 2.
A time based rule (this is the semen demon rule):
	if semen demon tattoo is worn:
		if a random number between 1 and 250 is 1:
			if asshole is actually occupied and face is not actually occupied:
				say "[bold type]Suddenly, you feel your Semen Demon tattoo summoning [semen] directly into your stomach![line break][variable custom style][one of]Holy shit![or][if the semen taste addiction of the player > 14]Aww, I didn't even get to taste it![otherwise if the semen taste addiction of the player > 7]So gooey...[otherwise]Gross! I'm glad I didn't have to taste that...[end if][stopping][roman type][line break]";
				StomachSemenUp a random number between 4 and 8;
			otherwise:
				say "[bold type]Suddenly, you feel your Semen Demon tattoo summoning [semen] directly into your belly![line break][variable custom style][one of]Holy shit[or]Eek[stopping]![roman type][line break]";
				AssFill a random number between 4 and 8.
Definition: semen demon tattoo is semen themed: decide yes.
Definition: semen demon tattoo is demonic: decide yes.

short skirt slut tattoo is a both-asscheeks tattoo. The tattoo-title of short skirt slut tattoo is "short skirt slut".
Figure of short skirt slut tattoo is the file "Items/Tats/tattoo137.jpg".
Definition: short skirt slut tattoo is eligible:
	if the noun is super-short clothing, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - short skirt slut tattoo):
	decide on figure of short skirt slut tattoo.
To say tattoo-desc of (T - short skirt slut tattoo):
	say "Your [AssDesc] have the words 'short skirt slut', permanently inked onto your skin in a fancy white font. You can sense it has given you a fetish for wearing short skirts.".
...
slut for black cock tattoo is a crotch tattoo. The tattoo-title of slut for black cock tattoo is "slut for black cock".
...
Definition: slut for black cock tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - slut for black cock tattoo):
	say "The words 'slut for black cock' are tattooed in large letters right above your [vagina]. It's helping you realise how much [if the sex addiction of the player < 12]dark skinned people are your natural superiors[otherwise]black cock is just... better[end if].".
To decide which number is the initial outrage of (T - slut for black cock tattoo):
	decide on 16.
Definition: slut for black cock tattoo is interracial themed: decide yes.
Definition: slut for black cock tattoo is penis themed: decide yes.

slut-tattoo is a crotch tattoo. The tattoo-title of slut-tattoo is "slut crotch".
Definition: slut-tattoo is eligible:
	if the noun is clothing:
		if the initial outrage of the noun > 14, decide yes;
	decide no.
To say tattoo-desc of (T - slut-tattoo):
...
Definition: spade leaves tattoo is playing card themed: decide yes.
Definition: spade leaves tattoo is drawable:
	if interracial fetish is 0 or spade leaves tattoo is worn, decide no;
	decide yes.
Definition: spade leaves tattoo is eligible:
	if the noun is biological clothing or the noun is writhing vine or the noun is bridal garter or the noun is suspenders, decide yes;
	decide no.
To say tattoo-desc of (T - spade leaves tattoo):
...
Definition: spade owned tattoo is playing card themed: decide yes.
...
spade owned breast tattoo is a left-breast tattoo. The tattoo-title of spade owned breast tattoo is "spade owned breast".
Definition: spade owned breast tattoo is interracial themed: decide yes.
Definition: spade owned breast tattoo is playing card themed: decide yes.
Definition: spade owned breast tattoo is whore themed: decide yes.
Definition: spade owned breast tattoo is drawable: decide no. [only appears from game effect]
To say tattoo-desc of (T - spade owned breast tattoo):
	say "The large black Queen of Spades symbol is tattooed on your left butt cheek with the word 'OWNED' and a barcode embedded inside the logo. It marks you as owned by [NameDesc of pimp], to be used as a whore for [his of pimp] [if interracial fetish is 1]black [end if]patrons.".
To decide which number is the initial outrage of (T - spade owned breast tattoo):
	decide on 5.

spank tattoo is a both-asscheeks tattoo. The tattoo-title of spank tattoo is "spank me".
Figure of spank tattoo is the file "Items/Tats/tattoo3.jpg".
To decide which figure-name is the examine-image of (T - spank tattoo):
	decide on figure of spank tattoo.
To say tattoo-desc of (T - spank tattoo):
	say "Your ass cheeks have the words 'Spank Me' permanently inked onto the skin.[if the bimbo of the player > 11 and the thickness of hips > 6][line break][second custom style][line break]I deserve a good spanking for having such a big naughty bum![roman type][line break][end if][if diaper quest is 0 and asshole is lewdly exposed]You can feel the tattoo increasing your dexterity, but also your sensitivity to pain.[otherwise if diaper quest is 0]You can feel that the tattoo is encouraging you to not cover your [asshole] up.[end if]".
To decide which number is the dexterity-influence of (T - spank tattoo):
	if asshole is lewdly exposed or diaper quest is 1, decide on 2;
	decide on 0.
To decide which number is the delicateness-influence of (T - spank tattoo):
...
To decide which number is the initial cringe of (T - spank tattoo):
	decide on 8.
Definition: spank tattoo is impact play themed: decide yes.

spank-heart tattoo is a right-asscheek tattoo. The tattoo-title of spank-heart tattoo is "spank heart ass". Understand "spank", "heart" as spank-heart tattoo.
Figure of spank-heart tattoo is the file "Items/Tats/tattoo169.jpg".
To decide which figure-name is the examine-image of (T - spank-heart tattoo):
	decide on figure of spank-heart tattoo.
Definition: spank-heart tattoo is eligible:
	if the noun is heart themed or the noun is suspenders or the noun is stockings or the noun is whip-of-domination or the noun is black themed knickers, decide yes;
	decide no.
To say tattoo-desc of (T - spank-heart tattoo):
	say "There is an image of a heart-shaped butt wearing black stockings and suspenders inked on one butt cheek. You feel somewhat more sensitive to pain, but in a good way.".

spank-me-heart tattoo is a dq tattoo. The tattoo-title of spank-me-heart tattoo is "spank me heart".
Figure of spank-me-heart tattoo is the file "Items/Tats/tattoo154.jpg".
...
To decide which number is the initial outrage of (T - spank-me-heart tattoo):
	decide on 6.
To decide which number is the initial cringe of (T - spank-me-heart tattoo):
	decide on 6.
...
spank my kitty tattoo is a left-asscheek tattoo. The tattoo-title of spank my kitty tattoo is "spank my kitty".
Figure of spank my kitty tattoo is the file "Items/Tats/tattoo4.jpg".
Definition: spank my kitty tattoo is drawable:
	if the player is not possessing a vagina or there is a worn left-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: spank my kitty tattoo is eligible:
	if the noun is butt-windowed clothing or the noun is focus band or the noun is cat themed or the noun is impact play themed, decide yes;
	decide no.
To decide which figure-name is the examine-image of (T - spank my kitty tattoo):
	decide on figure of spank my kitty tattoo.
To say tattoo-desc of (T - spank my kitty tattoo):
	say "Your left ass cheek has an image of a cute winking pussycat above the words 'spank my kitty', now permanently inked onto your skin.[if the bimbo of the player > 11][line break][second custom style][line break]I wonder if it means the tattoo itself or my [vagina]?[roman type][line break][end if][if diaper quest is 0 and vagina is lewdly exposed]You can feel that it's happy about the fact that your [vagina] is on display.[otherwise if diaper quest is 0]You can feel that the tattoo is encouraging you to not cover your [vagina] up.[end if]".
To decide which number is the strength-influence of (T - spank my kitty tattoo):
	if vagina is lewdly exposed or diaper quest is 1, decide on 2;
	decide on 0.
To decide which number is the bimbo-influence of (T - spank my kitty tattoo):
	if vagina is lewdly exposed or diaper quest is 1, decide on 1;
	decide on 0.
To decide which number is the initial outrage of (T - spank my kitty tattoo):
	decide on 10.
To decide which number is the initial cringe of (T - spank my kitty tattoo):
	decide on 10.
Definition: spank my kitty tattoo is cat themed: decide yes.
Definition: spank my kitty tattoo is impact play themed: decide yes.
...
stupid whore tattoo is a lower back tattoo. The tattoo-title of stupid whore tattoo is "stupid whore".
Definition: stupid whore tattoo is drawable:
	if diaper quest is 1, decide no;
	if there is a worn lower back tattoo, decide no;
	decide yes.
Definition: stupid whore tattoo is eligible:
	if the intelligence-influence of the noun < 0 or the bimbo-influence of the noun > 0 or the noun is pocketbook or the noun is whore themed or the noun is plentiful accessory, decide yes;
	decide no.
To say tattoo-desc of (T - stupid whore tattoo):
	say "You have a tramp stamp tattoo on your lower back that says the words '$tupid Whore'.".
To decide which number is the intelligence-influence of (T - stupid whore tattoo):
	decide on -1.
To decide which number is the bimbo-influence of (T - stupid whore tattoo):
	decide on 1.
Definition: stupid whore tattoo is whore themed: decide yes.

Book - T Tattoos

take it easy tattoo is an arm-tattoo. The tattoo-title of take it easy tattoo is "take it easy".
Figure of take it easy tattoo is the file "Items/Tats/tattoo57.jpg".
Definition: take it easy tattoo is eligible:
	...
	decide no.
To decide which figure-name is the examine-image of (T - take it easy tattoo):
	decide on figure of take it easy tattoo.
To say tattoo-desc of (T - take it easy tattoo):
	say "A drawing of a palm tree with the phrase 'take it easy' is tattooed on the inside of your left forearm.".
To decide which number is the humiliation-influence of (T - take it easy tattoo):
	decide on 2.
...
Definition: asshole-tally tattoo is anal sex themed: decide yes.
Definition: asshole-tally tattoo is semen themed:
	if the tallies of it >= 5, decide yes;
	decide no.
...
To decide which object is the at least partial concealer of (T - a vagina-tally tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn potentially at least partially vagina covering clothing.
Definition: vagina-tally tattoo is vagina themed: decide yes.
...
To decide which object is the at least partial concealer of (T - mouth-tally tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn hood.
Definition: mouth-tally tattoo is oral sex themed: decide yes.
...
target tattoo is a both-breasts tattoo. The tattoo-title of target tattoo is "target".
Definition: target tattoo is drawable:
	if diaper quest is 1 or there is a worn breast tattoo, decide no;
	decide yes.
...
To decide which number is the semen-addiction-influence of (T - target tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - target tattoo):
	decide on 9.
Definition: target tattoo is boob themed: decide yes.
Definition: target tattoo is semen themed: decide yes.

teapot tattoo is an arm-tattoo. The tattoo-title of teapot tattoo is "teapot and teacup".
Understand "teacup", "and teacup" as teapot tattoo.
Definition: teapot tattoo is eligible:
	if diaper quest is 1 and the noun is drink themed, decide yes;
	decide no.
To say tattoo-desc of (T - teapot tattoo):
	say "Your left shoulder sports the tattoo of a strangely familiar teapot and chipped teacup with smiling faces. You feel like your body is digesting faster and so you will need to eat and drink more frequently.".
To decide which number is the initial cringe of (T - teapot tattoo):
	decide on 4.
Definition: teapot tattoo is respiration-enhancing: decide yes.
Definition: teapot tattoo is drink themed: decide yes.

tear it up daddy tattoo is a lower back tattoo. The tattoo-title of tear it up daddy tattoo is "tear it up daddy".
Definition: tear it up daddy tattoo is drawable:
	if diaper quest is 1, decide no;
	if there is a worn lower back tattoo, decide no;
	decide yes.
Definition: tear it up daddy tattoo is eligible:
	if the noun is clothing:
		if the noun is crotch covering and the noun is no protection, decide yes;
...
To decide which number is the bimbo-influence of (T - tear it up daddy tattoo):
	decide on 1.
This is the tear it up daddy tattoo butt slut rule:
	if tear it up daddy tattoo is worn, increase the desirability of asshole by 10.
The tear it up daddy tattoo butt slut rule is listed in the butt slut eligibility rules.
Definition: tear it up daddy tattoo is anal sex themed: decide yes.

tearful tattoo is a left-breast tattoo. The tattoo-title of tearful tattoo is "tearful".
Definition: tearful tattoo is eligible:
	if the noun is identified clothing and the delicateness-influence of the noun > 0, decide yes;
	if the noun is baby doll crop top or the noun is spoiled crop top or the noun is crybaby T-shirt, decide yes;
	decide no.
Figure of tearful tattoo is the file "Items/Tats/tattoo133.jpg".
To decide which figure-name is the examine-image of (T - tearful tattoo):
	decide on figure of tearful tattoo.
To say tattoo-desc of (T - tearful tattoo):
	say "You have a drawing inked on your left breast that looks like an anime girl in floods of tears. You feel more comfortable about begging for mercy.".
To decide which number is the delicateness-influence of (T - tearful tattoo):
	decide on 1.
To decide which number is the initial outrage of (T - tearful tattoo):
	decide on 5.
To decide which number is the initial cringe of (T - tearful tattoo):
	decide on 7.
To compute inking effect of (T - tearful tattoo):
	now the mercyskill of the player is 1.

tentacles tattoo is a both-asscheeks tattoo. The tattoo-title of tentacles tattoo is "tentacles".
Definition: tentacles tattoo is drawable:
	if tentacle fetish is 0 or pregnancy fetish is 0 or inhuman pregnancy < 2 or there is a worn asscheek tattoo, decide no;
	decide yes.
Definition: tentacles tattoo is eligible:
	if the noun is egg or the noun is writhing vine or the noun is fertility outfit or the noun is magical dress or the noun is kraken bell or the noun is pocket necronomicon, decide yes;
	decide no.
...
To decide which number is the initial outrage of (T - tentacles tattoo):
	decide on 5.
Definition: tentacles tattoo is pregnancy themed: decide yes.

thorny tattoo is a hand-tattoo. The tattoo-title of thorny tattoo is "thorny". Understand "thorn" as thorny tattoo.
Figure of thorny tattoo is the file "Items/Tats/tattoo127.jpg".
To decide which figure-name is the examine-image of (T - thorny tattoo):
	decide on figure of thorny tattoo.
Definition: thorny tattoo is eligible:
	if the noun is purity, decide yes;
	if the noun is writhing vine, decide yes;
	decide no.
To say tattoo-desc of (T - thorny tattoo):
	say "A thorny green vine is tattooed onto your knuckles, twisting into the space between your fingers. You feel it adding power to hand-based attacks.".
To decide which object is the concealer of (T - thorny tattoo):
	decide on a random worn actually dense finger covering clothing.
To decide which object is the at least partial concealer of (T - thorny tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through finger covering clothing.
...
topless tattoo is a body tattoo. The tattoo-title of topless tattoo is "topless".
Definition: topless tattoo is drawable:
	if diaper quest is 1 or topless tattoo is worn or the player is a flatchested trap or topless tattoo is not eligible, decide no;
	decide yes.
Definition: topless tattoo is eligible:
	if the noun is boob themed, decide yes;
	if the noun is clothing:
		if the noun is fully exposing or (the noun is sheer and the noun is breast covering), decide yes;
	decide no.
...
To decide which number is the initial outrage of (T - topless tattoo):
	decide on 3.
Definition: topless tattoo is boob themed: decide yes.

tractor beam tattoo is a right-asscheek tattoo. The tattoo-title of tractor beam tattoo is "tractor beam".
Definition: tractor beam tattoo is drawable:
	if diaper quest is 1 or the player is not possessing a vagina or there is a worn right-asscheek tattoo or there is a worn both-asscheeks tattoo, decide no;
	decide yes.
Definition: tractor beam tattoo is eligible:
	if the noun is vagina themed or the noun is penis themed or the noun is sword-of-purity or the noun is portal-pants or the noun is portal-hotpants or the noun is portal gag or the noun is magnetism-elixir or the noun is electric fan, decide yes;
	decide no.
To say tattoo-desc of (T - tractor beam tattoo):
	say "There is a drawing of a vagina pulling a penis towards it with a tractor beam tattooed on your ass cheek. You can feel it [bold type]significantly[roman type] influencing people with penises to choose your [vagina] for sex.".
This is the tractor beam tattoo pussy slut rule:
	if tractor beam tattoo is worn and current-monster is male monster, increase the desirability of vagina by 20.
The tractor beam tattoo pussy slut rule is listed in the pussy slut eligibility rules.
Definition: tractor beam tattoo is penis themed: decide yes.
Definition: tractor beam tattoo is vagina themed: decide yes.

traitor tattoo is a both-breasts tattoo. The tattoo-title of traitor tattoo is "traitor".
Definition: traitor tattoo is drawable: decide no.
To say tattoo-desc of (T - traitor tattoo):
	say "You have the word 'TRAITOR' tattooed in artistic blue and black letters on your chest.".
To decide which object is the concealer of (T - traitor tattoo):
	decide on a random worn actually dense high cut or higher actually breast covering clothing.
To decide which object is the at least partial concealer of (T - traitor tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through high cut or higher actually breast covering clothing.
To decide which number is the initial outrage of (T - traitor tattoo):
	decide on 6.
To decide which number is the delicateness-influence of (T - traitor tattoo):
	decide on -1.

tribal wrist tattoo is an arm-tattoo. The tattoo-title of tribal wrist tattoo is "tribal wrist".
Figure of tribal wrist tattoo is the file "Items/Tats/tattoo140.jpg".
To decide which figure-name is the examine-image of (T - tribal wrist tattoo):
	decide on figure of tribal wrist tattoo.
Definition: tribal wrist tattoo is eligible:
	if the noun is rugged-headband or the noun is leopard themed or the noun is heavy-club, decide yes;
	decide no.
To say tattoo-desc of (T - tribal wrist tattoo):
	say "A black tribal pattern goes the way around your entire wrist.".
To decide which number is the delicateness-influence of (T - tribal wrist tattoo):
	decide on -1.
...
To decide which object is the concealer of (T - ABDL finger tattoo):
	decide on a random worn actually dense finger covering clothing.
To decide which object is the at least partial concealer of (T - ABDL finger tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through finger covering clothing.
To decide which number is the diaper-addiction-influence of (T - ABDL finger tattoo):
	decide on 3.
To decide which number is the initial cringe of (T - ABDL finger tattoo):
	decide on 5.
Definition: ABDL finger tattoo is baby themed: decide yes.
Definition: ABDL finger tattoo is pin themed: decide yes.

true love tattoo is a chest tattoo. The tattoo-title of true love tattoo is "true love".
Definition: true love tattoo is drawable:
...
Definition: true love tattoo is heart themed: decide yes.
Definition: true love tattoo is boob themed: decide yes.
...
To decide which number is the intelligence-influence of (T - unfaithful tattoo):
	decide on -1.
To decide which number is the initial outrage of (T - unfaithful tattoo):
	decide on 9.
...
To say tattoo-desc of (T - unicorn-horn-finger tattoo):
	say "This unicorn horn is tattooed on the side of your right index finger. It has a pink bow at the bottom and sparkles shooting out of the tip.".
To decide which object is the concealer of (T - unicorn-horn-finger tattoo):
	decide on a random worn actually dense finger covering clothing.
To decide which object is the at least partial concealer of (T - unicorn-horn-finger tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through finger covering clothing.
To decide which number is the semen-addiction-influence of (T - unicorn-horn-finger tattoo):
	if diaper quest is 1, decide on 0;
	decide on 3.
...
This is the VIP pussy tattoo pussy slut rule:
	if VIP pussy tattoo is worn, decrease the desirability of vagina by 6.
The VIP pussy tattoo pussy slut rule is listed in the pussy slut eligibility rules.
Definition: VIP pussy tattoo is vagina themed: decide yes.
Definition: VIP pussy tattoo is whore themed: decide yes.

virgin void tattoo is a body tattoo. The tattoo-title of virgin void tattoo is "virgin".
Definition: virgin void tattoo is drawable:
...
Definition: virgin void tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - virgin void tattoo):
	say "The black word 'VIRGIN' is tattooed to the right of your belly button, [if the vaginalvirgin of the player is 1]reminding you of your purity[otherwise]and a large red 'VOID' has been tattooed over the top as if it had been stamped there[end if].".
...
To decide which number is the initial outrage of (T - virgin void tattoo):
	if the vaginalvirgin of the player is 1, decide on 1;
	decide on 5.
To decide which object is the concealer of (T - virgin void tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - virgin void tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
Definition: virgin void tattoo is vagina themed: decide yes.
...
To decide which object is the concealer of (T - walking teddy bear tattoo):
	decide on a random worn actually dense belly covering clothing.
To decide which object is the at least partial concealer of (T - walking teddy bear tattoo):
	if T is listed in the armUses of arms, decide on arms;
	decide on a random worn not-see-through belly covering clothing.
To decide which number is the strength-influence of (T - walking teddy bear tattoo):
	decide on 1.
To decide which number is the initial cringe of (T - walking teddy bear tattoo):
	decide on 3.
...
To decide which figure-name is the examine-image of (T - wasp sting tattoo):
	decide on figure of wasp sting tattoo.
Definition: wasp sting tattoo is eligible:
	if the noun is wasp wing or the noun is medium egg or the noun is slap ready equippable, decide yes;
	decide no.
To say tattoo-desc of (T - wasp sting tattoo):
	say "A wasp is tattooed onto the back of one hand, the stinger pointed towards your fingertips. You feel it adding power to hand-based attacks.".
To decide which number is the initial outrage of (T - wasp sting tattoo):
	decide on 2.

weakness tattoo is a body tattoo. The tattoo-title of weakness tattoo is "mark of weakness".
Understand "mark", "of", "weak" as weakness tattoo.
Definition: weakness tattoo is eligible: decide no.
...
wet dream tattoo is a chest tattoo. The tattoo-title of wet dream tattoo is "wet dream".
Definition: wet dream tattoo is drawable:
	if there is a worn chest tattoo, decide no;
	if diaper quest is 1, decide no;
	decide yes.
Definition: wet dream tattoo is eligible:
	...
	if the noun is clothing:
		if the semen-soak of the noun > 0, decide yes;
	decide no.
To say tattoo-desc of (T - wet dream tattoo):
	say "The words 'Wet Dream' are tattooed in large letters across your [BreastDesc].".
To decide which number is the semen-taste-addiction-influence of (T - wet dream tattoo):
	decide on 2.
Definition: wet dream tattoo is semen themed: decide yes.

whip tattoo is an arm-tattoo. The tattoo-title of whip tattoo is "whip".
Figure of whip tattoo is the file "Items/Tats/tattoo75.jpg".
To decide which figure-name is the examine-image of (T - whip tattoo):
	decide on figure of whip tattoo.
Definition: whip tattoo is eligible:
	if the noun is impact play themed or the noun is writhing vine, decide yes;
	decide no.
To say tattoo-desc of (T - whip tattoo):
	say "A hand wielding a whip is tattooed on your left upper arm.".
To decide which number is the delicateness-influence of (T - whip tattoo):
	decide on -3.
Definition: whip tattoo is impact play themed: decide yes.

white-trash tattoo is a leg tattoo. The tattoo-title of white-trash tattoo is "white trash".
Definition: white-trash tattoo is drawable:
	if diaper quest is 1, decide no;
	if interracial fetish is 0, decide no;
	if there is a worn leg tattoo, decide no;
	decide yes.
...
whore-is-my-mind tattoo is a crotch tattoo. The tattoo-title of whore-is-my-mind tattoo is "whore is my mind".
To say ShortDesc of (T - whore-is-my-mind tattoo):
	say "[if the bimbo of the player < 14]where[otherwise]whore[end if] is my mind tattoo".
Understand "where" as whore-is-my-mind tattoo when the bimbo of the player < 14.
Understand "whore" as whore-is-my-mind tattoo when the bimbo of the player >= 14.
Understand "is my mind", "mind" as whore-is-my-mind tattoo.
Definition: whore-is-my-mind tattoo is eligible:
	if the noun is headgear or the noun is whore themed, decide yes;
	if the noun is wearthing:
		if the intelligence-influence of the noun is not 0, decide yes;
	decide no.
To say tattoo-desc of (T - whore-is-my-mind tattoo):
	say "The words [if the bimbo of the player < 14]'where is my mind' are permanently tattooed above your crotch. The gothic font makes the word 'where' almost look like 'whore'[otherwise]'whore is my mind' are lovingly inked above your crotch[end if].".
To decide which number is the intelligence-influence of (T - whore-is-my-mind tattoo):
	if the bimbo of the player < 14, decide on 1;
	decide on -1.
Definition: whore-is-my-mind tattoo is whore themed:
...
Figure of whoring feedback tattoo is the file "Items/Tats/tattoo130.jpg".
...
Definition: whoring feedback tattoo is whore themed: decide yes.

witchcraft tattoo is a leg tattoo. The tattoo-title of witchcraft tattoo is "witchcraft".
Figure of witchcraft tattoo is the file "Items/Tats/tattoo27.jpg".
To decide which figure-name is the examine-image of (T - witchcraft tattoo):
	decide on figure of witchcraft tattoo.
Definition: witchcraft tattoo is eligible:
	if the noun is magic themed, decide yes;
	decide no.
To say tattoo-desc of (T - witchcraft tattoo):
	say "The word 'Witch' is inked on the back your left leg and the word 'Craft' on the back of your right leg.".
To decide which number is the intelligence-influence of (T - witchcraft tattoo):
	decide on 1.
Definition: witchcraft tattoo is magic themed: decide yes.

womb diagram tattoo is a crotch tattoo. The tattoo-title of womb diagram tattoo is "womb diagram".
...
Definition: womb diagram tattoo is eligible:
	if the noun is pregnancy themed or the noun is vagina themed, decide yes;
	decide no.
To say tattoo-desc of (T - womb diagram tattoo):
...
To compute inking effect of (T - womb diagram tattoo):
	increase the pregnancy rate of the player by 1.
This is the womb diagram tattoo pussy slut rule:
	if womb diagram tattoo is worn, increase the desirability of vagina by 5.
...
To say tattoo-desc of (T - womb heart tattoo):
	say "A tattoo with elements of a woman's reproductive system and a heart symbol is inked just above your crotch. It's making your [vagina] much more sensitive.".
Definition: womb heart tattoo is drawable: decide no.
Definition: womb heart tattoo is pregnancy themed:
...
worthless cunt tattoo is a crotch tattoo. The tattoo-title of worthless cunt tattoo is "worthless cunt".
...
Definition: worthless cunt tattoo is eligible:
	...
	decide no.
To say tattoo-desc of (T - worthless cunt tattoo):
	say "The words 'worthless cunt' are tattooed in large block letters above your crotch.".
Definition: worthless cunt tattoo is vagina themed: decide yes.

Book - X Tattoos

xavier's cunt tattoo is a crotch tattoo. The tattoo-title of xavier's cunt tattoo is "xavier's cunt".
Definition: xavier's cunt tattoo is drawable: decide no.
Definition: xavier's cunt tattoo is eligible: decide no.
To say tattoo-desc of (T - xavier's cunt tattoo):
	say "The words 'Xavier's Cunt' are burned into the skin above your [vagina].".
Definition: xavier's cunt tattoo is vagina themed: decide yes.

Book - Y Tattoos

you live you learn tattoo is a chest tattoo. The tattoo-title of you live you learn tattoo is "you live you learn".
Figure of you live you learn tattoo is the file "Items/Tats/tattoo21.jpg".
To decide which figure-name is the examine-image of (T - you live you learn tattoo):
	decide on figure of you live you learn tattoo.
Definition: you live you learn tattoo is drawable:
	if there is a worn chest tattoo, decide no;
	if it is eligible, decide yes; [not chosen randomly]
	decide no.
...
To say tattoo-desc of (T - you live you learn tattoo):
	say "The words 'You Live You Learn' are tattooed in large letters across your [BreastDesc].".
A time based rule (this is the live you learn rule):
	if you live you learn tattoo is worn:
		if a random number between 1 and (the raw intelligence of the player * 50) < 10 and the raw intelligence of the player < 30:
			say "[bold type]Your 'You Live You Learn' tattoo feels warm, and you can feel yourself getting [smarter]![roman type][line break]";
			IntUp 1.
To decide which number is the initial outrage of (T - you live you learn tattoo):
	if diaper quest is 1, decide on 0;
	decide on 2.
To decide which number is the initial cringe of (T - you live you learn tattoo):
	decide on 3.

Book - Z Tattoos

zip tattoo is a vagina-tattoo. The tattoo-title of zip tattoo is "zip".
