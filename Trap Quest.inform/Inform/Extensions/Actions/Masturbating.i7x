...
To say PlayerFantasy:
	...
	otherwise if T is not expired and T is diaper-spiral-trap:
		say "[second custom style][one of]GETTING BOUNCED ON MOMMY'S LAP WHILE WEARING A DIAPER[or]DADDY CUTTING A HOLE IN MY DIAPER AND FUCKING ME[or]GETTING PUNISHED BY MY BABYSITTER FOR BEING NAUGHTY[or][caps slime]TING MY DIAPER UNTIL IT LEAKS[or]BEING DADDY'S LITTLE DIAPERSLUT[or]GETTING FINGERED BY MOMMY DURING A DIAPER CHANGE[or][if diaper messing >= 4]DROPPING A BIG LOAD IN MY DIAPER[end if][in random order][roman type]";
	...
	otherwise if diaper lover >= 1 and the diaper addiction of the player > 9:
		say "[one of][if the player is gendered male]having a girlfriend force you into diapers before making you [slimeonself][otherwise]having a boyfriend force you into diapers before making you [slimeonself][end if][or]a dominatrix turning you into a baby against your will and parading you around town for everyone to see your humiliation[or]being blackmailed by your [RelationDesc of Pn] to become [his of Pn] personal diaper slave[or]losing control of your bladder and having to wear diapers as people mock you for being a big baby[in random order]";
	otherwise if diaper lover >= 1 and the diaper addiction of the player > 4:
	...
	otherwise if the bimbo of the player < 4 and the player is gendered male and wanktype is not ASS-WANK:[dominating women]
		say "[one of]steamy sex with your [RelationDesc of Fn], [MediumDesc of Fn][or]letting a team of super hot cheerleaders take turns sucking your dick[or]having a threesome with a couple of [if extreme proportions fetish is 1]stacked as hell[otherwise]super fine[end if] bitches[or][if the analvirgin of the player is 1]anally[otherwise]revenge[end if] fucking the [if the intelligence of the player > 5]evil[otherwise]sexy[end if] bitches who put you in here[or]sexy [men of female-f] with big [if andro fetish is 1]asses[otherwise]breasts[end if] and an interest in sitting on your cock[in random order]";
...
To say OngoingMasturbationFlav of (O - an object) with (N - a thing) in (C - an object):
	...
	otherwise:
		...
		otherwise if C is clothing:[Only did variations for semen-soak, slime soak would have made things incredibly messy. Also it was too big so I had to cut it in half.]
			let A be a random number between 1 and 2;
			if A is 1:
