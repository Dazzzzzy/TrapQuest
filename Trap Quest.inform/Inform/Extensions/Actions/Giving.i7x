...
Check giving:
	...
	otherwise if the second noun is witch:[TODO: compute WitchGiving (T - a thing) to (M- a witch)]
		...
		if the noun is vessel:
			...
			if the second noun is unbitchy and the second noun is unconcerned, say "[speech style of the second noun]'Don't worry about paying me. You can use my altar for free!'[roman type][line break]" instead;
			...
			if the noun is anal-origin or a2m fetish < 2:
				say "After [he of the second noun][']s finished, [he of the second noun] falls down on [his of the second noun] shapely butt and sighs happily.[line break][speech style of the second noun]'[if the fill-colour of the noun is murky]Good enough[otherwise]Yep, that's the stuff[end if]. You've earned [if the doses of the noun is 1]one use[otherwise][doses of the noun] uses[end if] of the altar.'[roman type][line break]";
				AltarUsesUp the doses of the noun;
				if diaper quest is 0, cutshow figure of witch cutscene 1 for witch;
			otherwise:
				say "After [he of the second noun][']s finished, [he of the second noun] frowns.[line break][speech style of the second noun]'[one of]This is pretty bland, you know. I bet you just [if the fill-colour of the noun is golden and slimeshooter fetish is 1]drained your slime buddy straight into this cup[otherwise if the fill-colour of the noun is golden]pissed directly into this cup[otherwise]used your own bodily fluids[end if], didn't you? This only gets you 1 use of the altar. Sorry but really I want something actually interesting, something that took some kinky act for you to collect. Go find someone else's cum [if watersports fetish is 1]or [slime] [end if]and then I'll properly reward you. Or at the very least, at least use a squirt dildo to stew this in your butthole for a bit first, that might add a little flavour.'[or]Boring and bland again. Only worth 1 use of the altar, I'm afraid.'[stopping][roman type][line break]";
				AltarUsesUp 1;
		...
		otherwise if the noun is diaper:
			let RD be the noun;
			if the noun is diaper-stack, now RD is diaperStackOuter;
			let T be the total-soak of RD - the water-soak of RD;
			if diaper quest is 1 and the class of the player is priestess and the noun is worn:
				allocate 2 seconds;
				say "[speech style of the second noun]'I'm LITERALLY an altar witch. Do you really think I'm about to anger the altar Goddess by removing the diaper of an altar Priestess?'[roman type][line break]";
			otherwise if T < the soak-limit of RD / 3 and RD is not messed:
				allocate 2 seconds;
				say "[speech style of the second noun]'[if the total-soak of the noun is 0]Why would I want that? It's bone dry!'[otherwise if the total-soak of the noun >= the soak-limit of the noun / 3]I'm sorry, but there's too much water in that diaper. I need the good shit.'[otherwise]Nah, that's not used enough for me. Use it some more and then come back to me.'[end if][roman type][line break][if diaper-stack is worn][speech style of the second noun]'If there's another diaper underneath that one you want to offer me, you'll need to remove that outer one first.'[roman type][line break][end if]";
			otherwise:
				allocate 6 seconds;
				let D be a random diaper carried by the second noun;
				say "[BigNameDesc of the second noun] [if D is diaper]clicks [his of the second noun] fingers, and [his of the second noun] [D] disappears into thin air. [big he of the second noun] [end if][if RD is worn and RD is messed]waves [his of the second noun] hands and the nappy falls from your body, and then flies into [his of the second noun] hands. [big his of the second noun] magic ripples across your messy bottom, somehow cleaning away all the gross leftover mess and leaving you completely clean. [big he of the second noun] [otherwise if RD is worn]waves [his of the second noun] hands and the nappy falls from your body, and then flies into [his of the second noun] hands. [big he of the second noun] [end if]steps through the leg-holes of the [noun], pulling it up to [his of the second noun] bare crotch with a loud squelch. [big he of the second noun] wiggles [his of the second noun] hips a bit, clearly enjoying the feeling of the [if RD is messed]yucky goop[otherwise]soggy padding[end if] rubbing against [his of the second noun] loins. ";
				repeat with C running through diapers carried by the second noun:
					only destroy C; [she only holds onto the most recent one]
				let N be 1;
				if T >= the soak-limit of RD, now N is 2;
				if RD is messed, now N is 1; [Getting the player out of a messy situation is rewarding enough on its own]
				if RD is worn and RD is cursed, now N is 0;
				if the noun is diaper-stack, diaperRemove RD;
				now the second noun is carrying RD;
				if the altar-uses of the second noun < 0, now the altar-uses of the second noun is 0;
				if N > 0, say "[speech style of the second noun]'Ooh, that feels [if N > 1]incredible[otherwise]goood[end if]! You've earned [if N is 1]one use[otherwise][N] uses[end if] of the altar[one of]. Hey, don't judge me! I'm not the one who NEEDS to wear nappies[or][stopping].'[roman type][line break]";
				otherwise say "[speech style of the second noun]'Ooh, that feels pretty fucking good! You've not earned any uses of the altar though, since I had to use my magic to remove that curse[one of]. What, you thought I wouldn't notice that you were stuck in it?'[or].'[stopping][roman type][line break]";
				AltarUsesUp N;
			do nothing instead;
