...
A room can be lecture. [It's a training room]
...
To say FacilityHallway:
	say "An identical tiled marble floor to all the other sections of hallway. ".

Facility01 is an academic room. The printed name of Facility01 is "Reception". "A receptionist's desk occupies the right hand side of this room. [one of]It looks like there[or]There[stopping] is a hallway to the north.". The shape of Facility01 is L5/0-0-1-0-0-0. The grid position of Facility01 is <5,12,5>.

[Main Hallway]
Facility02 is an academic room. The printed name of Facility02 is "Hallway". "The tiled marble floor has a large engraving in it which reads 'DISCE PER HOC QUOD LUXURIA' along with a great emblem made of a pair of bare breasts. To the south the door says 'Reception' and to the north the door says 'Food Hall'. The hallway continues for quite a distance to both the east and west.". The shape of Facility02 is L5/0-0-1-1-1-1. The grid position of Facility02 is <5,12,6>. Facility02 is north of Facility01.
Facility03 is an academic room. The printed name of Facility03 is "Hallway". "[FacilityHallway]To the south the door says 'Sewing Room' and to the north the door says 'Emerald Class'. The hallway continues for quite a distance to both the east and west.". The shape of Facility03 is L5/0-0-1-1-1-1. The grid position of Facility03 is <5,11,6>. Facility03 is west of Facility02.
Facility04 is an academic room. The printed name of Facility04 is "Hallway". "[FacilityHallway]To the south the door says 'Head Office' and to the north the door says 'Changing Rooms'. The hallway continues for quite a distance to both the east and west.". The shape of Facility04 is L5/0-0-1-1-1-1. The grid position of Facility04 is <5,10,6>. Facility04 is west of Facility03.
Facility05 is an academic room. The printed name of Facility05 is "Hallway". "[FacilityHallway]To the south the door says '[big SlimeTarget]s' and to the north the door says 'Assembly Hall'. The hallway continues for quite a distance to both the east and west.". The shape of Facility05 is L5/0-0-1-1-1-1. The grid position of Facility05 is <5,13,6>. Facility05 is east of Facility02.
Facility06 is an academic room. The printed name of Facility06 is "Hallway". "[FacilityHallway]To the south the door says 'Nurse's Office' and to the north the door says 'Junk Room'. The hallway continues for quite a distance to the east and a bit further to the west.". The shape of Facility06 is L5/0-0-1-1-1-1. The grid position of Facility06 is <5,14,6>. Facility06 is east of Facility05.
Facility07 is an academic room. The printed name of Facility07 is "Hallway". "[FacilityHallway]To the south the door says 'Reconditioning Room' and to the north the door says 'Sapphire Class'. The hallway continues for quite a distance to the east[if the room east from Facility07 is Facility33]. A hidden extension to the hallway has been revealed via a door-shaped hole in the wall to the west[end if].". The shape of Facility07 is L5/0-0-1-0-1-1. The grid position of Facility07 is <5,15,6>. Facility07 is east of Facility06.

[Rooms Below Main Hallway]
Facility08 is an important academic room. The printed name of Facility08 is "Head Office". "In this room a large expensive wooden desk sits between the door and a cream armchair that has back cushions shaped like breasts and female legs coming out of the arms, making it almost feel like the chair... used to be a person. A safe in the corner looks like it must contain something valuable.". The shape of Facility08 is L5/0-0-1-0-0-0. The grid position of Facility08 is <5,10,5>. Facility08 is south of Facility04.
Facility09 is an academic room. The printed name of Facility09 is "Sewing Room". "Fabric scissors, sewing machines, and more. This room has everything you would need to mend damaged clothing.". The shape of Facility09 is L5/0-0-1-0-0-0. The grid position of Facility09 is <5,11,5>. Facility09 is south of Facility03.
To decide which number is the entry-rank of (R - Facility09):
	decide on 2.
Facility10 is an academic room. The printed name of Facility10 is "[big SlimeTarget]s". "A standard set of cubicles with [SlimeTarget]s inside, except there are no doors on the cubicles, so if anyone walked in they'd be able to see you straight away.". The shape of Facility10 is L5/0-0-1-0-0-0. The grid position of Facility10 is <5,13,5>. Facility10 is south of Facility05. Facility10 is toilets.
Facility11 is an academic room. The printed name of Facility11 is "Nurse's Office". "A series of medical implements ranging from enema kits to speculums hang around the walls. The entire floor of the room is empty due to a rather concerning lack of furniture. A door to the south says 'Med Bay'.". The shape of Facility11 is L5/0-0-1-0-1-0. The grid position of Facility11 is <5,14,5>. Facility11 is south of Facility06.
To decide which number is the entry-rank of (R - Facility11):
	decide on 1.
Facility12 is an academic room. The printed name of Facility12 is "Med Bay". "This room has a bed with pink bedsheets in it, but it doesn't look like the primary purpose of it is resting. The facts that the bed is on wheels and there are strong leather bonds at the four corners as well as several straps over the middle, bring two very specific words to your mind: '[if diaper quest is 1]Psych Ward'[otherwise]Operating Table'[end if].". The shape of Facility12 is L5/0-0-1-0-0-0. The grid position of Facility12 is <5,14,4>. Facility12 is south of Facility11.
To decide which number is the entry-rank of (R - Facility12):
	decide on 1.
Facility13 is an academic room. The printed name of Facility13 is "Reconditioning Room". "This room has more than one rather sinister-looking pieces of equipment that could be used to punish a trainee. There's a blackboard for lines, there's a set of stocks facing the doorway, and in one corner there's a chair with waiting bondage straps on each leg, and a vibrating wand fixed through a hole in the middle.". The shape of Facility13 is L5/0-0-1-0-0-0. The grid position of Facility13 is <5,15,5>. Facility13 is south of Facility07.

[Rooms Above Main Hallway]
Facility14 is a lecture academic room. The printed name of Facility14 is "Sapphire Training Room". "This 'training room' has rows of desks but no chairs. The walls are adorned with motifs of high heels and pouting lips.". The shape of Facility14 is L5/0-0-0-0-1-0. The grid position of Facility14 is <5,15,7>. Facility14 is north of Facility07.
To decide which number is the entry-rank of (R - Facility14):
	decide on 1.
Facility15 is an academic room. The printed name of Facility15 is "Junk Room". "This room has a few items of clothing discarded rather messily all around. Weird mystic runes adorn the ceiling and doorway, [if the donations of Facility15 < 5]pulsing a powerful purple, [end if]suggesting that some kind of magic is in action here. A door at the north end of the room says 'Science Lab'". The shape of Facility15 is L5/0-0-1-0-1-0. The grid position of Facility15 is <5,14,7>. Facility15 is north of Facility06.
To decide which number is the entry-rank of (R - Facility15):
	decide on 2.
Facility16 is an academic room. The printed name of Facility16 is "Assembly Hall". "A raised podium with a microphone at the front of the room makes it clear that this is an assembly hall, but the lack of other furniture makes it seem rather eerie and... clinical.". The shape of Facility16 is L5/0-0-0-0-1-0. The grid position of Facility16 is <5,13,7>. Facility16 is north of Facility05.
Facility17 is an academic room. The printed name of Facility17 is "Food Hall". "This room has large machine taking up most of the room with [ExamineDesc of food machine]". The shape of Facility17 is L5/0-0-1-0-1-0. The grid position of Facility17 is <5,12,7>. Facility17 is north of Facility02.
Definition: Facility17 is foody: decide yes. [Does this room remind the player that they're feeling hungry?]
Facility18 is a lecture academic room. The printed name of Facility18 is "Emerald Training Room". "This 'training room' has rows of desks but no chairs. The walls are adorned with motifs of spanking equipment, bondage and fetishwear.". The shape of Facility18 is L5/0-0-0-0-1-0. The grid position of Facility18 is <5,11,7>. Facility18 is north of Facility03.
To decide which number is the entry-rank of (R - Facility18):
	decide on 2.
Facility19 is an itemstatic academic room. The printed name of Facility19 is "Changing Rooms". "This room has a few hooks to hang up clothing and not much else. A door to the west says 'Swimming Pool' on it[if gloryhole is in Facility19]. You blink in surprise as you look at the north wall. [ExamineDesc of gloryhole]Considering the nature of this institution, it doesn't feel particularly out of place[end if].". The shape of Facility19 is L5/0-0-0-0-1-1. The grid position of Facility19 is <5,10,7>. Facility19 is north of Facility04.
To decide which number is the entry-rank of (R - Facility19):
	decide on 1.

[Rooms To The Left of Changing Room]
Facility20 is a water-bodied academic room. The printed name of Facility20 is "Swimming Pool". "A medium sized rectangular swimming pool [if diaper quest is 0]filled to the brim with what appears to be fresh warm [semen][otherwise]fills the air with the smell of chlorine[end if]. To the north is a set of tiered spectator stands. To the west a door reads 'Hot Tub'. To the south the door says 'Gymnasium'.". The shape of Facility20 is L5/0-0-1-1-1-1. The grid position of Facility20 is <5,9,7>. Facility20 is west of Facility19.
To decide which number is the entry-rank of (R - Facility20):
	decide on 2.
Facility21 is a water-bodied academic room. The printed name of Facility21 is "Hot Tub". "A large jacuzzi sits bubbling away at the centre of this otherwise small and empty room.". The shape of Facility21 is L5/0-0-0-1-0-0. The grid position of Facility21 is <5,8,7>. Facility21 is west of Facility20.
To decide which number is the entry-rank of (R - Facility21):
	decide on 3.
Facility22 is an academic room. The printed name of Facility22 is "Spectator Stands". "Tiered viewing benches face the [if diaper quest is 0][semen]-filled [end if]swimming pool.". The shape of Facility22 is L5/0-0-0-0-1-0. The grid position of Facility22 is <5,9,8>. Facility22 is north of Facility20.
To decide which number is the entry-rank of (R - Facility22):
	decide on 2.
Facility23 is an itemstatic academic room. The printed name of Facility23 is "Gym". "A large empty space typical of an indoor gym, with the addition of racetrack markings around the outside.". The shape of Facility23 is L5/0-0-1-0-0-0. The grid position of Facility23 is <5,9,6>. Facility23 is south of Facility20.
To decide which number is the entry-rank of (R - Facility23):
	decide on 2.

[Upper Hallway]
Facility24 is an academic room. The printed name of Facility24 is "Hallway". "The tiled marble floor has a large engraving in it which reads 'DISCE PER HOC QUOD LUXURIA' along with a great emblem made of a pair of bare breasts. To the south the door says 'Food Hall' and to the north the door says 'Trophy Hall'. The hallway continues for a short distance to both the east and west.". The shape of Facility24 is L5/0-0-1-1-1-1. The grid position of Facility24 is <5,12,8>. Facility24 is north of Facility17.
To decide which number is the entry-rank of (R - Facility24):
	decide on 3.
Facility25 is an academic room. The printed name of Facility25 is "Hallway". "The tiled marble floor has a large engraving in it which reads 'DISCE PER HOC QUOD LUXURIA' along with a great emblem made of a pair of bare breasts. To the east the door says 'Science Lab' and to the north the door says 'Pink Diamond Class'. The hallway continues for a reasonable distance to the west.". The shape of Facility25 is L5/0-0-1-1-0-1. The grid position of Facility25 is <5,13,8>. Facility25 is east of Facility24.
To decide which number is the entry-rank of (R - Facility25):
	decide on 3.
Facility26 is an academic room. The printed name of Facility26 is "Hallway". "The tiled marble floor has a large engraving in it which reads 'DISCE PER HOC QUOD LUXURIA' along with a great emblem made of a pair of bare breasts. To the west the door says 'Staff Room' and to the north the door says 'Ruby Class'. The hallway continues for a reasonable distance to the east.". The shape of Facility26 is L5/0-0-1-1-0-1. The grid position of Facility26 is <5,11,8>. Facility26 is west of Facility24.
To decide which number is the entry-rank of (R - Facility26):
	decide on 3.

[Rooms Adjacent to Upper Hallway]
Facility27 is an academic room. The printed name of Facility27 is "Staff Room". "This doesn't look like any staff room you've ever seen before. [if retiredTrainees > 0]A number of pieces of diapered human furniture can be found here. It truly is a unique sight to behold.[otherwise if diaper quest is 1]There's nothing here...[otherwise]Instead of any furniture there's just video cameras, piercing and tattoo needles held on giant robotic arms all poised and ready, pointing at... a gloryhole?![end if]". The shape of Facility27 is L5/0-0-0-1-0-0. The grid position of Facility27 is <5,10,8>. Facility27 is west of Facility26.
To decide which number is the entry-rank of (R - Facility27):
	decide on 6.
Definition: Facility27 (called R) is within vision:
	if R is Neighbour Finder or (R is next door and the rank of the player >= the entry-rank of R), decide yes;
	decide no.
Facility28 is an academic room. The printed name of Facility28 is "Science Lab". "A large metal lab bench has two metal bowls embedded into it. Maybe you can [bold type]craft[roman type] something in each.". The shape of Facility28 is L5/0-0-0-0-1-1. The grid position of Facility28 is <5,14,8>. Facility28 is east of Facility25. Facility28 is north of Facility15.
To decide which number is the entry-rank of (R - Facility28):
	decide on 3.

[Rooms Above Upper Hallway]
Facility29 is a lecture academic room. The printed name of Facility29 is "Ruby Training Room". "This 'training room' has rows of desks but no chairs. The walls are adorned with photos of [if diaper quest is 1]sexy adult women in dry diapers[otherwise]voluptuous women pleasuring themselves[end if].". The shape of Facility29 is L5/0-0-0-0-1-0. The grid position of Facility29 is <5,11,9>. Facility29 is north of Facility26.
To decide which number is the entry-rank of (R - Facility29):
	decide on 3.
Facility30 is a lecture academic room. The printed name of Facility30 is "Pink Diamond Training Room". "This 'training room' has a large circle of lit candles on the ground. The walls are adorned with photos of [if diaper quest is 1]sexy adult women using their diapers[otherwise]voluptuous women taking cocks in all their holes[end if].". The shape of Facility30 is L5/0-0-0-0-1-0. The grid position of Facility30 is <5,13,9>. Facility30 is north of Facility25.
To decide which number is the entry-rank of (R - Facility30):
	decide on 4.
Facility31 is an academic room. The printed name of Facility31 is "Trophy Hall". "A series of trophies, each for a different [if diaper quest is 1]baby related[otherwise]extremely lewd[end if] act, sit on shelves that line the east and west walls. To the north the door says 'Diamond Class'.". The shape of Facility31 is L5/0-0-1-0-1-0. The grid position of Facility31 is <5,12,9>. Facility31 is north of Facility24.
To decide which number is the entry-rank of (R - Facility31):
	decide on 4.
Facility32 is a lecture academic room. The printed name of Facility32 is "Diamond Training Room". "This room is fashioned like a [if diaper quest is 1]giant crib, covered in brightly coloured soft blankets and animal themed cushions, and populated by giant stuffed animals and baby toys[otherwise]porno studio, with cameras, spotlights and microphones on poles all trained in on a soft rug at the far end of the room[end if]. The only exit is behind you to the south, back into the Trophy Room.". The shape of Facility32 is L5/0-0-0-0-1-0. The grid position of Facility32 is <5,12,10>. Facility32 is north of Facility31.
To decide which number is the entry-rank of (R - Facility32):
	decide on 5.

[Facility33 to 35 are the dungeon]

[East Dungeon]
Facility33 is an academic room. The printed name of Facility33 is "Dungeon Hall". "Dungeon cells sit either side of this hidden extension to the hallway.". The shape of Facility33 is L5/0-0-1-0-1-1. The grid position of Facility33 is <5,16,6>. [Facility33 is east of Facility07.]
Report going when the player is in Facility33:
	change the east exit of Facility07 to Facility33; [As soon as the player steps into the hall from either cell we need to make the connection, otherwise the map button won't appear.]
	update Nviables of Facility07;
	update Nviables of Facility33.

Facility34 is an academic room. The printed name of Facility34 is "Dungeon Cell". "A dark cell. The cell has a permanently open doorway, but anyone cuffed to the chains attached to the wall would be unable to leave.". The shape of Facility34 is L5/0-0-1-0-0-0. The grid position of Facility34 is <5,16,5>. Facility34 is south of Facility33.
Facility35 is an academic room. The printed name of Facility35 is "Dungeon Cell". "A dark cell.". The shape of Facility35 is L5/0-0-0-0-1-0. The grid position of Facility35 is <5,16,7>. Facility35 is north of Facility33.

To decide which number is the entry-rank of (R - Facility33):
	decide on 6.
To decide which number is the entry-rank of (R - Facility34):
	decide on 6.
To decide which number is the entry-rank of (R - Facility35):
	decide on 6.

The Facility is a region. Facility01, Facility02, Facility03, Facility04, Facility05, Facility06, Facility07, Facility08, Facility09, Facility10, Facility11, Facility12, Facility13, Facility14, Facility15, Facility16, Facility17, Facility18, Facility19, Facility20, Facility21, Facility22, Facility23, Facility24, Facility25, Facility26, Facility27, Facility28, Facility29, Facility30, Facility31, Facility32, Facility33, Facility34, Facility35 are in The Facility.

To reveal the facility dungeon:
	change the east exit of Facility07 to Facility33;
	update Nviables of Facility07;
	update Nviables of Facility33;
	now Facility33 is seen;
	now Facility33 is discovered;
	now Facility34 is seen;
	now Facility34 is discovered;
	now Facility35 is seen;
	now Facility35 is discovered.

Carry out going west when the location of the player is Facility33:
	reveal the facility dungeon. [if we've exited via the secret doorway then we can return]
...
An all time based rule (this is the dungeon sentence progress rule):
	if dungeon chains is worn:
		...
		if dungeon-time > 40 and the player is not immobile:
			...
			let M be a random alive undefeated tutor;
...
To compute (M - a monster) dungeon locking:
	...
	if skeleton key is held:
		...
		now skeleton key is in Facility33;
	...
	repeat with N running through alive staff members:
		if N is regional, now N is unleashed;
		calm N;
		distract N.
...
To compute dungeon long term challenge of (M - a monster):
	if ex-princess is sex-enslaved and ex-princess is in Facility34:
		compute dungeon princess challenge of M;
	otherwise if ex-princess is diaper-enslaved and ex-princess is in Facility34:
	...
	if dungeon-favour >= 3 or dungeon-events >= 5:
		...
		if bondage protection > 0:
			repeat with C running through worn locked clothing:
				...
				unless K is a thing and K is not held by current-monster:
		...
		repeat with N running through fucked-silly staff members:
			now N is unleashed;
			if N is nurse, now N is in Facility11;
			if N is receptionist, now N is in Facility01;
		now Facility34 is not pink-smoky;
		display entire map;
		if class-time < 0, now class-time is 0; [so we don't go straight into reconditioning for being late]
...
Facility15 has a number called donations.
Check taking clothing when the player is in Facility15:
	if the noun is not held and the donations of Facility15 < 5 and mistress is alive and mistress is undefeated, say "The magic in the room somehow keeps the [ShortDesc of the noun] stuck to the ground! Maybe the magic will weaken if you leave a few of your own possessions here?" instead.

Carry out taking clothing when the player is in Facility15:
	if mistress is alive and mistress is undefeated:
		decrease the donations of Facility15 by 5;
		say "The magic runes around the ceiling and doorway [if the donations of Facility15 < 5]come back to life, glowing their powerful purple once again[otherwise]quickly pulse five times before returning to being inactive[end if].".

Report dropping clothing when the noun is in Facility15:
	if the noun is cursed:
		say "The magic runes around the ceiling and doorway turn black for a moment before [if the donations of Facility15 < 5]returning to their previous purple pulse[otherwise]returning to being grey and inactive[end if]. Maybe [if the noun is sure]because [end if]the [ShortDesc of the noun] was cursed?";
...
FacilityScenery01 is a thing. FacilityScenery01 is not portable. FacilityScenery01 is in Facility08. The printed name of FacilityScenery01 is "[TQlink of item described]marble bust[TQxlink of item described]". Understand "marble", "bust", "statue" as FacilityScenery01.

Figure of facilityScenery01 is the file "Env/Facility/marblebust1.png".

To decide which figure-name is the examine-image of (C - FacilityScenery01):
	decide on Figure of facilityScenery01.

The text-shortcut of FacilityScenery01 is "mrb".

To say ExamineDesc of (C - FacilityScenery01):
	say "A marble bust is on the wall behind the Royal Mistress[']s desk. It depicts a woman with stern features and a single finger pointing straight ahead[if piercing-stone is in the location of C]. There is a pure diamond ring on it[end if].".
