...
[!<SayGrabbedPrepOfMonsterInFuckhole>+

Displays some text describing a monster getting ready to penetrate the player that is grabbed by another monster. Basically just means we can't flip the player around like a bimbo patty

@param <Monster>:<M> A monster that is about to penetrate the player
@param <Monster>:<G> A monster that is grabbing the player
@param <Fuckhole>:<F> The fuckhole "M" is planning to penetrate

+!]
To say GrabbedPrep of (M - a monster) with (G - a monster) in (F - a fuckhole):
	do nothing.
...
To say PenPrep of (M - a monster) in (F - asshole):
	...
	let G be a random monster grabbing the player;
	if G is monster:
		say GrabbedPrep of M with G in F;
	otherwise if N is monster and O is monster:
...
To say GrabbedPrep of (M - a monster) with (G - a monster) in (F - asshole):
	say "[BigFuckerDesc of M] takes advantage of your compromising position and grabs your waist.".
...
To say GrabbedPrep of (M - a monster) with (G - a monster) in (F - vagina):
	say "[BigFuckerDesc of M] takes advantage of your compromising position and grabs your legs.".
...
To say FriendlyVeryLooseVaginaPenetrationFlav of (M - a monster):
	...
	otherwise:
		say "[one of]You giggle happily as [he of M] slides [his of M] [DickDesc of M] into your [vagina], working your hips back and forth as [he of M] smacks your [AssDesc] and gropes your [BreastDesc]. It's even more fun when you get to do the work![or]You proudly look over your shoulder as [he of M] slides [his of M] [DickDesc of M] into your loose [vagina], grinning at [him of M] as [he of M] begins to thrust. You're loose enough that [he of M] can go all out from the get go, [his of M] [if M is a balls-haver]balls[otherwise]hips[end if] slapping audibly against you as [his of M] hands grab hold of your waist.[or]You push backward against [him of M] as [his of M] [DickDesc of M] slides into your [vagina], glancing over your shoulder to [if there is a worn ballgag]stare seductively at [FuckerDesc of M] as you begin to work your hips back and forth.[otherwise]seductively lick your lips as you begin to work your hips back and forth.[end if][at random]".
...
To say sexSubmitSplitFlav of (M - a monster) in (O - an orifice):
	if the player is not possessing a vagina:
		if the size of penis < 4 and the player is presenting as female and the player is gendered male:
			say "[BigFuckerDesc of M] fucks you like the girl you really are!";
		otherwise if the size of penis < 4 and the player is possessing a penis and the bimbo of the player < 14:
			say "[BigFuckerDesc of M] pounds your [asshole] hard and fast. You just can't get over how tiny your [ShortDesc of penis] is compared to [hers of M].";
		otherwise if the size of penis < 4 and the player is possessing a penis:
			say "[BigFuckerDesc of M] pounds your [asshole] hard and fast. You feel proud of how tiny your [ShortDesc of penis] is compared to [hers of M].";
		otherwise if the bimbo of the player < 3:
			say "[BigFuckerDesc of M]'s [if M is a balls-haver]balls repeatedly slap your taint[otherwise]hips repeatedly clap your [AssDesc][end if] as [he of M] pistons in and out of your [asshole], as if to remind you how little you've actually done to stop [him of M].";
		otherwise if the bimbo of the player < 5:
			say "Shocks of pleasure ripple through your [DickDesc of M] as [he of M] pounds your [asshole]. And you thought it was humiliating before...";
		otherwise if the bimbo of the player < 7:
			say "[BigFuckerDesc of M]'s [DickDesc of M] relentlessly pounds your sensitive prostate, reminding you how humiliating it is to get fucked like this.";
	...
	otherwise:
		if the player is horny:
			if the relevant sex addiction of M < 10:
				say "[BigFuckerDesc of M] fucks your [variable O] hard and fast. Your cheeks burn as [he of M] reaches between your legs,immediately discovers when [he of M] discovers just how wet you are.";
			otherwise:
				say "[BigFuckerDesc of M] fucks your [variable O] hard and fast, [if O is vagina]all too aware of how wet this is making you[otherwise][his of M] hand between your legs leaving no doubt as to how wet this is making you[end if].";
		otherwise:
			say "[BigFuckerDesc of M] reaches between your legs, teasing your clit as [he of M] slams in and out of your [variable O].".
...
To compute unprotected climax of (M - a monster) in (F - fuckhole):
	if portal-hotpants is worn or M is willing to creampie F, compute creampie of M in F;
