...
Check going east when the player is in Tutorial01:
	unless navy-monokini is worn, say "You should probably make sure that you're wearing something before you continue.[unless navy-monokini is held] What's in that sack, I wonder?[end if]" instead.
