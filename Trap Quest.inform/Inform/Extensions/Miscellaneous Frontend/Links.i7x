...
To compute smart links:
	...
	if the player is prone and pink-spraybottle is worn and the milk-puddle of the location of the player + the semen-puddle of the location of the player + the slime-puddle of the location of the player >= 1, say "[link]clean mess[end link] ";
		...
		unless the player is in danger:
			...
			if witch is in the location of the player and witch is friendly:
				repeat with F running through held diapers:
					if the known-slime-soak of F + the known-mess of F > 0:
						if F is not catalogued, say "[F] ";
						now F is catalogued;
				repeat with F running through held vessels:
