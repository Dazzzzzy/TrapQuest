	...
	otherwise:
		...
		if player-numerical-response is not 0:
			...
			if T matches the text "incontinence":
				...
				now auto is 1;
				if diaper messing >= 3:
					say "'[one of]I can't believe I've let myself become this much of a baby. I never should've started wearing diapers! I didn't even mean to use them, they were just supposed to be a joke! But they were so hard to get off, so I thought what could the harm be? Then after that diaper was fully used (why let it go to waste?) and I changed myself, the [SlimeTarget] was so far away when I had to go that it only made sense to use my diaper! At this point I've forgotten what a pot - I mean [SlimeTarget], feels like[or]I tried using my training [SlimeTargetP] today, I had the perfect plan! I sat on the [SlimeTargetP] with my favourite pink diaper on, all I had to do when I felt the slightest need to go is take it off! I waited, and waited, and waited, and I never felt the need to go! I finally decided to check it, and it was already soaking wet and filled to the brim! I went who knows how long without even realising I had soiled my diaper[or]Why do they make it so hard to stop using diapers! They're [italic type]so[roman type] much more convenient than using the [SlimeTargetP], of course I started only going [SlimeTargetP] in them! But now that everyone sees me for the pathetic [SlimeTargetP]pants baby, I want to start using the [SlimeTargetP] again, but getting [SlimeTargetP] trained is so hard[at random]! I want a do-over.' You cringe at what's written on the page, partly because of the [if the diaper addiction of the player > 14]adult[end if]wording, but also because it perfectly represents how you've felt since you completely lost control of your [SlimeContainer] and bowels. Suddenly, the book begins to glow, and the words start erasing themselves from the page! You feel light-headed, and fall to your knees, your ass in the air, and begin grunting, before suddenly [if D is not total protection]feeling a warm glow from your diaper, as it miraculously repairs itself! Better yet, you can feel[otherwise]feeling[end if] your [SlimeContainer] and bowels again! They feel awfully full, that is until you feel them begin to empty into your diaper!";
					try kneeling;
					now rectum is 12;
					...
					try urinating;
				otherwise:
					say "'[one of]I can't believe I've let myself become this much of a baby. I never should've started wearing diapers! I didn't even mean to use them, they were just supposed to be a joke! But they were so hard to get off, so I thought what could the harm be? Then after that diaper was fully used (why let it go to waste?) and I changed myself, the [SlimeTarget] was so far away when I had to go that it only made sense to use my diaper! At this point I've forgotten what a pot - I mean [SlimeTarget], feels like[or]I tried using my training [SlimeTargetP] today, I had the perfect plan! I sat on the [SlimeTargetP] with my favourite pink diaper on, all I had to do when I felt the slightest need to go is take it off! I waited, and waited, and waited, and I never felt the need to go! I finally decided to check it, and it was already soaking wet! I went who knows how long without even realising I had soiled my diaper[or]Why do they make it so hard to stop using diapers! They're [italic type]so[roman type] much more convenient than using the [SlimeTargetP], of course I started only going [SlimeTargetP] in them! But now that everyone sees me for the pathetic [SlimeTargetP]pants baby, I want to start using the [SlimeTargetP] again, but getting [SlimeTargetP] trained is so hard[at random]! I want a do-over.' You cringe at what's written on the page, partly because of the [if the diaper addiction of the player > 14]adult[end if]wording, but also because it perfectly represents how you've felt since you completely lost control of your [SlimeContainer] and bowels. Suddenly, the book begins to glow, and the words start erasing themselves from the page! You feel light-headed, and fall to your knees, before suddenly [if D is not total protection]feeling a warm glow from your diaper, as it miraculously repairs itself! Better yet, you can feel[otherwise]feeling[end if] your [SlimeContainer] again! It feels awfully full, until you feel it begin to empty into your diaper!";
					try kneeling;
					now the bladder of the player is 10;
					now delayed urination is 1;
					try urinating;
