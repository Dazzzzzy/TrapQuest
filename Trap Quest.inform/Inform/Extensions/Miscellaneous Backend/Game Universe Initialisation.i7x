...
To decide which number is cruel christmas:
	if berri fetish is 1 and christmas content is 1 and diaper messing >= 7 and tough-shit is 1, decide on 1;
	decide on 0.
...
To Start The Machine:
	...
	otherwise if nursery resident is 1 or cruel christmas is 1:
		...
		now Dungeon12 is not unvisited;
		now Dungeon11 is not discovered;
		now Dungeon11 is not seen;
		now Dungeon11 is not unvisited;
		wait until animations are over;
		if cruel christmas is 1:
		...
		otherwise:
			...
			now the player is in DungeonNursery;
	otherwise:
		wait until animations are over;
	...
	if cruel christmas is 1:
		...
		now gold-hairclip is worn by the player;
		now gold-hairclip is cursed;
		now the quest of gold-hairclip is berri-quest;
		...
		say "[bold type]Everything is black.[variable custom style][line break]Where am I?![roman type][line break]You feel like you're stuck cramped, bent over in a fetal position, inside some kind of... human-sized box?[variable custom style][line break]Wait... Am I wearing a STUPIDLY GIANT DIAPER?! I'm freaking out! Did I choose too many crazy cruel starting options?! HEEEELP![roman type][line break]";
	otherwise:
		...
		otherwise if nursery resident is 1:
			if christmas content is 0:
				let TD be the chosen trap diaper;
				summon TD uncursed;
			...
			now the charge of dungeon nursery crib is 30;
			regionally place matron;
			let DD be a random worn dress;
			say "You wake up inside [NameDesc of dungeon nursery crib], wearing a locked [MediumDesc of DD], and you can feel layers of padding underneath. And you can feel that the diaper you're wearing is far from dry![line break][variable custom style]Oh god, what have I gotten myself into already?![roman type][line break]The immediate question, then, is do you try to escape, or do you wait for someone to arrive and hopefully let you free?";
		otherwise:
...
To initialise wardrobe:
	...
	if berri fetish is 1 and gold-hairclip is not worn, now gold-hairclip is in pink wardrobe;
