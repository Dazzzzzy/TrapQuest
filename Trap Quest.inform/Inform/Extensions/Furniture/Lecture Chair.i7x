...
A lecture chair has a truth state called alchemist-scene-1. A lecture chair has a truth state called alchemist-scene-2.

To say ExamineDesc of (C - a lecture chair):
	say "An academic-style chair with desk. Looks like it's bolted to the floor of the lecture hall.".
...
To compute furniture resting on (C - a lecture chair):
	...
	if diaper quest is 0 and the class of the player is alchemist:
		...
		otherwise if alchemist-scene-1 of C is false and the number of worn blue scrunchies is 1 and the player is not getting lucky:
			...
			say "The woman and the other [']trainees['] dressed as slutty alchemists disappear as quickly as they appeared. You're left alone, feeling substantially more self-conscious about your appearance than before.";
			now alchemist-scene-1 of C is true;
		[otherwise if alchemist-scene-2 of C is false and (the number of worn blue scrunchies is 2 or there is a worn pigtail-scrunchie) and the player is not getting lucky:
			say "[second custom style]'Hello everyone and welcome to this cosplay class! I see you're well-dressed for the event.'[roman type][line break]When you try to move your hands, you find that your wrists have been bolted down onto your lecture desk with strong metal cuffs![line break][variable custom style]What the hell?! Where did they come from?![paragraph break][second custom style]'As a member of the Slutty Alchemist Cosplay Society, it's important to always be pushing ourselves to look as provocative and erotic as possible. At first we were thinking of giving you all pigtails, but then we realised that we could go one step further.'[roman type][line break]Strapped down by your wrists, there's nothing you can do to stop her taking your scrunchie, and replacing it with two helium baloons! This is humiliating enough... But then she shows you a mirror and you can see what is written on each - the left one says 'FUCK', and the right one says 'DOLL'![line break][variable custom style]Oh my god![roman type][line break]";
			let H be a random worn blue scrunchie;
			silently transform H into pair of helium balloons;
			say "The woman and the other [']trainees['] dressed as slutty alchemists disappear as quickly as they appeared. You're left alone, feeling substantially more self-conscious about your appearance than before.";
			now alchemist-scene-2 of C is true;]
		otherwise:
		...
		otherwise if the player is diaper focused or diaper quest is 1 or the player is an adult baby or (there is a worn diaper and a random number between 1 and 2 is 1):
			...
			if there is a worn total protection soilable knickers and asshole is not actually occupied and diaper messing >= 3:
				if diaper messing is 3:
					say "You begin to groan as a flow of squishy mush squeezes its way out of your bottom, accompanied by your [SlimeContainer] releasing itself at full blast. Your diaper is filled rapidly and noisily at both ends. ";
			...
			otherwise:
				...
				try urinating;
			say "The other [']trainees['] around you giggle and point, as you become the laughing stock of the nursery. ";
