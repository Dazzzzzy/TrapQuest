...
To compute BabyChairReaction of (M - a monster):
	say "[BigNameDesc of M] looks at you and grins.[line break][speech style of M]'[one of]Yes you are a good [boy of the player], aren't you?'[or]Good [boy of the player]! [if M is male][daddytitle of M][otherwise]Nanny[end if] is very impressed.'[or]Aww, does little sweetie want a gold sticker?'[in random order][roman type][line break]";
	moderateHumiliate;
