	...
	if the largeness of breasts >= 5 or there is worn breast hiding clothing:
		...
		if SB > 1:
			if the titfuck addiction of the player > 1:
				say "[if the titfuck addiction of the player <= 2]You find the thought of having a [manly-penis] in between your breasts rather repulsive[otherwise if the titfuck addiction of the player <= 3]You find the idea of letting [men of male-m] fuck your breasts distasteful[otherwise if the titfuck addiction of the player <= 5 and the anal sex addiction of the player <= 5 and the vaginal sex addiction of the player <= 5]You don't mind giving titjobs. It's often better than the alternatives[otherwise if the titfuck addiction of the player <= 5]You don't mind giving titjobs, but you usually find other types of sex more fun[otherwise if the titfuck addiction of the player <= 7]You love pleasuring [men of male-m] with your boobs! It's just so sexy and convenient[otherwise if the titfuck addiction of the player <= 9]You get really turned on by your breasts being used as fuckpillows for some [man of male-m] to sandwich [his of male-m] thick meat between[otherwise]Whenever your cleavage is empty, you ache to feel another phallic object thrusting in and out of its voluptuous fold[end if].";
...
To say GrossStuff:
	say "gross stuff[one of][if diaper messing >= 6], such as the smell of messy diapers[otherwise if a2m fetish >= 1], such as the taste of buttholes[otherwise], for example licking sweaty feet[end if][or][stopping]".
To say DetailedGrossStuff:
	say "[if diaper messing >= 6]the smell of messy diapers[otherwise if a2m fetish >= 1]the taste of buttholes[otherwise]licking sweaty feet[end if] and other gross stuff".

[!<TheGrossnessAddictionDescriptionRule>+

We explain how much the player likes bad tastes and smells.
