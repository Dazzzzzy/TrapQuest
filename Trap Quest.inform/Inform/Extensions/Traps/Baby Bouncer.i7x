...
To trigger (Y - a baby bouncer):
	...
	if C is clothing:
		say "They suddenly seem to change their mind, apparently realising that your [ShortDesc of C] makes them unable to place you in the bouncer as they had clearly intended. [if the bimbo of the player < 14]Phew![otherwise]Aww...[end if]";
...
To say SexHoldBackFlav of (Y - a baby bouncer):
