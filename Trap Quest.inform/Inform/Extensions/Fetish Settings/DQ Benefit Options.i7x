...
"Maximum Incontinence: [if incontinence protection is 0]Extreme incontinence where you don't even automatically notice you've soiled your diaper - 0 points spent[otherwise if incontinence protection is 1]Full incontinence - 2 points spent[otherwise if incontinence protection is 2]Very incontinent - 4 points spent[otherwise if incontinence protection is 3]Quite incontinent - 6 points spent[otherwise if incontinence protection is 4]A little incontinent - 8 points spent[otherwise]No incontinence - 10 points used[end if] (costs 2 points per level)"	--	--	incontinence protection toggle rule
...
"Slower timers (Things like the royal training class bell and doom quest ritual are more forgiving.) - ([if slower timers is 1]Not enabled - costs 2 points to enable[otherwise][bold type]Enabled[roman type] - 2 points used[end if])"	--	--	slower timers toggle rule
