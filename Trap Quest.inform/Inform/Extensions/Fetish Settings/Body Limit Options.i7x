...
This is the max breast size rule:
	...
	otherwise if points count > 0 or diaper quest is 0:
...
This is the max ass size rule:
	if (points count > 0 or diaper quest is 0) and max ass size - extreme proportions fetish > min ass size, increase choice in row 28 of the Table of Player Options by 1;
...
This is the max belly size rule:
	if (points count > 0 or diaper quest is 0) and max belly size points < 3, increase choice in row 37 of the Table of Player Options by 1;
...
This is the min penis size rule:
	...
	otherwise if min penis size points < (5 - (natural body shape * 2)) and the player is male and (points count > 0 or tg fetish >= 1 or diaper quest is 0):
...
This is the trap fetish toggle rule:
	if tg fetish > 0 and trap fetish is 0 and (points count >= 3 or diaper quest is 0), now choice in row 34 of the Table of Player Options is 1;
