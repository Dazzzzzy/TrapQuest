Facility Stuff by DQ Only Stuff begins here.

tutor-hannah is an emerald-tutor.
The training-tutor of pledge-training is tutor-kaylee.

Part - Ruby Tutor Brooke

tutor-brooke is a ruby-tutor.
Definition: tutor-brooke is dark skinned: decide yes.

The text-shortcut of tutor-brooke is "tebr".

Figure of brooke is the file "NPCs/Facility/Tutor/tutor6a.png".
Figure of brooke defeated is the file "NPCs/Facility/Tutor/tutor6b.png".
Figure of Tutor Brooke Cutscene 1 is the file "Special/Cutscene/cutscene-brooke-race1.jpg".
Figure of Tutor Brooke Cutscene 2 is the file "Special/Cutscene/cutscene-brooke-ball1.jpg".

To decide which figure-name is the pacified-image of (M - tutor-brooke):
	if diaper messing < 3, decide on figure of Missing NPC;
	decide on figure of brooke defeated.
To decide which figure-name is the monster-image of (M - tutor-brooke):
	decide on figure of brooke.

To say MonsterDesc of (M - tutor-brooke):
...
The tutor-name of tutor-brooke is "Brooke".

To say WhoAnswer of (M - tutor-brooke):
...
To say WhereAnswer of (M - tutor-brooke):
...
trainee-jennifer is an amicable trainee.
The max-rank of trainee-jennifer is 4.

Definition: trainee-jennifer is dark skinned: decide yes.

The text-shortcut of trainee-jennifer is "trje".

Figure of jennifer rank 1 is the file "NPCs/Facility/Trainee/trainee6a.png".
Figure of jennifer rank 2 is the file "NPCs/Facility/Trainee/trainee6b.png".
Figure of jennifer rank 3 is the file "NPCs/Facility/Trainee/trainee6c.png".
Figure of jennifer rank 3 diaper wet is the file "NPCs/Facility/Trainee/trainee6d.png".
Figure of jennifer rank 3 diaper messed is the file "NPCs/Facility/Trainee/trainee6e.png".

To decide which figure-name is the monster-image of (M - trainee-jennifer):
...
Part - Innocent Trainee Lottie

trainee-lottie is a innocent trainee.

The text-shortcut of trainee-lottie is "trlo".

Figure of lottie is the file "NPCs/Facility/Trainee/trainee9.png".

To decide which figure-name is the monster-image of (M - trainee-lottie):
	decide on figure of lottie.

To say MonsterDesc of (M - trainee-lottie):
	say "This tall brunette is wearing a modest alchemist uniform with a tartan dress. [big he of M] has a red pacifier in [his of M] mouth [if the current-rank of M is 1]and seems a bit unsure about it[otherwise]which [he of M] is sucking on nervously[end if]. [big he of M] is studying a little carton of what looks like [if diaper messing >= 3]fibre supplements[otherwise]caffeinated teabags[end if] with a frown.".

The max-rank of trainee-lottie is 1.

To update name of (M - trainee-lottie):
	now the trainee-print of M is "little learner";
	if the current-rank of M is 1:
		now the trainee-name of M is "Lottie";
	otherwise:
		now the trainee-name of M is "Lollie".

To say StoryAnswer of (M - trainee-lottie):
...
To say WhereAnswer of (M - trainee-lottie):
...
To say EscapeAnswer of (M - trainee-lottie):
...
To say AdviceAnswer of (M - trainee-lottie):
	say "[speech style of M]'Always read the label.'[roman type][line break]".

Part - Innocent Trainee Polly

[trainee-polly is a innocent trainee.

The text-shortcut of trainee-polly is "trpo".

Figure of polly is the file "NPCs/Facility/Trainee/trainee20.png".

To decide which figure-name is the monster-image of (M - trainee-polly):
	decide on figure of polly.

To say MonsterDesc of (M - trainee-polly):
...
The min-rank of trainee-polly is 3.
The current-rank of trainee-polly is 3.
The max-rank of trainee-polly is 4.

To update name of (M - trainee-polly):
	now the trainee-print of M is "beautiful babydoll";
...
Part - Innocent Trainee Rachel

trainee-rachel is a innocent trainee.

The text-shortcut of trainee-rachel is "trrs".

Figure of rachel 1 is the file "NPCs/Facility/Trainee/trainee28a.jpg".
Figure of rachel 2 is the file "NPCs/Facility/Trainee/trainee28b.jpg".
Figure of rachel 3 is the file "NPCs/Facility/Trainee/trainee28c.jpg".

To decide which figure-name is the monster-image of (M - trainee-rachel):
...
To say MonsterDesc of (M - trainee-rachel):
...
The current-rank of trainee-rachel is 2.
The max-rank of trainee-rachel is 4.

To update name of (M - trainee-rachel):
	if the current-rank of M < 3:
		now the trainee-name of M is "Rachel";
		now the trainee-print of M is "blushing businesswoman";
	otherwise if the current-rank of M is 3:
		now the trainee-name of M is "Ray";
		now the trainee-print of M is "shining secretary";
	otherwise:
		now the trainee-name of M is "Ray-Ray";
		now the trainee-print of M is "bright babygirl";

To say WhoAnswer of (M - trainee-rachel):
	say "[speech style of M]'My name is [trainee-name of M] Sunshine. I know, how appropriate...'[roman type][line break]".

To say StoryAnswer of (M - trainee-rachel):
...
To say WhereAnswer of (M - trainee-rachel):
...
To say AdviceAnswer of (M - trainee-rachel):
...
To say EscapeAnswer of (M - trainee-rachel):
...
To compute teaching offer of (M - trainee-rachel):
	say "[speech style of M]'No, sorry, I'm not any good at this yet. I'm the one who needs extra help...'[roman type][line break]".

Part - Nasty Trainee Tanya

[trainee-tanya is a nasty trainee.

The text-shortcut of trainee-tanya is "trta".

Figure of tanya is the file "NPCs/Facility/Trainee/trainee16.png".

To decide which figure-name is the monster-image of (M - trainee-tanya):
	decide on figure of tanya.

To say MonsterDesc of (M - trainee-tanya):
...
The max-rank of trainee-tanya is 2.

To update name of (M - trainee-tanya):
	if the current-rank of M is 1:
		now the trainee-name of M is "Tanya";
		now the trainee-print of M is "rainbow rebel";
		now the text-shortcut of trainee-tanya is "trta";
	otherwise:
		now the trainee-name of M is "Temper";
		now the trainee-print of M is "lil monster";
		now the text-shortcut of trainee-tanya is "trte".

To say StoryAnswer of (M - trainee-tanya):
...
Definition: a trainee is scrunchie-giving:
	if it is trainee-tanya, decide yes;
	decide no.]

Part - Nasty Trainee Emily

trainee-emily is a nasty trainee.

The text-shortcut of trainee-emily is "trem".

Figure of emily is the file "NPCs/Facility/Trainee/trainee22.jpg".

To decide which figure-name is the monster-image of (M - trainee-emily):
	decide on figure of emily.

To say MonsterDesc of (M - trainee-emily):
...
The current-rank of trainee-emily is 3.
The max-rank of trainee-emily is 4.

To update name of (M - trainee-emily):
	if the current-rank of M is 3:
		now the trainee-name of M is "Emily";
		now the trainee-print of M is "elegant enfant";
	otherwise:
		now the trainee-name of M is "Ember";
		now the trainee-print of M is "elegant emptier".

To say WhoAnswer of (M - trainee-emily):
...
To say WhereAnswer of (M - trainee-emily):
...
To say EscapeAnswer of (M - trainee-emily):
...
To say StoryAnswer of (M - trainee-emily):
...
To say AdviceAnswer of (M - trainee-emily):
...
To compute teaching offer of (M - trainee-emily):
	say "[speech style of M]'You can't teach looks. You're always going to be ugly, too bad.'[roman type][line break]".

Part - Tryhard Trainee Raye

[trainee-raye is a tryhard trainee.

The text-shortcut of trainee-raye is "trra".

Figure of raye 1 is the file "NPCs/Facility/Trainee/trainee21a.png".
Figure of raye 2 is the file "NPCs/Facility/Trainee/trainee21b.png".
Figure of raye 3 is the file "NPCs/Facility/Trainee/trainee21c.png".

To decide which figure-name is the monster-image of (M - trainee-raye):
...
To say MonsterDesc of (M - trainee-raye):
...
The min-rank of trainee-raye is 3.
The current-rank of trainee-raye is 3.
The max-rank of trainee-raye is 6.

To update name of (M - trainee-raye):
	if the current-rank of M is 3:
		now the trainee-name of M is "Raye";
		now the trainee-print of M is "padded flasher";
	otherwise if the current-rank of M is 4:
		now the trainee-name of M is "Rae";
		now the trainee-print of M is "skirtless babygirl";
	otherwise:
		now the trainee-name of M is "Rainbow";
		now the trainee-print of M is "desperate diapergirl".

To say StoryAnswer of (M - trainee-raye):
...
To say WhereAnswer of (M - trainee-raye):
...
Part - Ditzy Trainee Minnie

trainee-minnie is a ditzy trainee.

The text-shortcut of trainee-minnie is "trmi".

Figure of minnie is the file "NPCs/Facility/Trainee/trainee27.png".
...
To update name of (M - trainee-minnie):
	if the current-rank of M is 4:
		...
		now the trainee-print of M is "misbehaving minx";
	otherwise:
		now the trainee-name of M is "Mimi";
		now the trainee-print of M is "mindless minx";
...
To say WhoAnswer of (M - trainee-minnie):
	say "[speech style of M]'[if the current-rank of M is 4][trainee-name of M], I think[otherwise][trainee-name of M] can't even remember [his of M] name[end if]...'[roman type][line break]".

To say WhereAnswer of (M - trainee-minnie):
...
mistress has a number called chess-boredom.
chess-training has a number called chess-refused.
chess-training has a number called trainee-latest-percent.
chess-training has a number called player-latest-percent.
...
Figure of chess table is the file "Env/Facility/chesstable1.jpg".
...
To render chess state:
	...
	otherwise if player-latest-percent of chess-training >= 4:
		if trainee-latest-percent of chess-training >= 4, now temporary-map-figure is Figure of chess cutscene 2;
		otherwise now temporary-map-figure is Figure of chess cutscene 2c;
	otherwise:
		if trainee-latest-percent of chess-training >= 4, now temporary-map-figure is Figure of chess cutscene 2d;
...
To construct unique buttons for (T - chess table):
	if chess-victor of chess-training is 1 and ButtonTableFull is 0:
...
To compute teaching of (L - chess-training):
	...
	if the player is bimbo consenting:
		...
		say "[BigNameDesc of M] smiles warmly.[line break][speech style of M]'Oh, well volunteered! The mistress will be so [please]d. You'll both need one of these, and I'm afraid you're not allowed any other clothing.'[roman type][line break]";
		...
		now the trainee-extra-diapers of ST is 3;
		allocate 0 seconds;
	...
	otherwise:
		...
		otherwise:
			say ". ";
		say "I'm afraid that until we get two volunteers for this game, or the mistress gets bored of asking, we're not going to be able to have any other training sessions. So for now class is cancelled!'[roman type][line break][big he of M] politely gestures for you all to leave the room.";
...
chess-training has a number called currently-messing. [Is the player currently unable to think or act because of a messy episode?]

To compute chess time:
	let ST be chess-opponent of chess-training;
	if currently-messing of chess-training is 1, compute chess messing; [messing continues]
	if chess-turn of chess-training is 1: [Opponent takes her turn]
		let diffNeeded be 5;
		if the lost-pieces of chess-training >= 7 or the trainee-lost-pieces of chess-training >= 7, now diffNeeded is 4;
		if the lost-pieces of chess-training >= 10 or the trainee-lost-pieces of chess-training >= 10, now diffNeeded is 3;
		if the lost-pieces of chess-training >= 13 or the trainee-lost-pieces of chess-training >= 13, now diffNeeded is 2;
		if (the lost-pieces of chess-training > 12 and the lost-pieces of chess-training > the trainee-lost-pieces of chess-training) or (the lost-pieces of chess-training - trainee-lost-pieces of chess-training >= diffNeeded), compute opponent checkmate;
		otherwise compute opponent chess turn;
		if the lost-pieces of chess-training > 13 and the lost-pieces of chess-training > the trainee-lost-pieces of chess-training:
			compute opponent checkmate;
		otherwise if the chess-turn of chess-training is 0 and (the trainee-lost-pieces of chess-training > 12 or (the trainee-lost-pieces of chess-training - lost-pieces of chess-training >= diffNeeded)):
			compute checkmate;
	...
	if the chess-victor of chess-training is 0:
		...
		if chess-turn of chess-training is 0: [Who's getting force-fed?]
		...
		otherwise:
			...
			increase the trainee-rectum of chess-training by 2;
		if currently-messing of chess-training is 0:
			compute wallowing;
		...
		render chess state;
		if currently-messing of chess-training is 0:
			if the chess-victor of chess-training is 0, say "You have [bold type][16 - lost-pieces of chess-training][roman type] pieces left, and [NameDesc of ST] has [bold type][16 - trainee-lost-pieces of chess-training][roman type] pieces left. Your diaper is [if player-latest-percent of chess-training > 0][player-latest-percent of chess-training][end if]0% of the way towards your pressure plate, and [NameDesc of ST][']s diaper is [if trainee-latest-percent of chess-training > 0][trainee-latest-percent of chess-training][end if]0% of the way towards the other pressure plate.";
...
To compute opponent chess turn:
	...
	if a random number between 5 and 25 < trainee-rectum of chess-training:
		...
		compute trainee chess soiling;
		now the chess-turn of chess-training is 1; [Messing doesn't end their turn]
	otherwise if a random number between 1 and (11 + (mess-factor / 3)) > 4 and the trainee-great-move of chess-training > 0 and the trainee-diaper of chess-training < 50: [The more they're winning the diaper game or losing the chess game, the more time they spend thinking]
		say "[BigNameDesc of ST] keeps thinking.";
		now the chess-turn of chess-training is 1; [Thinking doesn't end their turn]
	otherwise if trainee-great-move of chess-training <= 0 and a random number between 1 and 3 > 1:
		if trapping-move of chess-training > 1000: [the player was trapping]
			...
			now the chess-turn of chess-training is 1; [Doesn't end their turn]
		otherwise:
	...
	otherwise:
		...
		reset chess opponent planning;
		if R is 1:
			if aggression of chess-training is 1 or a random number between 1 and 3 is 1:
...
To decide which number is chess-thinking-penalty:
	let X be 0;
	if player-bladder-penalty of chess-training >= 5, increase X by the player-bladder-penalty of chess-training;
...
To compute chess players thinking:
	...
	let STI be 3 - ((a random number between 0 and the trainee-rectum of chess-training) / 5);
...
To compute trainee chess soiling:
	increase the trainee-diaper of chess-training by the trainee-rectum of chess-training;
	let ST be the chess-opponent of chess-training;
	increase the trainee-diaper-mess of ST by 1;
	if the trainee-diaper of chess-training < 55:
		now the trainee-latest-percent of chess-training is (trainee-diaper of chess-training * 10) / 55;
		if the trainee-diaper of chess-training > 5, say "[big his of ST] diaper visibly bulges and expands until it is about [bold type][trainee-latest-percent of chess-training]0%[roman type] of the way to the pressure plate[one of] that triggers your victory and freedom[or][stopping].";
	otherwise:
		compute chess win;
	now the trainee-rectum of chess-training is 0;
...
To compute chess messing:
	...
	if currently-messing of chess-training is 0: [only happens on the first turn of a messing episode]
	...
	now the currently-messing of chess-training is 1;
	MessUp D by mess-amount;
	decrease rectum by mess-amount;
	if rectum <= 1:
		now rectum is 1;
		now the currently-messing of chess-training is 0;
	...
	if the mess of D < 30:
		let PLP be the player-latest-percent of chess-training;
		now the player-latest-percent of chess-training is the mess of D / 3;
		if PLP < the player-latest-percent of chess-training and the mess of D > 3, say "Your diaper stretches and expands to the point where it's about [bold type][the mess of D / 3]0%[roman type] of the way down to the pressure plate![if debuginfo > 0][line break][input-style]([mess of D] / 30)[roman type][line break][end if]";
	...
	let failsafe be 20;
	while M is the chess-opponent of chess-training and failsafe > 0:
		decrease failsafe by 1;
		now M is a random trainee in the location of the player;
	unless M is the chess-opponent of chess-training or M is nothing, compute chess diaper reaction of M.
...
To compute chess diaper reaction of (M - a trainee):
...
To compute chess masturbation:
	...
	unless M is the chess-opponent of chess-training, compute chess masturbation reaction of M.
...
To compute chess move input:
	...
	if chess-turn of chess-training is 0:
		if the trainee-lost-pieces of chess-training < 14 and the lost-pieces of chess-training < 14, set numerical response 1 to "make a dangerous aggressive move";
		if defensive-move of chess-training <= 0, set numerical response 2 to "make a dangerous defensive move";
...
To compute chess win reward:
	...
	say "[BigNameDesc of M] speaks again.[line break][speech style of M]'Now, let's allow [trainee-name of ST] to sit and... [']stew['] on [his of ST] failings! Nobody is allowed to release [him of ST], understand? Okay, assembly is over!'[roman type][line break]The trainees and staff begin to disperse, leaving nothing to prove that the event even happened except the [chess piece] in your hand and the poor [boy of ST] still locked in [his of ST] chair on the stage.";
...
To compute chess loss punishment:
	...
	say "[speech style of M]'And now, it's punishment time! Hehehe... Go on darlings, take these pens. It's time to get creative!'[roman type][line break]You wrestle in vain against your bonds as the trainee body advances on the stage, permanent markers in hand. Soon you are surrounded by them, and two hold your hands as the rest cover your mostly-naked body in humiliating phrases.";
	summon loser tattoo;
...
enema-race-training is a training session. The training-tutor of enema-race-training is tutor-brooke.

To say TrainingSessionTitle of (L - enema-race-training):
	say "Enema Run 2018".
...
To compute teaching of (L - enema-race-training):
	let M be the training-tutor of L;
	set up gym training session of M;
	let D be plain-massive-diaper;
	let S1 be a random trainee in the location of the player;
	let S2 be a random trainee in the location of the player;
	while the number of trainees in the location of the player > 1 and S1 is S2:
		now S2 is a random trainee in the location of the player;
	...
	now the trainee-extra-diapers of S2 is 2;
	...
	now temporaryYesNoBackground is figure of tutor brooke cutscene 1;
	...
	if S1 is the player:
		...
		if D1 >= 0:
			...
			update trainees; [an important line which makes boring old trainees disappear and new cool ones appear]
		otherwise:
			say "[speech style of M]'What a great race! [trainee-name of S2], congratulations on your win. You deserve this.'[roman type][line break]";
			promote S2;
	...
	otherwise:
		...
		if diaper messing >= 3, appropriate-cutscene-display figure of tutor brooke cutscene 1 with priority 3;
...
dodgeball-training is a training session. The training-tutor of dodgeball-training is tutor-brooke.

To say TrainingSessionTitle of (L - dodgeball-training):
	say "Diaper Dodgeball".

Definition: dodgeball-training is training-appropriate:
	if diaper messing >= 3, decide yes;
	decide no.

To compute teaching of (L - dodgeball-training):
	allocate 30 seconds;
	let M be the training-tutor of L;
	set up gym training session of M;
	let D be a random worn diaper;
	...
	say "You all obediently follow [NameDesc of M] to the gym. Inside the outer racetrack, a large square box has been drawn on the ground in chalk. A straight line goes straight through the middle dividing the square into two evenly sized rectangles. A large sign has been put up at the side that reads 'DIAPER BALL TRYOUTS'. [one of]Uhm, this sounds... unique[or]Here we go again[stopping].[line break][speech style of M]'Ah yes, I love diaperball season. Instead of having to limit myself to working with one or two of you at once, I can just have you all play for your bowels at the same time.[line break][one of]The game works as follows: These dodge-balls have been imbued by our genius mistress with magical properties. Whenever they connect with any part of you except your hands, your rectum and bowels will be filled to the absolute brim with, well, you-know-what. It goes without saying that you won't be able to hold it in for long. Luckily, you'll all be wearing diapers to catch any and all messes you might make while playing. After your first 'stinky' you'll be allowed to keep playing, but the second time you'll be eliminated and you will get a punishment at the end of the training session. If[or]Alright babies, let's get to it. Remember, if[stopping] you're still in the game when your team wins, you get promoted. Got it? Okay, now lets get those of you without sufficient padding into something a little more appropriate...'[roman type][line break]";
	say "[BigNameDesc of M] takes [if D is not worn]those of you that aren't in diapers and forces you all into some very thick disposable nappies[otherwise if D is soiled]you aside and swiftly changes your [ShortDesc of D] so that you have a fresh dry one for the game[otherwise]those of the trainees that aren't already in appropriate diapers and gives them each a big thick disposable nappy to wear[end if].";
	if D is not worn:
		let K be a random worn knickers;
	...
	let LST be the list of rank3 trainees in the location of the player;
	...
	repeat with ST running through LST:
		...
		now the trainingInt1 of ST is 0; [We will use this integer to track if they have messed]
		now the trainee-extra-diapers of ST is 2;
	...
	while NELS1 > 0 and NELS2 > 0:
			...
			if NELS2 > 1:
				while ballTarget is yourself:
					...
					repeat with TST running through LS2:
						set next numerical response to "[NameDesc of TST] ([if the trainingInt1 of TST < 3]dry[otherwise]messy[end if][if the trainingInt1 of TST is 1 or the trainingInt1 of TST is 4] and bulging[end if])";
					compute multiple choice question;
					now ballTarget is entry player-numerical-response in LS2;
			otherwise:
				now ballTarget is entry 1 in LS2;
			say "You can throw the ball at [trainee-name of ballTarget][']s upper or lower body[one of]. [bold type]Aiming higher has a greater chance of hitting but also a much greater chance of immediate retaliation.[roman type][line break][or].[stopping]";
			reset multiple choice questions; [ALWAYS REMEMBER THIS WHEN MAKING A MULTIPLE CHOICE QUESTION]
			...
			if currentBallHolder is listed in LS2:
				if yourself is listed in LS1:
					...
					repeat with TST running through LS1:
						...
						otherwise say "[NameDesc of TST] ([if the trainingInt1 of TST < 3]dry[otherwise]messy[end if][if the trainingInt1 of TST is 1 or the trainingInt1 of TST is 4] and bulging[end if])[run paragraph on]";
						say "[if NLS is NELS1].[otherwise if NLS is NELS1 - 1] and [otherwise], [end if]";
						increase NLS by 1;
					say "The opposing team looks like this: ";
					now NLS is 1;
					repeat with TST running through LS2:
						say "[NameDesc of TST] ([if the trainingInt1 of TST < 3]dry[otherwise]messy[end if][if the trainingInt1 of TST is 1 or the trainingInt1 of TST is 4] and bulging[end if])[if NLS is NELS2].[otherwise if NLS is NELS2 - 1] and [otherwise], [end if]";
						increase NLS by 1;
		...
		if currentBallHolder is trainee:
		...
		if ballHit > 0:[hit]
			if ballTarget is trainee:
				say "[BigNameDesc of ballTarget] [one of]is way too slow[or]deflects the ball with [his of ballTarget] hands but it isn't good enough[or][if bodyTarget is thighs]tries to duck[otherwise]tries to jump[end if] in vain[at random] and the ball hits [him of ballTarget] [if bodyTarget is thighs]on the legs[otherwise]right in the [one of]face[or]chin[purely at random][end if]! [big his of ballTarget] [one of]belly[or]stomach[or]tummy[at random] rapidly expands to the size of a [if the trainingInt1 of ballTarget is not 1 and the trainingInt1 of ballTarget is not 4]large basketball[otherwise]beach ball[end if] as [his of ballTarget] [one of]bowels are[or]rectum is[or]intestines are[at random] magically filled with an [one of]inhuman load[or]insane amount of mess[or]gigantic helping of poop[at random].";
				if the trainingInt1 of ballTarget > 2:
					now temporaryYesNoBackground is figure of tutor brooke cutscene 2;
					now temporaryYesNoResetNeeded is false;
				...
				increase the trainingInt1 of ballTarget by 1; [0: UNAFFECTED; 1: FILLED WITH MESS; 2: DOUBLEFILLED WITH MESS; 3: MESSED ONCE; 4: MESSED AND FILLED WITH MESS; 5: MESSED AND DOUBLEFILLED WITH MESS 6+: Scheduled for elimination]
			otherwise:
		...
		repeat with ST running through LSTemp:
			if ST is trainee, compute dodgeball messing of ST with M;
			if the trainingInt1 of ST > 5:
				let LSX be 1;
	...
	repeat with ST running through LST:
		if ST is trainee[ and the trainingInt1 of ST < 2]:
			say "[big he of M] [one of]point at[or]addresses[or]turns to[at random] [NameDesc of ST].[line break][speech style of M]'Congratulations [trainee-name of ST], you did a great job today.'[roman type][line break]";
			if ST is listed in LS1, FavourUp ST by 2;
			if ST is promotable:
				promote ST;
			otherwise:
				say "[BigNameDesc of M] is clearly about to promote [NameDesc of ST] when all of a sudden a loud gurgle can be heard from [his of ST] belly. [BigNameDesc of M] pauses for a moment, and sure enough [NameDesc of ST] loses control at that moment, flooding [his of ST] previously unstained padding with [if the trainingInt1 of ST is 1]a gallon of [end if]brown mush.[line break][speech style of ST]'[one of]Oh no...'[or]... Oops.'[or]... Oh crap!'[or]Nooooooo...'[in random order][roman type][line break][BigNameDesc of M] takes a step back.[line break][speech style of M]'[one of]And to think I was about to promote you! It looks like I still have some work to do teaching you. I can't promote you today after all.'[or]What? This is ridiculous! No promotion for you until you learn to hold it in for more than a few seconds!'[stopping][roman type][line break]";
				increase the trainee-diaper-mess of ST by 2;
	if yourself is listed in LS1:
...
To say WhoAnswer of (M - tutor-kaylee):
	say "[speech style of M]'I don't like to think of myself as a tutor. I like to think of our time together as more of an... initiation.'[roman type][line break]".
...
To say EscapeAnswer of (M - tutor-kaylee):
	say "[speech style of M]'After my initiation, you'll be allowed to join the VIPs in the facility dungeon when we tort... I mean [']entertain['] the prisoner.'[roman type][line break]".
...
Figure of staff room 0 is the file "Env/Facility/staffroom0.jpg".
Figure of staff room 1 is the file "Env/Facility/staffroom1.png". [urinal 2 (put in back)]
Figure of staff room 2 is the file "Env/Facility/staffroom2.png". [couch 1 (put in back)]
Figure of staff room 3 is the file "Env/Facility/staffroom3.png". [chair in back (put in back)]
Figure of staff room 4 is the file "Env/Facility/staffroom4.png". [lounge chair]
Figure of staff room 5 is the file "Env/Facility/staffroom5.png". [chandelier]
Figure of staff room 6 is the file "Env/Facility/staffroom6.png". [ash tray]
Figure of staff room 7 is the file "Env/Facility/staffroom7.png". [lounge chair 2]
Figure of staff room 8 is the file "Env/Facility/staffroom8.png". [couch 2]
Figure of staff room 9 is the file "Env/Facility/staffroom9.png". [server 1]
Figure of staff room 10 is the file "Env/Facility/staffroom10.png". [server 2]
Figure of staff room 11 is the file "Env/Facility/staffroom11.png". [urinal 1]

Figure of staff room urinal is the file "Env/Facility/urinal1.png".

A game universe initialisation rule:
	now retiredTrainees is 2;
	if watersports fetish is 1, now Facility27 is urinals.

previousStaffRoomTrainees is a number that varies.

An all time based rule (this is the staff room rule):
	if retiredTrainees > 0:
		if the player is in Facility27:
			MapShowReset;
			...
			if previousStaffRoomTrainees < retiredTrainees:
				...
				dignify PS * 2000;
				now previousStaffRoomTrainees is retiredTrainees;
