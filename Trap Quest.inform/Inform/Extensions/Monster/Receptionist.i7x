...
receptionist is in Facility01. The text-shortcut of receptionist is "rcp".
To decide which object is the default-local-room of (M - receptionist):
	decide on Facility01.

Figure of receptionist is the file "NPCs/Facility/receptionist1.png".
Figure of enslaved diapered receptionist is the file "NPCs/Facility/receptionist3.png".
...
To say MonsterDesc of (M - receptionist):
	if M is sex-enslaved:
		say "[BigNameDesc of M][']s smart dress has been torn at the crotch, completely exposing [his of M] [if andro fetish is 1]bright pink chastity cage[otherwise]naked pussy[end if]. It's also been torn over one breast. [big his of M] armband, instead of showing a picture of [his of M] face, and the word 'STAFF', now just reads 'SPANK ME'. [big his of M] left hand is still raised with an adorable pointing finger, but the fury on [his of M] face tells you it's not hanging there of [his of M] own volition. In fact both of [his of M] arms and hands seem magically frozen in place. [big his of M] face and mouth have been left free to allow [him of M] to frown and snarl[if M is in Facility01], and [he of M] would be able to walk around if one of [his of M] ankles wasn't bound to the back of [his of M] reception desk with a strong metal chain[end if].";
	otherwise if M is diaper-enslaved:
		say "[BigNameDesc of M][']s blue outfit has had several subtle changes made. There's a blue ribbon in [his of M] hair and blue flowers on the hem of [his of M] shortened dress. [big he of M]'s got girly frills at the top of [his of M] blue socks and a blue choker around [his of M] neck. [big his of M] hands are encased in fingerless elbow-length mittens. The most notable change, however, is the rather giant blue diaper bulging out from underneath the short skirt section of [his of M] dress. It's so big that [he of M] has to keep [his of M] feet a metre apart just to be able to walk at all[if M is in Facility01] - not that [he of M] can go very far anyway, since one of [his of M] ankles is bound to the back of [his of M] reception desk with a strong metal chain[end if]. [big he of M] can't seem to stop rubbing the front and back of [his of M] diaper with [his of M] two mittened hands, with a vacant drooling facial expression. Whatever [his of M] mega-diaper is full of, it sloshes around rather noisily as [he of M] rubs it into [himself of M].";
	otherwise:
...
To set up (M - receptionist):
	...
	now M is in [Facility01] Dungeon10;
	now M is guarding;
...
To say ArmbandCalming of (M - receptionist):
	...
	if the armband-print of armband is "new recruit", say "Now you need to go see the mistress for initiation. [big his of mistress] door is the last one on the left, you can't miss it. ";
	say "Now trot along!'[roman type][line break]".

To compute monstermotion of (M - receptionist):
	if M is in Facility01, now M is guarding;
...
To compute teaching offer of (M - receptionist):
	say "[speech style of M]'Oh, haha, no, I'm afraid I'm just the receptionist. The tutors are inside.'[roman type][line break]".
...
To compute perception of (M - receptionist):
	...
	if (M is in Dungeon10 or M is in Hotel40) and armband is off-stage and M is friendly:
		if the class of the player is berri:
			...
			if W is a warp portal and the destination of W is facility, now the destination of W is playerRegion; [prevents access to training facility]
			bore M for 999999 seconds;
		otherwise:
			say "[line break][speech style of M]'[if M is in Dungeon10]Hey you! Are you looking to become the new ruler of this region? A little birdie told me that the previous [prince] got into a bit of trouble with the law and this place is currently royalty-free. Well, isn't this your lucky day, because you're talking to the administrator for the most prestigious (and only) [prince] training facility in this part of the multiverse! I can sign you up as new recruit right now, and before you know it, you can be the perfect [prince] for the entire Kingdom of Bimbacia!'[otherwise]There's a lot of positives to becoming one of our highly trained [princes]. You don't want to miss out on this opporunity! Come on, come with me!'[end if][roman type][line break][big he of M] hands you a neon reflective pink armband and gestures for you to strap it on.[line break][speech style of M]'Quickly now, strap this on and jump through the portal. It'll take you straight to the Mistress's office.'[roman type][line break]";
			now armband is carried by the player;
			now the armband-print of armband is "new recruit";
			say ExamineDesc of armband;
			if newbie tips is 1, say "[newbie style]Newbie tip: This will teleport you to the start of the '[training halls]' region side-quest. [one of]The Training Halls is a separate region that you'll be warped to at regular intervals. It's a safe space pretty much free from combat (unless you start it) but every time you go there, you have to attend a [']training session['], and if you've taken too long to arrive you'll instead be sent to [']reconditioning['], both of which can have negative effects. However if you get promoted to the top of the training ladder, the conclusion will be very rewarding.[paragraph break]But if[or]This is usually your last chance to engage with this side quest. As I said before, if[stopping] this is your first ever game, I'd recommend selecting 'No', because including this side quest will just make the game more complicated and less easy to pick up.[roman type][line break]";
			say "Do you do what [he of M] says? ";
			if the player is bimbo consenting:
				try wearing armband;
				if armband is worn and mistress is alive:
					...
					let R be the location of mistress;
					teleport to R;
					now shocked-monsters is 0;
					check guaranteed perception of mistress;
					increase the times-met of mistress by 1;
					display entire map;
	...
	otherwise if the times-met of M <= 1 and armband is not worn and the number of fucked-silly monsters in the facility is 0 and M is in Facility01:
		say "[line break][speech style of M]'Well hello there, you're a new face! Welcome to the [training halls]! Did your royal vizier send you along? Excellent, I'll get you enrolled right away. You start at rank 1 but I'm sure a [prince] like you will be climbing the ranks in no time!'[roman type][line break][big he of M] hands you a neon reflective pink armband and gestures for you to strap it on.";
		now armband is carried by the player;
		now the armband-print of armband is "new recruit";
		say ExamineDesc of armband;
		...
		otherwise:
			...
			anger M;
	otherwise if playerRegion is facility:
		if armband is worn:
			if the class of the player is princess:
				say "[line break][speech style of M]'[one of]Hello again... Princess Annie?! I thought you were locked up in the... oh wait it's you, [NameBimbo]! Never mind that. I hope you're enjoying your training[or]You! Oh, right, it's just you, [NameBimbo]. Phew. I keep mistaking you for someone else[stopping]!'[roman type][line break]";
			otherwise if the player is the donator and there is an appropriate eligible predicament and predicamentJustDone is false and the player is predicament-ready:
				say "[line break][speech style of M]'Hello again [NameBimbo], I hope you're enjoying your training! [one of]Have you considered trying the extra credit zone? [or]You should consider the extra credit zone again. [stopping][if the number of worn cursed removable clothing > the number of worn cursed removable headgear]Not only would you get a bracelet, a trophy and potentially some useful tokens, but you could escape from that annoying cursed clothing[otherwise]You can earn some tokens, a new bracelet and a cool trophy[end if]!'[roman type][line break]";
			otherwise:
				say "[line break][speech style of M]'Hello again [NameBimbo], I hope you're enjoying your training!'[roman type][line break]";
		otherwise if dungeon chains is worn and dungeon chains is stuck:
			say "[speech style of M]'So this is where they're keeping you now.'[roman type][line break]";
			bore M;
		otherwise:
	...
	otherwise:
		anger M;
		say "[line break][speech style of M]'I'm afraid I've been sent here because you've neglected your training. I've been ordered to ensure that you return with me. You're not going to put up a fight, are you?'[roman type][line break]";
		make M expectant.
...
To say CombatProvokedReaction of (M - receptionist):
	if M is in Dungeon10 or M is in Hotel40:
		...
		if W is warp portal and the destination of W is facility and armband is not worn, now the destination of W is playerRegion;
	otherwise:
...
Definition: receptionist (called M) is successfully blocking: [Do they succeed in a roll to stop the player moving]
	if (M is in Facility01 or M is not in the facility) and the noun is north, decide yes; [The (unfriendly) receptionist always blocks the entrance into the facility unless you kill her]
...
Definition: receptionist-armband is appropriate:
	if current-monster is receptionist and current-monster is in the facility and armband is not worn, decide yes;
	decide no.
...
[The staff reconditioning rule is listed first in the receptionist unique punishment rules.]

To say GenericReconditioning of (M - receptionist):
	say "[BigNameDesc of M] looks disappointed.[line break][speech style of M]'[one of]I'm sorry if you don't like me very much[or]I'd rather we got along[or]I'm sorry you feel that way[at random], but you just earned yourself a reconditioning for that, young miss. Come with me.'[roman type][line break]";
	now M is unconcerned.

This is the receptionist forces armband rule:
	if armband is not worn and playerRegion is facility and ex-princess is not guarding: [if princess is guarding this is the final fight]
...
The staff member unique punishment rule is listed last in the receptionist unique punishment rules. [Reconditioning / Dungeon]
