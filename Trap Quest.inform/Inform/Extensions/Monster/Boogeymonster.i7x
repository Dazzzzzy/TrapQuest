...
To compute punishment of (N - boogeymonster-nightmare-aeroplane):
	...
	say "Moments later the inevitable begins. The floodgates open and the whole aeroplane fills with the sound of [if diaper messing >= 3]your bottom as your tummy reaches its limit of patience[otherwise]hissing as your [SlimeContainer] begins to go of its own accord, just as if you were a real baby[end if]. You cover your eyes in shame, unable to meet the judging gaze of any of the adults in front of you as your large nappy begins to bulge and expand even further, providing damning visible evidence of your accident.[line break][first custom style]'Honestly, how pathetic,'[roman type][line break]you hear one man in the front row mutter. You moan through your pacifier as you continue to fail to hold it in.[line break][variable custom style]Wait... pacifier?![roman type][line break]You notice for the first time that you are wearing a pretty yellow pacifier in your mouth.[line break][variable custom style]It must have been there all along, I guess?[roman type][line break]You struggle to remember what you were doing. Oh that's right, you were [slime]ing [if diaper messing >= 3]and pooping [end if]your nappy in front of all the grown-ups, while sucking on your paci like a good baby. After what feels like a year you finally finish going. Your heavy sagging diaper sits beneath you like a large beanbag, bulging out in all directions. You feel the warmth emanating from your padding up into your bum cheeks and loins. It actually feels really comforting and soothing. You make a loud satisfied sigh as you squirm into a comfortable position in your baby seat and relax as you drift off to sleep.";
	...
	say "You open your eyes. You are lying on your back in the [location of the player], but now wearing a [D][if F is worn], [F][end if][if B is worn], [printed name of B][end if] and [yellow-pacifier]. The [ShortDesc of D] feels extremely heavy[if the player is bursting], you feel desperate for the [SlimeTarget][end if], and you feel extremely fatigued. [BigNameDesc of M] is nowhere to be seen.";
	now the fatigue of the player is the buckle threshold of the player;
	regionally place M;
	distract M;
	DiaperAddictUp 1;
...
To compute punishment of (N - boogeymonster-nightmare-magic-marker):
	...
	if diaper messing < 4 or armband is not worn or the player is not the donator:
		...
		distract M;
	otherwise:
		say "[first custom style]'How could you, [NameBimbo]? We trusted you with our son and our house and this is what you get up to behind our backs?! No wonder our Devlin is so much less mature than his peers, with you for a role model. Get off our property right now, and never come back.'[roman type][line break][second custom style]'Noooooo!'[roman type][line break]You whine as you are forcibly ejected from their home, onto the street all the way the other side of the central park from your own home. In the cold evening air, wearing nothing but a superheavy overflowing diaper, a baby bib that hardly covers your chest, and a rattle you can't let go of. Who knows how long it'll be before you can find somewhere to wash it off!";
		if change-self tattoo is not worn:
			summon change-self tattoo;
			summon incontinent-when-speaking tattoo;
			if diaper messing >= 3, summon cum-when-messing tattoo;
			say "You open your eyes. You now have a [change-self tattoo] and an [incontinent-when-speaking tattoo][if cum-when-messing tattoo is worn] and a [cum-when-messing tattoo][end if]! ";
		say "[BigNameDesc of M] is nowhere to be seen... Because YOU ARE NOW IN YOUR ACTUAL HOME NEIGHBOURHOOD![line break][variable custom style]What the fuck?![roman type][line break]";
		if TG fetish > 0:
			SexChange the player;
			say "Wait a minute, you also now have boobs! What the hell?! Feeling through your padding with [horror the bimbo of the player] your fears are confirmed - that's definitely not a willy in between your legs any more. You've been completely and utterly transformed into a girl. You shiver with [joy the bimbo of the player] - you get the feeling that this change is 100% irreversible.";
		regionally place M;
		...
		now the printed name of Predicament01 is "Empty Warehouse";
		teleport to Predicament04;
...
To compute punishment of (N - boogeymonster-nightmare-clubbing):
	...
	compute single choice question "'I'm going to go hide in the [SlimeTarget]s until this nightmare is over...'";
	say "Every second that you spend here in this thing is making you burn up with new levels of humiliation you didn't even know were possible. You just plan to run and hide. But then... Your [PlatonicRole] awkwardly points to the sign on the [SlimeTarget] door.";
	appropriate-cutscene-display Figure of boogeymonster clubbing cutscene 2;
	say "The sign is abundantly clear - no diapers are allowed in the bathrooms. And since you can't remove your diaper, you can't go in the bathrooms either. This stark realisation is accompanied by another - a heavy throb coming from your [SlimeContainer] makes you realize that you actually need to [slime] pretty badly right now.[line break][variable custom style]This can't be happening...[roman type][paragraph break]There's nowhere to run, nowhere to hide, and you desperately need to use the big [boy of the player] [SlimeTargetP]. But you're not allowed. For the next several hours, you'll be wearing nothing but this oversized incontinence aid that forces you to walk with a humiliating waddle. There's nothing to do... But let it go.";
	compute single choice question "[if slimeshooter fetish is 1]Drain slime on[otherwise]Wet[end if] yourself";
	say "You release your hold on your [SlimeContainer], and pray that nobody can tell.[line break][variable custom style]Is everybody looking? Why is everybody looking?![roman type][paragraph break]Probably because you're the only person there in a giant blue nappy, that's why. Your face goes red as you try to hide the fact that you're currently [SlimeDraining] right in front of everyone.[paragraph break]As the warmth spreads throughout your loins, you try to shake your oversized booty to the beat, pretending that you're just a normal clubber, dancing as normal.[line break][italic type]SQUELCH SQUELCH SQUELCH[roman type][line break]Wait... Why is the beat *squelching*? And then you notice... Asolutely EVERYONE is looking at you. The music has paused for a moment in between songs, and the noise you can hear isn't the beat, it's your own soggy diaper squelching loudly as you shake your hips. You stop shaking, but it's too late. Everybody has heard your super-loud, squelching diaper. Everybody knows you [slimedrained] on yourself. EVERYBODY IS LOOKING. You shut your eyes, wishing for the ground to open up and swallow you whole.";
	...
	SlimeSoakUp blue-waddle-diaper by 10;
...
Definition: boogeymonster-nightmare-mahjong (called P) is appropriate:
	if current-monster is not boogeymonster, decide no;
	if diaper messing < 4 or armband is not worn or the player is not the donator or the class of the player is not adventurer or the player is shameless or the diaper addiction of the player > 10, decide no;
	decide yes.
