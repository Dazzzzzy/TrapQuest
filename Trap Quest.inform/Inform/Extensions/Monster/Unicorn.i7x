...
To say LickInitiationFlav of (M - unicorn):
	say "[BigNameDesc of M] walks in front of your face, and presses one of [his of M] sandals to your face.[line break][speech style of M]'Lick it, [bitch]!'[roman type][line break][one of]The shoe doesn't look particularly dirty but it's obviously been walking around on the forest floor. In any case you're confident it wouldn't taste pleasant. (Use [bold type]submit[roman type] to lick the boot, and [bold type]resist[roman type] to refuse.)[line break][or][stopping]".

To say NearingLickingResponse of (M - unicorn):
...
To say LickSubmissionResponse of (M - unicorn):
	say "You [if the grossness addiction of the player < 3]extremely reluctantly[otherwise if the grossness addiction of the player < 6]reluctantly[otherwise if the grossness addiction of the player < 13]timidly[otherwise]enthusiastically[end if] lick the front [his of M] sandal. The unpleasant taste of bamboo instantly hits your tongue[if the grossness addiction of the player >= 13], but you don't care[end if].".

To say LickResistingResponse of (M - unicorn):
	say "[BigNameDesc of M] [one of]grinds [his of M] sandal against your face.[or]pushes the tip of [his of M] sandal between your lips.[or]twists the sandal against your lips.[or]allows [his of M] toes to just barely touch your nose as [his of M] sandal bears down on your chin.[in random order]";

To say NearingAnilingusResponse of (M - unicorn):
	if the reaction of the player is 0:
		say "[speech style of M]'[one of]You don't have a fucking CLUE what you're supposed to do[or]Get your tongue inside my ass already, you [whore]! You're so stupid[or]That's not how you give a rimjob, you idiot[or]UGH, you don't know what you're doing at ALL[in random order]!'[roman type][line break]";
	otherwise:
		if M is intelligent, say "[speech style of M]'[one of]That's-! That's not bad[or]Y-you're awful at that[or]M-my asshole is-![or]E-even my beloved isn't this good...[in random order]!'[roman type][line break]";
		otherwise say "It feels like [NameDesc of M] is nearly satisfied!";
...
To ride dominate (M - unicorn):
	say "[BigNameDesc of M] yelps as you knock [him of M] to the ground and straddle [him of M]. [PowerBottomComment of M] [big his of M] cheeks redden as you pull [his of M] [LongDickDesc of M] out of [his of M] panties.";
	let B be 0;
	...
	otherwise:
		...
		compute ride dominate content M.

To compute ride dominate content (M - unicorn):
	...
	let Fit be the openness of asshole - 2;
	if M is unbridaled or the class of the player is princess or the class of the player is succubus or demon lord is mating:[If the unicorn hates you]
		say "[line break][speech style of M]'I knew it! You want to ruin me for [him of demon lord]! I-I'll never cum for the likes of you!'[roman type][line break][BigNameDesc of M] shrieks, [his of M] shaft twitching excitedly as you slide it into your [asshole]. [if the girth of M < Fit][big his of M] girth leaves a lot to be desired, which of course makes [his of M] little 'declaration' even[otherwise][big his of M] girth perfectly fills you up without stretching you out too much, which makes [his of M] little declaration that much[end if] more annoying. You decide to take it as a challenge, [if G is clothing]kissing [him of M] roughly[otherwise]roughly tearing open [his of M] dress[end if] as you begin to ride [him of M]. [big his of M] [DickDesc of M] responds with a very appreciative throb as you [if G is clothing]force your tongue into [his of M] mouth, [otherwise if the player is wrist bound]gyrate your hips, [otherwise]pinch [his of M] nipples, [end if]and you can feel [his of M] heart racing as [he of M] struggles not to moan. [big he of M] work actually seems to pay off, and as you pour ever more effort into making [him of M] cum, you're the one who starts to feel the strain. You find yourself moaning every few breaths, [if sexual-penis-length < 1]tingles radiating up your spine[otherwise if A is clothing]your [player-penis] bouncing in its cage[otherwise]your [SexDesc of penis] tapping against [his of M] tummy[end if] as you vigorously fuck yourself with [his of M] shaft, but still--[he of M] refuses to break. A smug look creeps across [his of M] features as [he of M] realises you've hit your limit, and your [if the intelligence of the player < 8]dim [end if]mind goes into overdrive trying to think of a way to wipe that look off [his of M] face.[line break][variable custom style]'[if R < 0]Um...I can't think of anything!'[roman type][line break]You simply can't focus when you're this close to orgasm, and you feel your internal muscles tightening up as they embrace the inevitable.[otherwise]I bet [he of M]'d cum if I put my finger in [his of M] ass. Although, it would definitely mean [he of M]'s going to creampie me.'[roman type][line break]Do you go for [his of M] ass?[end if]";
		if R >= 0 and the player is bimbo consenting:
			if debugmode > 0, say "[bold type]PASSED[roman type][line break]";
			say "[if M is wrapped]Knowing the condom will protect you anyway[otherwise]Deciding a creampie is worth it[end if], you reach between [his of M] legs and immediately jam your finger up [his of M] ass.[line break][speech style of M]'W- What are you d-doing? T-that's my-AH! AAAH! UUUUAAAAAH!'[roman type][line break][BigNameDesc of M] wildly bucks [his of M] hips, no longer able to contain [his of M] moans as [his of M] [LongDickDesc of M] begins to spasm. You feel an incredible wave of satisfaction as [if M is wrapped]the condom finally fills with [his of M] load[otherwise][his of M] load finally shoots into your [asshole][end if], your last moan coming out as a laugh as [if sexual-penis-length < 1]you reach a climax of your own[otherwise if sexual-penis-length < 4 or A is clothing]your [load] dribbles[otherwise]your [load] spurts[end if] out on [his of M] tummy a few seconds later.";
			orgasm;
			if M is unwrapped:
	...
	otherwise:
		say "[line break][speech style of M]'W-well, I'm not even turned on anyway!'[roman type][line break][BigNameDesc of M] blurts, [his of M] shaft twitching excitedly as you line it up with your [asshole].[if the intelligence of the player > 10]You smirk at [his of M] terrible lie as you lower yourself onto [his of M] shaft, theatrically[otherwise]You have no reason to disbelieve [him of M], so you don't bother being dramatic, gently[end if][if the player is wrist bound]shaking[otherwise]playing with[end if] your nipples as you begin to fuck yourself with [his of M] [cockshaft of M]. [big he of M] bites [his of M] lip, and [his of M] eyes glue themselves to your [if the largeness of breasts >= 6]ample[otherwise]petite[end if] chest as stifled moans leak out of [his of M] mouth. You can feel [his of M] [DickDesc of M] throb inside of you as you [if the player is wrist bound]jut out[otherwise]continue to play with[end if] your breasts, and [if R < 0]you start thinking of a way to somehow turn [him of M] on. Unfortunately, it's too difficult, so you decide to simply relax and enjoy yourself. You sigh as you lay down on top of [him of M], allowing [his of M] head to rest[otherwise]you come up with the perfect idea to turn [him of M] on even more. With a dramatic sigh, you lay down on top of [him of M], grinning as you press [his of M] head[end if] [if the largeness of breasts < 6]against your chest[otherwise]between your [ShortDesc of breasts][end if].[line break][speech style of M]'Huh!? Wh-...What are you-...I...I-I'm...I-I'M GONNA CUM!'[roman type][line break][BigNameDesc of M] bucks hips as [his of M] shaft begins to rapidly spasm, and you're left with only a few seconds to react. [if R > 0 and M is unwrapped]Stopping might let you avoid a creampie, but you'd probably lose out on your chance to cum. Do you want to stop?[end if]";
		...
		otherwise:
			...
			say "[if M is wrapped]You know there's a condom, so you don't bother thinking about it, [otherwise]You simply don't have enough time to think it through, and before you can make your decision, [end if] you feel several spurts of [semen] [if M is wrapped]shooting into the condom[otherwise]shooting out inside you[end if]. Satisfaction fills your chest as you milk [him of M] down to [his of M] last drop, finally standing up when [his of M] softening [DickDesc of M] slips out of your [asshole].[line break][speech style of M]'T-this is all your fault! I told you I- Mmnf!'[roman type][line break]You cut [him of M] off by immediately sitting on [his of M] face, grinding [if the player is possessing a vagina]your clit[otherwise if sexual-penis-length < 1]yourself[otherwise if A is clothing]your cage[otherwise]your [SexDesc of penis][end if] against [his of M] horn as [his of M] load seeps out of you. The stimulation is just enough to push you over the edge, and you groan happily as [if sexual-penis-length > 3] your [load] arcs over[otherwise if A is clothing or sexual-penis-length > 0]your [semen] dribbles down[otherwise if the player is possessing a vagina]you squirt on[otherwise]climax against[end if] [his of M] forehead.";
			orgasm M;
			FavourDown M by 1;
			orgasm;
			LickGet;
...
To penetration dominate (M - unicorn):
	...
	if sexual-penis-length > 8:
		...
		if the player is consenting:
			...
			let X be 3 + (1 + the times-seeded of M / 2);
