...
A wench is a kind of monster. A wench is intelligent. The wench has a number called guard-obedience. The leftover-type of a wench is 102.

A wench has a number called creampieTimer. [As far as I can tell, this is essentially, there is extra cum inside her, and this is the countdown until it comes out]

A wench has a number called the expulsionTimer. [Number of seconds until next expulsion]

A horny-wench is a kind of wench.

Definition: a wench is willing to do oral:
	if andro fetish is 1, decide no;
	decide yes.
Definition: a wench is willing to do licking:
	if a2m fetish > 0, decide yes;
	decide no.
Definition: a wench is certain to do anilingus: decide yes.[also requires willingness to do licking.]
Definition: a wench is willing to potion forcefeed: decide yes.
...
Definition: a wench is dungeon dwelling:
	...
	if it is willing to do oral or it is willing to do anilingus, decide yes;
	decide no.
...
Figure of fucked silly wench is the file "NPCs/Dungeon/Wench/wench6.jpg".
...
Figure of Wench Cutscene 10 is the file "NPCs/Dungeon/Wench/cutscene-wench-cumblast1.jpg".

To decide which figure-name is the monster-image of (M - a creampied wench):
	if andro fetish is 1, decide on figure of male wench;
...
To decide which figure-name is the pacified-image of (M - a wench):
	if M is fucked-silly and andro fetish is 0, decide on figure of fucked silly wench;
...
To say MonsterDesc of (M - a wench):
	...
	if M is horny-wench:
		if bukkake fetish is 1:
			say "This [man of M] has a glazed look in [his of M] eye, and from [his of M] [if andro fetish is 1]tiny caged penis and jizz-coated figure[otherwise]voluptuous, jizz-coated figure[end if], [he of M][']s definitely the type you'd expect to be passed around down here. [big he of M] is wearing a white blouse, which is unbuttoned and completely soaked in the [if C > 0]extra-large helping of the [end if] same pearly white stuff running out of [his of M] [HolesDesc of M]. [big he of M] has one hand constantly between [his of M] legs, vigorously working [his of M] [semen] loaded [HolesDesc of M] as [he of M] wanders around with a bow-legged stride."; [not sure desperate wenches can steal, so left panty bits out]
		otherwise:
			say "This [man of M] has a glazed look in [his of M] eye, a [if andro fetish is 1]tiny caged penis[otherwise]voluptuous figure[end if], and both hands buried in [his of M] crotch. [big his of M] beach blonde hair and white blouse, which appears to have been rather forcefully unbuttoned, are both soaked and plastered to [his of M] body. [if K is clothing and C > 0]The [ShortDesc of K] [he of M] took from you (displaced for convenience) is completely soaked full of [semen] that has oozed out of [his of M] [HolesDesc of M].[otherwise if K is clothing]The [ShortDesc of K] [he of M] took from you (displaced for convenience) has a large dark spot where [semen] has drooled out of [his of M] [HoleDesc of M].[otherwise]The lower half of [his of M] body has nothing covering it at all, leaving [his of M] worn out, [semen]-drooling [HolesDesc of M] on full display.[end if]";
	otherwise if M is kidnapped wench:
		if bukkake fetish is 1:
			if andro fetish is 1:
				say "This twink is completely naked and plastered with [semen], [if K is clothing]aside from [his of M] stolen [ShortDesc of K][otherwise]and if the bright pink cage locked around [his of M] cock is any indication, [he of M] doesn't normally get to be on top[end if]. [big his of M] skin is [one of]pale[or]a pale brown[sticky random], and his beach blonde hair is unkempt and messy. [big he of M] wears a look on [his of M] face that says 'Please be gentle!', although the [semen] [if C > 0]freely dribbling out of [his of M] asshole[otherwise]that has caked [his of M] thighs[end if] and [if K is clothing]soaking through [his of M] stolen [ShortDesc of K][otherwise]down [his of M] legs[end if] makes it pretty clear [he of M] tends to get it pretty rough. The words 'SISSY CUMDUMP' are tattooed across [his of M] left ass cheek.";
			otherwise:
				say "This [man of M] is completely naked and plastered with [semen]. If the purple bruises on [his of M] wrists and ankles are any indication, [he of M]'s probably spent most of [his of M] time here cooped up in chains. [big his of M] skin is [one of]pale[or]a pale brown[sticky random], and [his of M] beach blonde hair is unkempt and messy. [big he of M] wears a look on [his of M] face that says 'Please be gentle!', although the [semen] [if C > 0]freely dribbling out of [his of M] [HolesDesc of M][otherwise]that has caked [his of M] thighs[end if] and [if K is clothing]soaking through [his of M] stolen [ShortDesc of K][otherwise]down [his of M] legs[end if] makes it pretty clear [he of M] tends to get it rough. A small tattoo across the small of [his of M] back reads 'PROPERTY'.";
		otherwise:
			if andro fetish is 1, say "This twink is completely naked, [if K is clothing]aside from [his of M] stolen [ShortDesc of K][otherwise]and if the bright pink cage locked around [his of M] cock is any indication, [he of M] doesn't normally get to be on top[end if]. [big he of M] has pale skin, long, beach blonde hair and a look on [his of M] face somewhere between excitement and total exhaustion. The words 'SISSY CUMDUMP' are tattooed across [his of M] left ass cheek, and [if C > 0][semen] is dribbling freely out of [his of M] asshole[otherwise][his of M] hole seems like it's recently taken a pounding.";
...
To set up (M - a wench):
	...
	now the creampieTimer of M is 100;
	now the expulsionTimer of M is 300;
...
To set up (M - a horny-wench):
	...
	now the creampieTimer of M is 500;
	now the expulsionTimer of M is 150;
	now the health of M is the maxhealth of M;
	set up detachment of M. [#LXorDD]
...
To compute unique periodic effect of (M - a wench):
	decrease the expulsionTimer of M by time-seconds;
	if the expulsionTimer of M <= 0:
		let N be 1;
		if the creampieTimer of M > 0:
			let CT be the creampieTimer of M;
			if CT > 100, now CT is the creampieTimer of M / 2;
			increase N by 1 + (CT / 100);
			decrease the creampieTimer of M by CT;
		if M is in the location of the player and M is not penetrating a body part:
			if M is combative and bukkake fetish > 0 and grossness fetish > 0:
			...
			otherwise if N > 1:
				let T be "[if N > 5]giant[otherwise if N > 3]huge[otherwise if N > 2]big[end if]";
				if M is asleep, say "[BigNameDesc of M] moans in [his of M] sleep as a [T] glob of [semen] rolls out of [his of M] [HoleDesc of M] and onto the floor.";
				otherwise say "[speech style of M]'Oh [one of]god[or]fuck[or]shit[at random]...'[roman type][line break][BigNameDesc of M] grunts as a [T] gush of [semen] spurts out of [his of M] [HoleDesc of M] and loudly splatters onto the floor, creating a [T] puddle.";
			otherwise:
				if M is asleep, say "[BigNameDesc of M] mumbles as a glob of [semen] rolls out of [his of M] [HoleDesc of M] and onto the floor.";
				otherwise say "[BigNameDesc of M] shivers as a glob of [semen] drips out of [his of M] [HoleDesc of M] and onto the floor.";
		SemenPuddleUp N in (the location of M);
		now the expulsionTimer of M is 300;
		if the class of the player is maid, now the expulsionTimer of M is 200;
		if M is horny-wench, now the expulsionTimer of M is the expulsionTimer of M / 2.
...
To compute (M - a monster) stomping (N - a wench):
	if M is in the location of the player:
		...
		if mythical creature fetish is 1 and gyno fetish is 0, cutshow figure of minotaur cutscene 1 for N;
	otherwise:
...
To say RuneTrapReactFlav of (M - a wench):
	if M is unfriendly:
		say "[BigNameDesc of M] giggles.[line break][speech style of M]'I stepped on that one earlier. It's much more funny when someone else does it!'[roman type][line break]";
	otherwise:
...
To compute disgusting spit reaction of (M - a wench):
	say "[BigNameDesc of M] shudders as [he of M] watches you. You're not sure if it's with disgust or arousal. [if the slime volume of face > 0][strongHumiliateReflect][otherwise][moderateHumiliateReflect][end if]";
	FavourDown M with consequences.
...
Definition: a horny-wench (called M) is objectifying the player:
...
To compute kneeling reaction of (M - a wench):
	if the guard-obedience of M is 0:
		...
		otherwise:
			...
			otherwise:
				say "[speech style of M]'[if the class of the player is maid][one of]Hey maid, I'm dirty, come clean me up.'[or]Open your mouth baby, I need help cleaning up.'[in random order][otherwise if the player is possessing a penis and there is a worn chastity cage][one of]You're not going to fuck anybody when you're locked up like that. Now open up.'[or]Oooh, is poor widdle baby locked up in a cage? Don't worry, I've got milk for you right here.'[or]Hmm, I bet you'd like to fuck this [HoleDesc of M]. Too bad you're all caged up! Now open wide.'[in random order][otherwise if the player is possessing a penis and the size of penis <= 3][one of]Hey baby dick, how'd you like to eat my [HoleDesc of M]? That's probably the only action you'll ever get from a [man of M].'[or]With a [player-penis] that tiny, I bet you can't even cum. Luckily, you can still help ME cum if you lend me your mouth for a minute.'[or]Wow, what a tiny [player-penis]! You'll never satisfy anyone with that! I really hope your tongue isn't that small.'[or]If you open your mouth, I'll give you a taste of a real man's cum.'[in random order][otherwise if the size of penis > 5][one of]Wow, a [player-penis] that big and you're still on your knees? I'm going to enjoy having you eat my [HoleDesc of M].'[or]I bet you thought you were going to fuck me. Wrong! Now open up, bitch.'[in random order][otherwise][one of]Open wide, bitch.'[or]Open up, bitch.'[or]You thirsty, bitch?'[or]I hope you're thirsty.'[or]I hope you're good at eating [HoleDesc of M].'[in random order][end if][roman type][line break]";
		strongHumiliate.
...
This is the obedient wench rule:
	...
	if M is monster and the class of the player is not princess and M is not penetrating a body part:
...
To compute vaginal assistance from (S - a wench) with (D - a monster):
	if a random number between 1 and 2 is 1 and andro fetish is 0:
...
To compute anal assistance from (S - a wench) with (D - a monster):
	if a random number between 1 and 2 is 1 and andro fetish is 1:
...
This is the wench asscum cup punishment rule:
	if a2m fetish >= 2 and champagne-glass is held and (champagne-glass is empty or the fill-colour of champagne-glass is not creamy) and doom counter > 0 and there is a nonstalking evil-wisp and the creampieTimer of current-monster > 0:
		let M be current-monster;
		...
		silently set up wisp quest drink-wisp-quest with bimbo-wisp-punishment for W;
		silently set up wisp trigger spill-wisp-trigger for W;
		silently set up wisp GUI for W;
		say "[AnnounceNewWisp W][line break][speech style of M]'That was weird! I don't know what came over me. Now where was I...'[roman type][line break]";
		decrease the creampieTimer of current-monster by 100;
		if the creampieTimer of current-monster < 0, now the creampieTimer of current-monster is 0;
		rule succeeds.
...
To (M - a wench) steals (K - a knickers):
	if K is worn:
		...
		if R > the defence of K:
			...
			now M is carrying K;
			if the chosen-orifice of M is penis and penis is an actual target:
				say "[big he of M] pulls the [K] off and tucks it under [his of M] arm![line break][speech style of M]'I'm keeping these~'[roman type][line break]";
			otherwise:
	...
	otherwise:
		...
		now M is carrying K;
		if the chosen-orifice of M is penis and penis is an actual target:
			say "[big he of M] pulls [K] from your hands and tucks it under [his of M] arm![line break][speech style of M]'I'm keeping these~'[roman type][line break]";
		otherwise:
			distract M;
			calm M;
			now the scared of M is 75.
...
To compute brainWashedGreeting of (M - a wench):
	unless bbc-training of M is 0:
		if bbc-training of M <= 2:
			say "[line break][speech style of M]'[one of]You haven't seen any [BlackCock] around have you? I just can't stop thinking about it.'[or]Do you think the [shopkeeper] would like it if I trained away my gag reflex? I think that's kinda hot to be honest.'[or]Hey, let's go see the [ShortDesc of shopkeeper] together, I need to go shopping.'[as decreasingly likely outcomes][roman type][line break]";
		otherwise:
			say "[line break][speech style of M]'[one of]Oh fuck I need a [BlackCock] in me so badly, you haven't seen any around have you?'[or]Do you like my new tattoos? Every time I please [daddytitle of shopkeeper] I get another!'[or]Hey, let's go see the [ShortDesc of shopkeeper] together, I need to get fucked by the huge [BlackCock] again.'[as decreasingly likely outcomes][roman type][line break]";
...
To compute facial sex of (M - a wench):
	if grossness fetish > 0 and the creampieTimer of M > 0:
		say "[one of]A large glob of [semen] leaks out of [his of M] [asshole] and onto your face.[or]Warm [semen] seeps out of [his of M] [asshole] and onto your face.[or]Thick [semen] slowly trickles out of [his of M] [asshole], rolling down the side of your nose and over your cheeks.[or]A fat wad of [semen] leaks out of [his of M] butt and plops wetly onto your face.[or][semen] oozes out of [his of M] gaping butthole, pooling on your face.[or]Thick [semen] dribbles out of [his of M] asshole, rolling down your cheeks.[in random order][line break]";
		SlowGrossOut 6;[Because cum is dripping from her ass onto your face.]
	...
	otherwise if there is a worn diaper:
		say "[BigNameDesc of M] lovingly rubs your diaper[one of] from [his of M] advantageous position[or][stopping].[line break][speech style of M]'[one of]What's this? Why are you wearing a nappy, honey? Are you having [SlimeTargetP] problems?'[or][DiaperHumiliation of M][stopping][roman type][line break]";
		severeHumiliate;
...
[To say FacesitResistingResponse of (M - a wench):
...
To say AnilingusResisting of (M - a wench):
	say "[one of]You refuse to let [him of M] use you as [his of M] own personal [if the creampieTimer of M > 0]cleaning service[otherwise]sex toy[end if]. [or]You keep your mouth shut, valuing your dignity over your ability to breathe. [or]You spitefully purse your lips, wanting to make sure [he of M] gets a little out of it as possible. [or]You keep your mouth shut. At least if you pass out, you'll still have some dignity. [in random order]".

To say FacesitSubmissionResponse of (M - a wench):
	if the creampieTimer of M <= 0:
		say "[one of][BigNameDesc of M] moans as you obediently kiss and lick [his of M] [HoleDesc of M].[or]You dig your tongue into [NameDesc of M][']s gaping [HoleDesc of M].[or]You tease [NameDesc of M][']s clit with your tongue.[or]You [if the oral sex addiction of the player < 8]reluctantly[otherwise if the delicateness of the player < 10]somewhat reluctantly[otherwise]eagerly[end if] stroke [NameDesc of M]'s folds with your tongue.[in random order]";
	otherwise:
		say "[one of]You lick [NameDesc of M][']s [vagina], causing the [semen] inside to slowly flow into your mouth.[or]You dig your tongue into [NameDesc of M][']s [vagina], which immediately rewards you with a thick glob of salty [semen].[or]You tease [NameDesc of M][']s clit with your tongue. Warm [semen] slowly dribbles out of [his of M] [vagina] and into your open mouth.[or]You spear your tongue into [NameDesc of M][']s gaping [vagina], allowing the [semen] within to slowly roll into your mouth.[or]You obediently open your mouth, allowing the [semen] slowly oozing out of [his of M] [vagina] to slide onto your tongue.[or]You [if the semen taste addiction of the player < 8]reluctantly[otherwise if the delicateness of the player < 10]somewhat reluctantly[otherwise]eagerly[end if] stroke the wench's folds with your tongue, swallowing obediently as [semen] dribbles into your mouth.[or][if the semen taste addiction of the player < 8]You tease [his of M] [vagina] with your tongue, trying to clean it out while tasting as little [semen] as possible. There's still quite a lot.[otherwise if the semen addiction of the player < 12]You obediently eat out [his of M] [vagina], collecting the [semen] that trickles out on your tongue.[otherwise]You kiss and lick every inch of [his of M] [vagina], eagerly lapping up any [semen] that trickles out.[end if][in random order]";
		FaceFill semen by 1;
...
To say AnilingusSubmissionResponse of (M - a wench):
	if the creampieTimer of M <= 0:
		say "[one of][BigNameDesc of M] moans as you obediently lick [his of M] bitter, salty [asshole].[or]You dig your tongue into [NameDesc of M][']s gaping [asshole].[or]You tease [NameDesc of M][']s anal ring with your tongue.[or]You [if the grossness addiction of the player < 7]scowl in disgust as you reluctantly kiss[otherwise if the grossness addiction of the player < 14]grunt with effort as you plant kisses onto[otherwise]moan as you pepper eager kisses around[end if] [NameDesc of M]'s [asshole].[in random order]";
	otherwise:
		say "[one of]You lick [NameDesc of M][']s [asshole] with your tongue, causing the [semen] inside to slowly flow into your mouth.[or]You dig your tongue into [NameDesc of M][']s [asshole], which immediately rewards you with a thick glob of salty [semen].[or]You tease [NameDesc of M][']s anal ring with your tongue. Warm [semen] slowly dribbles out of [his of M] [asshole] and into your open mouth.[or]You spear your tongue into [NameDesc of M][']s gaping [asshole], allowing the [semen] within to slowly roll into your mouth.[or]You obediently open your mouth, allowing the [semen] slowly oozing out of [his of M] [asshole] to slide onto your tongue.[or]You [if the semen taste addiction of the player < 8]reluctantly[otherwise if the delicateness of the player < 10]somewhat reluctantly[otherwise]eagerly[end if] press your lips against [NameDesc of M]'s [asshole], slurping out the [semen].[or][if the semen taste addiction of the player < 8]You tease [his of M] [HoleDesc of M] with your tongue, trying to clean it out while tasting as little [semen] as possible. There's still quite a lot.[otherwise if the semen addiction of the player < 12]You obediently scour [his of M] [asshole] with your tongue, collecting the [semen] that trickles out on your tongue.[otherwise]You kiss and lick every inch of [his of M] [HoleDesc of M], eagerly lapping up any [semen] that trickles out.[end if][in random order]";
		FaceFill semen by 1;
		decrease the creampieTimer of M by 30;
		if the creampieTimer of M < 0, now the creampieTimer of M is 0;
		progress quest of creampie-drinking-quest.
...
To say AnilingusResistingResponse of (M - a wench):
	...
	otherwise:
		say "[BigFuckerDesc of M] grapples your head by the hair and [one of]rubs [his of M] creampied [asshole] into your lips as roughly as [he of M] can[or]shoves your nose into [his of M] stretched out, creampied sphincter[or]smushes [his of M] [semen]-packed ass in your face[or]does [his of M] best to suffocate you with [his of M] cum-drooling hole[in random order]. You can't breathe!";
		if bukkake fetish is 1, CumFaceUp 1;
...
To say AnilingusEndFlav of (M - a wench):
	if andro fetish is 1:
		say "You hear a sigh and then a moan and then a screaming orgasm as [NameDesc of M]'s [sissy-penis] spurts out a tiny load. [run paragraph on]";
	otherwise:
		say "You hear a sigh and then a moan and then a screaming orgasm as [NameDesc of M] squirts all over your face. [run paragraph on]";
	let D be the difficulty of M - the starting difficulty of M;
	if D >= 1 and the creampieTimer of M > 33 and a random number between 1 and D > 1:
		say "[big his of M] [asshole] twitches at the same time, and a split second later, the entire contents of [his of M] belly explode [if the reaction of the player > 0]straight into your mouth.[otherwise if bukkake fetish is 1]all over your face.[otherwise]onto the ground.[end if][if the semen taste addiction of the player > 12 and the reaction of the player > 0][line break][second custom style]Mmm, tasty![roman type][line break][end if]";
		if the reaction of the player is 0:
			TasteGrossOut 7;
			FaceFill semen by the creampieTimer of M / 50;
		otherwise:
			GrossOut 6;
			if bukkake fetish is 1, AnnouncedSquirt semen on face by the creampieTimer of M / 33;
			otherwise SemenPuddleUp the creampieTimer of M / 33;
		now the creampieTimer of M is 0;
	say "[big he of M] continues screaming in pleasure for a few seconds, then you feel [his of M] hold on your body weaken, and [he of M] rolls off your body, passed out from the pleasure.";
	cutshow figure of wench cutscene 1 for M.

To say LickEndFlav of (M - a wench):
	say "You hear a sigh and then a moan and then a screaming orgasm as [NameDesc of M] squirts [his of M] own sex juices squirt all over your face. [run paragraph on]";
	let D be the difficulty of M - the starting difficulty of M;
	if D >= 1 and the creampieTimer of M > 33 and a random number between 1 and D > 1 and grossness fetish > 0:
		say "[big his of M] [asshole] twitches at the same time, and a split second later, the entire contents of [his of M] belly explode [if bukkake fetish > 0]out on your face.[otherwise]onto the ground.[end if]";
		GrossOut 6;
		if bukkake fetish is 1, AnnouncedSquirt semen on face by the creampieTimer of M / 33;
		otherwise SemenPuddleUp the creampieTimer of M / 33;
		now the creampieTimer of M is 0;
...
To compute (M - a wench) entering mouth:
	...
	otherwise:
		...
		if M is flipping the player:
			...
			if andro fetish is 0 and a2m fetish > 1:
				say "A large glob of [semen] leaks out of [his of M] asshole and onto your face.";
				if bukkake fetish is 1, CumFaceUp 1;
				GrossOut 4;
...
To say AnilingusInitiationFlav of (M - a wench):
	say "[BigFuckerDesc of M] grabs you by the hair, blocks your nose with [his of M] genitals, and covers your mouth with [his of M] asshole. You can't breathe!";
	...
	otherwise:
		say "[line break][line break][line break][speech style of M]'[if the creampieTimer of M > 0][one of]Drink bitch, drink!'[or]Clean it out, bitch!'[or]Lick my fucking shithole, whore!'[purely at random][otherwise][one of]Eat my ass, bitch!'[or]How do you like the taste of my fucking shithole, bitch?'[or]How do you fucking like my fucking shithole, you fucking whore?'[purely at random][end if][roman type][line break]".

To say MouthPenetrationFlav of (M - a wench):
	if a2m fetish > 0:
		say "[big he of M] buries your nose into [his of M] asshole and covers your mouth with [his of M] [if the creampieTimer of M > 0]cum-filled [end if]cunt. You can't breathe!";
	otherwise:
		say "[big he of M] pinches your nose and covers your mouth with [his of M] [if the creampieTimer of M > 0]cum-filled [end if]cunt. You can't breathe!";
	if M is horny-wench or M is friendly-fucking:
		say "[line break][line break][line break][speech style of M]'[if the creampieTimer of M > 0][one of][big please] lick it all out of me!'[or][big please], you have to drink it all.'[or]Don't worry, it tastes really good!'[purely at random][otherwise][one of]I really need to feel your tongue...'[or]Yes! Give me your tongue!'[or]Yes! [big please] make me cum!'[purely at random][end if][roman type][line break]";
	otherwise:
		say "[line break][line break][line break][speech style of M]'[if the creampieTimer of M > 0][one of]Drink bitch, drink!'[or]Clean it out, bitch!'[or]Lick my pussy clean you fucking whore!'[purely at random][otherwise][one of]Eat my fuckhole, bitch!'[or]How do you like the taste of my pussy, bitch?'[or]How do you like my fuckhole, you fucking whore?'[purely at random][end if][roman type][line break]".
...
To say ErectionLostFlav of (M - a wench):
	if M is unfriendly:
		if face is not actually occupied and M is normal-penis-fucking:[Now she sits on your face.]
			if M is QoS wench:
		...
		otherwise:
			...
			say "[BigNameDesc of M] gives you a smug look as [he of M] [unless M is normal-penis-fucking]releases[otherwise]climbs off[end if] you.[line break][speech style of M]'[one of]It would have been great to make you eat me out too, but I guess you lucked out, huh?'[or]I can't believe how easy that was. We'll have to pick this up later.'[or]I had more planned, but I'll let you off easy this time.'[in random order][roman type][line break]";
			Bore M;
	otherwise:
		now the sex-length of M is 0;
...
To say TaxReturnDismay of (M - a wench):
	say "[speech style of M]'My only one... I can't believe you're making me give it to you. Maybe the shopkeeper will let me earn another one... *sniff*'[roman type][line break]".
...
To compute failed dominance punishment of (M - a wench):
	...
	otherwise:
		...
		if there is a desirable knickers and M is not objectifying the player and the number of clothing carried by M is 0 and the player is prone, now another-turn-flavour is the substituted form of "[BigFuckerDesc of M] escapes!";
		otherwise now another-turn-flavour is the substituted form of "[BigFuckerDesc of M] holds you in place.";
		now another-turn is 1.
...
To penetration dominate (M - a wench):
	...
	if sexual-penis-length > 8:
		...
		if R >= 0:
			say "[line break][speech style of M]'Don't stop! Don't stop!'[roman type][line break]You grit your teeth as the pleasure comes to a head, forcing yourself to hold on just a moment longer. [BigNameDesc of M] climaxes explosively, [his of M] whole body shuddering as [his of M] [if andro fetish is 1][DickDesc of M] shoots across [his of M] belly. [otherwise][vagina] squirts out girlcum. [end if]Knowing you've reached the finish line, you allow yourself to lose control, emitting a primal groan as you flood [his of M] [HoleDesc of M] with your massive load.";
			FavourUp M by 2;
			orgasm M;
			say AfterDominationComment 1 of M;
		otherwise:[she has a ruined orgasm]
			say "[line break][speech style of M]'Don't stop! Don't sto-'[roman type][line break]You cut [him of M] with a guttural groan of pleasure, a brief surge of shame flashing through your chest as you flood [his of M] [HoleDesc of M] with your massive load. [BigNameDesc of M] is hot on your heels, and [his of M] whole body begins to shudder as [he of M] begins to clench up around you. Its slightly too late, and your softening [sexual-player-penis] softens and slips out before [he of M]'s completely satisfied.";
	...
	otherwise if sexual-penis-length > 3:
		...
		if R >= 0:
			...
			orgasm;
			say "[BigNameDesc of M] doesn't seem to notice that you came already, and [his of M] voice steadily rises as you push [him of M] closer and closer to climax. Finally, [his of M] whole body begins to convulse, and [he of M] shrieks in pleasure as [if andro fetish is 1][his of M] [DickDesc of M] shoots [semen] across [his of M] belly[otherwise][his of M] [vagina] squirts out girlcum[end if].";
			now player-fucking is DOMINANT-NEUTRAL;
			FavourUp M by 1;
			orgasm M;
			passively stimulate vagina from M;
...
To blowjob dominate (M - a wench):
	...
	let C be a random bottom level protection clothing;
	let D be 0;
	if the difficulty of M > the size of penis + 3 and M is not horny-wench:
		now D is 1;
		if M is a-non-detacher or C is strapon-panties or the player is not possessing a penis, now D is 0;
	if sexual-penis-length > 8:
		say "You force [NameDesc of M] to [his of M] knees, but one look at your [if C is clothing and C is not strapon-panties][sexual-player-penis] being freed from your [ShortDesc of C][otherwise if penis is penis-erect][SexDesc of penis][otherwise]hardening [sexual-player-penis][end if] sends [him of M] scrambling away. You [if the player is wrist bound]quickly step into [his of M] path. [otherwise]grab [him of M] by the hair and drag [him of M] back. [end if][big he of M] quickly shakes [his of M] head, [if M is horny-wench]but by the time the motion is finished, [his of M] mouth is wide open and [his of M] tongue is lolling out of[otherwise]but after a moment [he of M] blushes and slowly opens[end if] [his of M] lips.";
		if R >= 0:
		...
		otherwise:
			if D is 0:
				say "[line break][speech style of M]'P-pineapple on pizza!'[roman type][line break]";
				now M is dying;
			otherwise:
				say "There is a silver ring hidden just past [his of M] cheeks, and you are wondering what it is when ";
				compute detach-players-dick by M using 1;
	otherwise if sexual-penis-length > 6:
		say "You force [NameDesc of M] to [his of M] knees, [if C is clothing and C is not strapon-panties]pulling your [sexual-player-penis] out of your [ShortDesc of C] and pointing it[otherwise if the player is wrist bound]pointing your [SexDesc of penis][otherwise if penis is penis-erect]brandishing your [SexDesc of penis][otherwise]brandishing your hardening [sexual-player-penis][end if] at [him of M]. [big he of M] [if M is horny-wench]nods eagerly[otherwise]gulps, avoiding eye contact as [he of M] answers with a slow nod[end if] and grips the base of your [SexShaft]. [run paragraph on]";
		if debugmode > 0, say "[line break][bold type][if R < 0]FAILED[otherwise]PASSED[end if][roman type][line break]";
		if R >= 0:
			say "[big he of M] drags [his of M] tongue up your length, lightly stroking it as [he of M] slowly spreads [his of M] spit over the surface of your [SexShaft]. [big he of M]'s actually a bit too thorough about it, but at the very moment you run out of patience, [he of M] plants [his of M] lips on your [SexTip] and glides down your [SexShaft] in a fraction of a section. [big he of M] furrows [his of M] eyebrows as your tip brushes the back of [his of M] throat, bracing [his of M] hands on your thighs as [he of M] forces [himself of M] down even further. Pleasure explodes up your [SexShaft] as tiny movements of [his of M] tongue push you to the brink of orgasm in no-time-flat. You barely manage to grunt before you go over the edge, involuntarily bucking your hips as you unload straight down [his of M] throat. [if the throatskill of the player is 1][big he of M]'s clearly had a lot more practise than you have, because [end if][big he of M]'s able to hold the position for the full duration of your orgasm, sitting up gracefully as your softening [sexual-player-penis] slips out of [his of M] mouth.";
			BlowGet;
			orgasm;
			moderateDignify;
	...
	otherwise if sexual-penis-length > 3:
		...
		otherwise: [#LXorDD]
			if D is 0:
				say "and immediately rolling [his of M] eyes.[line break][speech style of M]'Pineapple on pizza!'[roman type][line break]";
				now player-fucking is DOMINANT-NEUTRAL;
				now M is dying;
			otherwise:
				say "and working [his of M] mouth as if to get ready. When [he of M] parts [his of M] lips, you notice a glint of silver behind [his of M] cheek, and while you're wondering what it might be, ";
				compute detach-players-dick by M using 1;
	otherwise:
		say "You force [NameDesc of M] to [his of M] knees, [if C is clothing and C is not strapon-panties]taking your [sexual-player-penis] out of your [ShortDesc of C] and pushing[otherwise if the player is wrist bound]pushing your [SexDesc of penis][otherwise if penis is penis-erect]pushing your [SexDesc of penis][otherwise]pushing your stiffening [sexual-player-penis][end if] against [his of M] cheek. ";
		now player-fucking is DOMINANT-NEUTRAL;
		if debugmode > 0, say "[line break][bold type][if R < 0]FAILED[otherwise]PASSED[end if][roman type][line break]";
		if R >= 0:
		...
		otherwise:
			if D is 0:
				say "[line break][speech style of M]'Sorry, too tiny. Pineapple on pizza!'[roman type][line break]";
				now M is dying;
			otherwise:
				say "[big he of M] leans back, working [his of M] mouth as if getting ready, and parts [his of M] lips ever so slightly. You're grimacing at just HOW slightly when [run paragraph on]";
				compute detach-players-dick by M using 1.

To watersports dominate (M - a wench):
	if the player is possessing a penis:
		say "You force [NameDesc of M] to [his of M] knees, [if slimeshooter fetish is 1]taking out your slimeshooter[otherwise]thrusting your [SexDesc of penis][end if] in front of [him of M].";
		if the size of penis > 3:
			say "[speech style of M]'Ok. O-ok, I'm... I'm ready.'[roman type][line break][big he of M] opens wide, closing [his of M] eyes as you [if slimeshooter fetish is 1]pull the trigger[otherwise]relax your muscles[end if] and the contents of your [SlimeContainer] run down [his of M] face and chest.";
			moderateDignify;
			say AfterDominationComment 9 of M;
		otherwise:
			say "[speech style of M]'Pfft, is that tiny shrimp dick supposed to be intimidating??'[roman type][line break][big he of M] laughs derisively and begins to stand up, but you grab [him of M] by the hair and yank hard to get [his of M] back on [his of M] knees. You decide to punish [him of M] by releasing your hold on your [SlimeContainer], grinning down at [him of M] as [SlimeShade] [slime] sprays all over [his of M] face and breasts.";
			now the bladder of the player is 0;
			say AfterDominationComment 7 of M;
			trivialDignify;
	otherwise if the player is possessing a vagina:
		say "You force [NameDesc of M] to [his of M] knees, spreading your labia as you release your hold on your [SlimeContainer]. [big he of M] closes [his of M] eyes and angles [his of M] face toward your [vagina] as best [he of M] can. You sigh as your [slime] streams onto [his of M] face and breasts.";
		moderateDignify;
		say AfterDominationComment 9 of M;
	now the bladder of the player is 0;
	SportsGet.
...
To facesit dominate (M - a wench):
	...
	if the player is not possessing a vagina:
		...
		otherwise if the slime volume of belly > 0:
			say "You sigh in pleasure, [if the player is wrist-bound-behind]grinding against [him of M][otherwise]tweaking your nipples[end if] as the sensation causes your anal muscles to loosen and allow [slime] in your ass to dribble out into [his of M] mouth. [if M is horny-wench][big he of M] slows down briefly, but doesn't stop, scouring your [asshole] with [his of M] tongue[otherwise][big he of M] wretches, a single glare over your shoulder spurs [him of M] to keep [his of M] tongue in your [asshole][end if] until its frothy contents have been thoroughly emptied into [his of M] mouth.";
	...
	otherwise:
		if player-fuckchoice is FUCK-WATERSPORTS:
			say "You force [NameDesc of M] to [his of M] knees, [if the player is wrist bound]and[otherwise]spreading your labia as you [end if]release your hold on your [SlimeContainer]. [big he of M] closes [his of M] eyes and angles [his of M] face toward your [vagina] as best [he of M] can. You sigh as your [slime] streams onto [his of M] face and breasts.";
			now the bladder of the player is 0;
		otherwise:
...
To say AfterDominationComment (N - a number) of (M - a wench):
	...
	otherwise if N is 6:
		say "[speech style of M]'[one of]I may be your whore now, but just you wait.'[or]Treat me like that as much as you want. I'll remember it when I'm kicking your ass.'[or]I'm not a sore loser. But one day, YOU'RE going to be.'[in random order][roman type][line break]";
	otherwise if N is 7:
...
To say TauntRejected of (M - a wench):
	if the size of penis <= 3 and the player is possessing a penis and penis is lewdly exposed and the player is feeling dominant and transGender is 0:
		say "[speech style of M]'[one of]Just try to fuck me, shrimp dick. I fucking dare you.'[or]So you're going to fuck me? Really. With a tiny cock like that?'[or]Go ahead and try to fuck me, shrimp. I wouldn't even feel it.'[at random][roman type][line break]";
		alwayscutshow figure of wench interact 6 for M;
...
To compute teaching of (M - a wench):
	...
	if andro fetish is 0, cutshow figure of wench cutscene 4 for M;
	teach deepthroating.
...
Definition: workaholic wench is hotel dwelling:
	...
	decide no.
Definition: workaholic wench is a bondage applier: decide yes.

To say MonsterDesc of (M - workaholic wench):
	let K be a random knickers carried by M;
	if bukkake fetish is 1:
		say "This [man of M] has dozens of hatch marks next to [his of M] mouth, [if andro fetish is 1]and [asshole][otherwise][asshole], and [vagina][end if], and from [his of M] [if andro fetish is 1]effeminate[otherwise]voluptuous[end if], jizz-coated figure, it's not hard to guess how [he of M] might have earned them. [big he of M]'s wearing a cum-soaked white blouse[if K is clothing] with a [printed name of K][end if], and you can see the words 'Free Ride' tattooed across [his of M] right cheek. [big he of M] looks a little exhausted.";
	otherwise:
		say "This [man of M] has dozens of hatch marks next to [his of M] mouth, [if andro fetish is 1]and [asshole][otherwise][asshole], and [vagina][end if], and from the way [semen] is leaking from [if gyno fetish is 1][his of M] hole[otherwise][his of M] holes[end if], it's not hard to guess their significance. [big he of M]'s wearing a soaking wet white blouse[if K is clothing] with a [printed name of K][end if], and you can see the words 'Free Ride' tattooed across [his of M] right cheek. [big he of M] looks a little exhausted.".
...
Definition: QoS wench is dungeon dwelling: [can she spawn randomly?]
	...
	decide no.
Definition: QoS wench is hotel dwelling:
...
Definition: QoS wench (called M) is objectifying the player:
	now the objectification of M is 1;
	decide yes.
...
Definition: QoS wench is a bondage applier: decide yes.
...
To say MonsterDesc of (M - QoS wench):
	say "This [man of M] is completely covered in several BBC fetish tattoos. [big his of M] skin is pale, and [his of M] beach blonde hair is in pigtails. [big he of M] has the body figure of a [if andro fetish is 0]stacked [end if]athletic goddess, although the collar around [his of M] neck and the big black cock-shaped edible treat [he of M][']s munching on make it clear that [he of M]'s only interested in [BlackCock]. Everything [he of M]'s wearing, including even [his of M] watch and clutch purse, are coordinated, and share a Queen of Spades theme[if playerRegion is hotel]. A large collection of used, cumfilled condoms are pinned to [his of M] microskirt[end if][if gyno fetish is 1]. [big his of M] tiny penis is peeking out from underneath [his of M] super-short red microskirt, safely locked away in a pink chastity cage. [big he of M] doesn't seem upset about this at all - it looks like [he of M] is a fervent believer that white cocks should be locked away, and black cocks should be worshipped all day[end if].";
...
To say StraponOralResistingResponse of (M - QoS wench): [The player is refusing to play ball and suck obediently on the dildo. How does the NPC act?]
...
To say StraponOralSubmissionResponse of (M - QoS wench): [The player is sucking obediently on the dildo. What does that look like?]
...
To compute anal sex of (M - QoS wench):
	...
	if M is not friendly-fucking:
		if refractoryperiod >= maxrefractoryperiod:
			say "[BigNameDesc of M] bites [his of M] lip and spanks your [AssDesc].[line break][speech style of M]'Did you cum nice and hard for my [LongDickDesc of M]? See hun, I told you that [BlackCock] is simply the best, just wait till I find you a real black [daddytitle of shopkeeper].'[roman type][line break]";
			BBCAddictUp 1.
...
To compute (M - a QoS wench) demanding erection:
	...
	otherwise:
		if condom of kings is worn and condom of kings is not cursed:
			say "[BigFuckerDesc of M] starts to hungrily worship your [manly-penis].[line break][speech style of M]'How's my favourite stud going? Remember to keep this on till you become at least 14 inches long. If you cum before then, it will just show you're not worthy of this juicy ass! Come see again me when you're even bigger...[line break][roman type]";
		...
		otherwise if condom of kings is not worn:
			...
			summon H;
			passively stimulate penis from M;
			say "[BigFuckerDesc of M], seemingly satisfied with [his of M] work, saunters off.";
			bore M;
		otherwise:
...
This is the QoS wench shares you with BBC rule:
	...
	if shopkeeper is alive and shopkeeper is awake and shopkeeper is undefeated and the refractory-period of shopkeeper <= 0 and the BBC addiction of the player > a random number between 1 and 10:
		...
		if N is in Q:
			...
			compute monstermotion of M;
		otherwise:
			say "[speech style of M]'Oh, [he of N][']s not here. That's unusual. Oh well, I guess we can wait for [him of M] here. I've got an idea for something we can do to pass the time...'[roman type][line break]";
			anger M;
		rule succeeds.
