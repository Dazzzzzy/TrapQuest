...
Centaur is a monster. Centaur is intelligent. The text-shortcut of centaur is "cttm". Understand "templar", "cyborg" as centaur. Centaur is male. Centaur can be shieldblocked or not shieldblocked.

Figure of Centaur is the file "NPCs/Forest/centaur1.jpg".
To decide which figure-name is the monster-image of (M - centaur):
	if mythical creature fetish is 1, decide on the figure of centaur;
	decide on figure of Missing NPC.

To say MediumDesc of (M - centaur):
	say "[if mythical creature fetish is 1]centaur[otherwise]cyborg[end if] templar".

To say MonsterDesc of (M - centaur):
	say "This armoured [man of M] has [if mythical creature fetish is 1]the body of a horse[otherwise]a cybernetic contraption[end if] from the waist down, with a [LongDickDesc of M] hanging down between [his of M] [if mythical creature fetish is 1]legs. [otherwise]foot cups. [end if]Aside from [his of M] head, [his of M] torso is protected by a bit of ornate armour, and [he of M] is holding a large steel sword in one strong hand and a medium sized shield in the other. [big his of M] wispy black hair flows behind [him of M] as if constantly caught by the wind[if the bimbo of the player > 6]. For some reason, your eyes can't help but return to the [LongDickDesc of M] dangling between [his of M] hind legs[end if].".
...
To say MonsterComment of (M - centaur):
	if diaper quest is 0:
		...
		otherwise if the bimbo of the player < 12:
			say "[variable custom style][one of][big he of M] might be pretty hung by [if mythical creature fetish is 1]centaur[otherwise]cyborg[end if] standards.[or]That sword seems like it's really valuable. I wonder if I could try it. The metal one. Yup, that's the one I want to try.[or][big he of M] keeps staring at my butt. I mean, I'm flattered, but...[in random order]";
		otherwise:
...
Definition: centaur is father material:
...
To say LongDickDesc of (M - centaur):
	say "massive 2-foot [if mythical creature fetish is 1]centaur[otherwise]cyborg[end if] [DickDesc of M]".

To say DickDesc of (M - centaur):
	if andro fetish is 1 or futanari fetish > 0, say manly-penis;
	otherwise say "strap-on".

To say cockhead of (M - centaur):
	say "flat, [if mythical creature fetish is 0]synthetic[otherwise if super-gyno fetish is 1]plastic[otherwise]bestial[end if] [one of]cockhead[or]tip[or]bellend[or]dicktip[in random order]".
...
To decide which number is the grossness of (M - centaur): [grossness addiction needed to tolerate it]
	if mythical creature fetish is 1, decide on 6;
	decide on 3.
...
To say SummoningFlav of (M - centaur):
	if M is in the location of the player, say "You hear a very sexual sounding sigh, followed by a short prayer. Several seconds later, a heavily armoured [man of M] with [if mythical creature fetish is 0]a cybernetic lower body[otherwise]the lower body of a horse leaps[end if] out of the statue, landing on the ground with a resounding *clop*.";
	otherwise say "You hear the clopping of [if mythical creature fetish is 1]hooves[otherwise]metal foot cups[end if] nearby.".
...
To compute appearance assessment of (M - centaur):
	...
	otherwise if the class of the player is cowgirl or the class of the player is puppygirl or the class of the player is catgirl or the class of the player is bunny:
		say "[BigNameDesc of M] cocks an eyebrow as [his of M] gaze moves up and down your body.[line break][speech style of M]'[one of]What a sexy [player-class]...'[or]Wow, a [player-class]. [if the player is able to get pregnant and M is father material]And a pretty fertile looking one too[otherwise]And a pretty hot one too[end if].'[or]Pretty sexy for a [player-class]...'[at random][roman type][line break]";
...
To say SlimeDrinkThreat of (M - centaur):
	...
	otherwise:
		say "[speech style of M]'[one of]I can't see my [slime] hitting your face, so make sure you drink it all.[or]I can't see you down there, so you might as well be a good sport and be my [SlimeTarget].'[or]I won the duel, so drink it. That's fair.'[in random order].'[roman type][line break]".

To say DrainFlav of (M - centaur):
	say "[BigNameDesc of M] [if slimeshooter fetish is 1]spins [his of M] slimeshooter around [his of M] shoulders and back before finally[otherwise][one of]bends [his of M] legs slightly[or]takes a tiny step forward[or]takes a tiny step back[at random], so [his of M] [LongDickDesc of M] is[end if] pointing directly at your face. [if the slime taste addiction of the player < 4][one of]Despite the clear warning, you aren't ready when[or]You are ready when[stopping][otherwise]You are delighted when[end if] a stream of [slime] floods from the tip![if the humiliation of the player < HUMILIATION-MODEST + 1500 and the slime taste addiction of the player < 7][line break][variable custom style][line break]This can't be happening[one of].[or] again![stopping][roman type][line break][end if]".

To say NormalMouthPenetrationFlav of (M - centaur):
	if the oral sex addiction of the player < 4:
		say "[one of][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] planting [if mythical creature fetish is 1]musky[otherwise]oily[end if] 'kisses' all over your face as it clumsily searches around for your mouth.[line break][first custom style]'Give up, already! You aren't go-'[roman type][line break][big he of M] finds [his of M] target at the worst possible time, and your sentence is interrupted by a [cockhead of M] plugging up your open mouth. It's too wide to actually get past your lips at first, but [he of M]'s pressing forward with so much force that you can't close your mouth, and after several seconds, [his of M] [DickDesc of M] pops in and begins to thrust.[or][BigFuckerDesc of M][']s [LongDickDesc of M] stiffens as [he of M] steps over you, drooling [CentaurLube] as it waves closer and closer to your face.[line break][first custom style]'No way. Take your freaky genitalia and go-'[roman type][line break][big he of M] throws [his of M] hips forward at the perfect moment, cutting you off as [his of M] [cockhead of M] wedges itself in your open mouth. You unsuccessfully try to close it, your jaws being forced wider and wider until finally, [his of M] shaft pops in and begins to thrust.[or][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] smearing [CentaurLube] across your lips as [he of M] tries to push it into your mouth. You involuntarily open your mouth to retch, only for [his of M] [cockhead of M] to form a seal against your lips. After that, [he of M] slowly brings up the pressure, forcing you to taste [his of M] [CentaurLube] directly as [he of M] forces your jaws to open little by little. Your own drool helps [him of M] reach the breaking point, and you groan helplessly as [his of M] [LongDickDesc of M] finally slides in and begins to thrust.[in random order]";
	otherwise if the oral sex addiction of the player < 7:
		say "[one of][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] planting [if mythical creature fetish is 1]musky[otherwise]oily[end if] 'kisses' all over your face as it clumsily seeks your mouth. You obediently open wide, waiting quietly for [his of M] 'kiss' to finally land on your lips. It happens on the twelfth attempt, immediately followed by your partner pressing forward with such force you couldn't close your mouth even if you wanted to. [big his of M] [cockhead of M] is too wide to get into your mouth at first, but after forcing your jaws wider, [his of M] [DickDesc of M] pops in and begins to thrust.[or][BigFuckerDesc of M][']s [LongDickDesc of M] stiffens as [he of M] steps over you, drooling [CentaurLube] as it waves closer and closer to your face. You hesitate, but after a moment, you open wide, and [his of M] [cockhead of M] wedges itself in your open mouth. Having given up on resisting, you force your jaws to open wider and wider, until finally, [his of M] shaft pops in and begins to thrust.[or][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] smearing [CentaurLube] across your lips as [he of M] tries to push it into your mouth. You open your mouth, and before you can have second thoughts, [his of M] [cockhead of M] forms a seal against your lips. After that, [he of M] slowly brings up the pressure, allowing you to taste [his of M] [CentaurLube] directly as [he of M] forces your jaws open little by little. You don't have the willpower to keep resisting, and allow your mouth to open just wide enough for [his of M] [LongDickDesc of M] to slide in and begin to thrust.[in random order]";
	otherwise:
		say "[one of][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] planting [if mythical creature fetish is 1]musky[otherwise]oily[end if] 'kisses' all over your face as it clumsily searches around for your mouth. You enjoy it for a little while, but eventually you get impatient, jerking your head into [his of M] path to claim your 'kiss' for yourself. [big his of M] [cockhead of M] is too wide to enter your mouth at first, but after forcing your jaws open wider, [his of M] yummy [DickDesc of M] finally pops in and begins to thrust.[or][BigFuckerDesc of M][']s [LongDickDesc of M] stiffens as [he of M] steps over you, drooling [CentaurLube] as it waves closer and closer to your face. You eagerly open wide, sticking your tongue out as [his of M] [cockhead of M] wedges itself in your open mouth. Enthusiasm makes for a great lubricant, and after a moment [his of M] shaft pops in and begins to thrust.[or][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] smearing [CentaurLube] across your lips as [he of M] tries to push it into your mouth. You hungrily open your mouth, working up a bit of drool as [his of M] [cockhead of M] forms a seal against your lips. After that, [he of M] slowly brings up the pressure, allowing you to taste [his of M] delicious [CentaurLube] directly as [he of M] forces your jaws to open little by little. Your own efforts help [him of M] reach the breaking point, and you emit a contented sigh as [his of M] [LongDickDesc of M] slips in and begin to thrust.[in random order]".

To say RingMouthPenetrationFlav of (M - centaur):
	say "[one of][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] planting [if mythical creature fetish is 1]musky[otherwise]oily[end if] 'kisses' all over your face as it clumsily searches around for your mouth. Even when [he of M] finds [his of M] target, [he of M] gets held up when [his of M] [cockhead of M] can't fit through the gag ring. [if the oral sex addiction of the player > 6]Thankfully, [otherwise]Mercifully, [end if]that only stymies [him of M] for a few seconds before [he of M] pops through and slowly begins to thrust.[or][BigFuckerDesc of M][']s [DickDesc of M] stiffens as [he of M] steps over you, drooling [CentaurLube] as it waves closer and closer to your face. Completely boxed in by all four of [his of M] limbs, there's nothing you can do but sit there and take it as [he of M] forces [his of M] [cockhead of M] past the gag-ring and begins to thrust.[or][BigFuckerDesc of M] steps over you, [his of M] [LongDickDesc of M] drooling [CentaurLube] as it presses right up against your [LipDesc]. [big his of M] tip gets caught on the outside of the gag for a moment before popping through, giving you ample opportunity to taste [his of M] potent [if mythical creature fetish is 1]musky[otherwise]oil[end if] before [he of M] slides all the way in and begins to thrust.[in random order]";

To say CentaurBest:
	if mythical creature fetish is 1, say "bestial";
	otherwise say "cybernetic".

To say SexDollMouthPenetrationFlav of (M - centaur):
	say "[one of][BigFuckerDesc of M] steps over you, [his of M] [DickDesc of M] repeatedly punching you in the face as [he of M] searches around for the taut, permanently-open hole you call a mouth. Eventually, [he of M] finds it, and an incredibly humiliating squeaking noise begins as several inches of equine shaft fill your mouth all at once and begin to thrust.[or][BigFuckerDesc of M] steps over you, [his of M] [LongDickDesc of M] drooling [CentaurLube] as it presses right up against your soft, [LipDesc]. [big his of M] [CentaurBest] tip is just a bit larger than the hole, but [he of M] has more than enough lubrication to pop [his of M] way through. Lewd squeaking noises start up as [he of M] begins to thrust.[in random order]";
...
To say SpitroastPrep of (M - centaur) with (O - a monster) in (F - asshole):
	say "[BigFuckerDesc of M] uses a [if mythical creature fetish is 1]hoof[otherwise]foot-cup[end if] to force you onto all fours, [his of M] [LongDickDesc of M] prodding your [AssDesc] as [he of M] clumsily lines it up with your hole.".
...
To say SpitroastPrep of (M - centaur) with (O - a monster) in (F - vagina):
	say "[BigFuckerDesc of M] uses a [if mythical creature fetish is 1]hoof[otherwise]foot-cup[end if] to force you onto all fours, [his of M] [LongDickDesc of M] prodding your thighs as [he of M] clumsily lines it up with your entrance.".
...
To say VeryLooseVaginaPenetrationFlav of (M - centaur):
	if the relevant sex addiction of M < 7:
		say "[one of][BigFuckerDesc of M] slowly drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your unwilling [vagina].[or]You scoff as [he of M] drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your [vagina].[or]You [if face is actually occupied]make an indignant noise[otherwise]curl your lip in disgust[end if] as [his of M] [CentaurBest] shaft presses between your folds, providing its own lubrication as it slowly slides into your [vagina].[in random order] [big he of M] sighs in satisfaction as [he of M] begins to thrust.";
	otherwise if the relevant sex addiction of M < 12:
		say "[one of][BigFuckerDesc of M] slowly drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your not-unwilling [vagina].[or]You suppress a moan as [he of M] drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your [vagina].[or]You [if face is actually occupied]make a muffled noise[otherwise]bite your [LipDesc][end if] as [his of M] [CentaurBest] shaft presses between your folds, providing its own lubrication as it slowly slides into your [vagina].[in random order] [big he of M] sighs in satisfaction as [he of M] begins to thrust.";
	otherwise:
		say "[one of][BigFuckerDesc of M] slowly drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your oh-so-willing [vagina].[or]You shamelessly moan as [he of M] drives [his of M] weight forward, sliding [his of M] [CentaurBest] shaft into your welcoming [vagina].[or]You [if face is actually occupied]emit a muffled moan[otherwise]moan hungrily[end if] as [his of M] [CentaurBest] shaft presses between your folds, providing its own lubrication as it slowly slides into your [vagina].[in random order] [big he of M] sighs in satisfaction as [he of M] begins to thrust.".
...
To say LickInitiationFlav of (M - centaur):
	let scent be the substituted form of "[if mythical creature fetish is 1][one of]*unwashed*[or]sweaty[stopping][otherwise]oily[end if]";
...
To watersports dominate (M - centaur):
	let C be a random bottom level protection clothing;
	if slimeshooter fetish is 1, say "You knock the sword out of [NameDesc of M]'s hand, staring [him of M] down as you pull out your slimeshooter. [big he of M] frowns.[line break][speech style of M]'[one of]I don't appreciate you acting all high and mighty like this, but I'm the foreigner here, so I'll let it slide[or]You don't have any right to look at me that way, but since I'm the foreigner, I'll accept it just this once[in random order].'[roman type][line break][big he of M] drops to [his of M] knees, grumbling as [he of M] [if andro fetish is 1]shrugs[otherwise]pops [his of M] breasts[end if] out of [his of M] armour. You take a small step forward and pull the trigger[run paragraph on]";
	otherwise say "You knock the sword out of [NameDesc of M]'s hand, staring [him of M] down as you [if the player is not possessing a penis or C is not clothing or C is strapon-panties]widen your stance and fondle your [genitals]. [otherwise]pull out your [SexDesc of penis]. [end if][big he of M] frowns.[line break][speech style of M]'[one of]I don't appreciate you acting all high and mighty like this, but I'm the foreigner here, so I'll let it slide[or]You don't have any right to look at me that way, but since I'm the foreigner, I'll accept it just this once[in random order].'[roman type][line break][big he of M] drops to [his of M] knees, grumbling as [he of M] [if andro fetish is 1]shrugs[otherwise]pops [his of M] breasts[end if] out of [his of M] armour. You take a small step forward and emit an exaggerated sigh as you release your hold on your [SlimeContainer].[run paragraph on]";
	if sexual-penis-length > 8:
		say "[big he of M] reflexively closes [his of M] eyes as your [SlimeShade] stream hits [him of M] on the forehead, and [he of M] slumps a little as your [slime] slowly flows down [his of M] face, chest, and stomach.";
		severeDignify;
		say AfterDominationComment 5 of M;
	otherwise if sexual-penis-length > 3:
		say "[big he of M] flinches a little as your [SlimeShade] stream hits [him of M] between [his of M] [if andro fetish is 1]pecs[otherwise]boobs[end if] and flows down [his of M] torso. Ideally, you would have humiliated [him of M] by dousing [his of M] face, but even on [his of M] knees [he of M]'s so tall that your aim doesn't reach any higher than the bottom of [his of M] chin.";
		strongDignify;
		say AfterDominationComment 5 of M;
	otherwise:
		say "[big he of M] cocks [his of M] eyebrow as your [SlimeShade] stream hits [him of M] in the torso and flows off [his of M] stomach. It clearly isn't having the humiliating effect that you imagined, but [if sexual-penis-length > 0]your [SexDesc of penis] is so small that[otherwise]but even on [his of M] knees [he of M]'s so tall that[end if] it can't be helped.";
		now player-fucking is DOMINANT-NEUTRAL;
		moderateDignify;
...
To say AfterDominationComment (N - a number) of (M - centaur):
	...
	otherwise if N is 5:
		say "[speech style of M]'[one of]Your species does scent marking too, eh... Even so, I'm not much of a sub. You'll be learning that soon enough.'[or]So it was scent marking... Well, you'll be learning soon enough that I'm nobody's sub.'[in random order][roman type]";
