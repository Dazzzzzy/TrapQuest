...
This is the immobility blocks masturbation rule:
	if there is a thing grabbing the player:
		...
		rule fails.
The immobility blocks masturbation rule is listed last in the global masturbation restriction rules.

Definition: yourself is at least partially living stuck:
	if there is a live thing penetrating an orifice or there is a live thing grabbing the player or there is a live thing wrangling a body part, decide yes;
	decide no.
