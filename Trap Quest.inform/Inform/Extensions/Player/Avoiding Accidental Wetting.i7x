...
To diaperreward:
	if wetting-valued > 3:
		if diaper quest is 1 and background-pure is 1:
			say "[bold type]You are extremely proud of yourself for still having managed to control your [SlimeContainer]! Once again you feel yourself gaining real, physical power just from the happiness you feel from having retained your continence.[roman type][line break]";
			increase diaper bonus by 1;
		otherwise:
			say "";
	otherwise:
		say "[bold type]You pause for a moment, happy that so far all your [SlimeContainer] movements have been voluntary.[roman type] You get the feeling that the game is trying to make you lose control of your bodily functions and eventually render you incontinent. You feel that by placing a lot of value on your [SlimeContainer] control, you could help maintain your self-respect. But the negative impact of wetting yourself involuntarily in the future would likely be more severe. Would you like to make the mental decision to care deeply about your continence? ";
		...
		if the player is consenting:
			...
			dignify 1000;
		otherwise:
			say "You decide in this game, placing all of your hopes on your [SlimeContainer] might not be the most sensible idea.";
			now wetting-valued is -1.

To compute wetting failure:
	if diaper quest is 1 and background-pure is 1, say "As that powerful feeling of pride for your full control of your [SlimeContainer] melts away, it feels as if it has left you in an even worse state than when you first began to feel it. ";
